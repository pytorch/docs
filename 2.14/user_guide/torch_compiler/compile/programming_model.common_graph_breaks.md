...
- Use higher-order ops like [Control Flow - Cond](../../../higher_order_ops/cond.html#cond) in place of data-dependent control flow
...
entirely. See [this page for more details](programming_model.fullgraph_true.html#programming-model-fullgraph-true-skipping-functions).