...
torch.overrides.get_ignored_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L103)
...
torch.overrides.get_overridable_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1945)
...
torch.overrides.resolve_name(*f*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1958)
...
torch.overrides.get_testing_overrides()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L423)
...
torch.overrides.handle_torch_function(*public_api*, *relevant_args*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1722)
...
torch.overrides.has_torch_function()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1811)
...
torch.overrides.is_tensor_like(*inp*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L2013)
...
torch.overrides.is_tensor_method_or_property(*func*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1987)
...
torch.overrides.wrap_torch_function(*dispatcher*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L1601)
...
torch.overrides.redispatch_function(*func*, *types*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/overrides.py#L2168)
