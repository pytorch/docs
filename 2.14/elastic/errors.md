...
torch.distributed.elastic.multiprocessing.errors.record(*fn*, *error_handler=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/distributed/elastic/multiprocessing/errors/__init__.py#L331)
...
*class*torch.distributed.elastic.multiprocessing.errors.ChildFailedError(*name*, *failures*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/distributed/elastic/multiprocessing/errors/__init__.py#L205)
...
*class*torch.distributed.elastic.multiprocessing.errors.ErrorHandler[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/distributed/elastic/multiprocessing/errors/error_handler.py#L24)
...
*class*torch.distributed.elastic.multiprocessing.errors.ProcessFailure(*local_rank*, *pid*, *exitcode*, *error_file*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/distributed/elastic/multiprocessing/errors/__init__.py#L91)
