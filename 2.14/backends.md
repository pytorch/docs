...
torch.backends.cpu.get_cpu_capability()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cpu/__init__.py#L9)
...
torch.backends.cuda.is_built()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L43)
...
torch.backends.cuda.preferred_blas_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L296)
...
torch.backends.cuda.cublas_workspace_size(*size=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L340)
...
torch.backends.cuda.cublaslt_workspace_size(*size=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L359)
...
torch.backends.cuda.blas_workspace_size(*size=None*, *backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L378)
...
torch.backends.cuda.preferred_rocm_fa_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L454)
...
torch.backends.cuda.is_ck_sdpa_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L499)
...
torch.backends.cuda.preferred_linalg_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L225)
...
torch.backends.cuda.flash_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L510)
...
torch.backends.cuda.enable_mem_efficient_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L537)
...
torch.backends.cuda.mem_efficient_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L528)
...
torch.backends.cuda.enable_flash_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L519)
...
torch.backends.cuda.math_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L546)
...
torch.backends.cuda.enable_math_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L555)
...
torch.backends.cuda.fp16_bf16_reduction_math_sdp_allowed()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L573)
...
torch.backends.cuda.allow_fp16_bf16_reduction_math_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L564)
...
torch.backends.cuda.cudnn_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L655)
...
torch.backends.cuda.enable_cudnn_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L664)
...
torch.backends.cuda.is_flash_attention_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L582)
...
torch.backends.cuda.can_use_flash_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L595)
...
torch.backends.cuda.can_use_efficient_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L615)
...
torch.backends.cuda.can_use_cudnn_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L635)
...
torch.backends.cuda.sdp_kernel(*enable_flash=True*, *enable_math=True*, *enable_mem_efficient=True*, *enable_cudnn=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cuda/__init__.py#L673)
...
torch.backends.cudnn.version()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cudnn/__init__.py#L110)

Return the version of cuDNN.

torch.backends.cudnn.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cudnn/__init__.py#L124)
...
torch.backends.cusparselt.version()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cusparselt/__init__.py#L42)
...
torch.backends.cusparselt.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cusparselt/__init__.py#L49)
...
torch.backends.cusparselt.get_max_alg_id()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/cusparselt/__init__.py#L54)
...
torch.backends.mha.get_fastpath_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mha/__init__.py#L9)
...
torch.backends.mha.set_fastpath_enabled(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mha/__init__.py#L22)
...
torch.backends.mps.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L28)
...
torch.backends.mps.is_built()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L18)
...
torch.backends.mps.get_core_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L52)
...
torch.backends.mps.get_name()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L46)
...
torch.backends.mps.is_macos13_or_newer(*minor=0*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L40)
...
torch.backends.mps.is_macos_or_newer(*major*, *minor*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mps/__init__.py#L34)
...
torch.backends.mkl.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mkl/__init__.py#L5)

Return whether PyTorch is built with MKL support.

*class*torch.backends.mkl.verbose(*enable*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mkl/__init__.py#L14)
...
torch.backends.mkldnn.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mkldnn/__init__.py#L114)

*class*torch.backends.mkldnn.verbose(*level*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/mkldnn/__init__.py#L33)
...
torch.backends.nnpack.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/nnpack/__init__.py#L11)

Return whether PyTorch is built with NNPACK support.

torch.backends.nnpack.flags(*enabled=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/nnpack/__init__.py#L23)

Context manager for setting if nnpack is enabled globally

torch.backends.nnpack.set_flags(*_enabled*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/nnpack/__init__.py#L16)

Set if nnpack is enabled globally

## torch.backends.openmp

torch.backends.openmp.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/openmp/__init__.py#L5)

Return whether PyTorch is built with OpenMP support.

torch.backends.kleidiai.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/kleidiai/__init__.py#L5)

Return whether PyTorch is built with KleidiAI support.

## torch.backends.opt_einsum

torch.backends.opt_einsum.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/opt_einsum/__init__.py#L17)
...
torch.backends.opt_einsum.get_opt_einsum()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/opt_einsum/__init__.py#L30)
...
torch.backends.python_native.get_dsl_operations(*dsl_name*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L214)
...
torch.backends.python_native.disable_operations(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L232)
...
torch.backends.python_native.enable_operations(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L251)
...
torch.backends.python_native.disable_dispatch_keys(**dispatch_keys*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L267)
...
torch.backends.python_native.enable_dispatch_keys(**dispatch_keys*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L281)
...
torch.backends.python_native.operations_disabled(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/python_native/__init__.py#L295)
...
torch.backends.xeon.run_cpu.create_args(*parser=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/backends/xeon/run_cpu.py#L913)
