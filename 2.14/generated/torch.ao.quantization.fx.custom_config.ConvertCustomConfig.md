...
*class*torch.ao.quantization.fx.custom_config.ConvertCustomConfig[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/quantization/fx/custom_config.py#L374)
...
*classmethod*from_dict(*convert_custom_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/quantization/fx/custom_config.py#L419)
...
set_observed_to_quantized_mapping(*observed_class*, *quantized_class*, *quant_type=QuantType.STATIC*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/quantization/fx/custom_config.py#L393)
...
set_preserved_attributes(*attributes*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/quantization/fx/custom_config.py#L410)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/quantization/fx/custom_config.py#L451)
