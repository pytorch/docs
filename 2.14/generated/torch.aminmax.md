...
Default is False.
- **out** (*Optional**[**Tuple**[*[*Tensor*](../tensors.html#torch.Tensor)*,*[*Tensor*](../tensors.html#torch.Tensor)*]**]*) - Optional tensors on which to write the result. Must have the same
...
[`torch.amin()`](torch.amin.html#torch.amin) computes just the minimum value
[`torch.amax()`](torch.amax.html#torch.amax) computes just the maximum value
