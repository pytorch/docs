...
*class*torch.autograd.grad_mode.inference_mode(*mode=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/grad_mode.py#L213)
...
clone()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/grad_mode.py#L297)
