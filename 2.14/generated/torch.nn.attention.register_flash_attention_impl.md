...
torch.nn.attention.register_flash_attention_impl(*impl*, ***, *register_fn*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/attention/_registry.py#L28)
