...
*class*torch.optim.rmsprop.RMSprop(*params*, *lr=0.01*, *alpha=0.99*, *eps=1e-08*, *weight_decay=0*, *momentum=0*, *centered=False*, *capturable=False*, *foreach=None*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/rmsprop.py#L30)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/rmsprop.py#L144)
