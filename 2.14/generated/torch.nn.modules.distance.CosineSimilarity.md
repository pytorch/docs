...
*class*torch.nn.modules.distance.CosineSimilarity(*dim=1*, *eps=1e-08*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/distance.py#L64)
...
forward(*x1*, *x2*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/distance.py#L96)
