...
torch.fx.experimental.unify_refinements.substitute_all_types(*graph*, *mapping*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/unify_refinements.py#L109)
