...
*class*torch.autograd.function.BackwardCFunction[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/function.py#L338)

This class is used for internal autograd work. Do not use.

apply(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/function.py#L354)
...
apply_boxed(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/function.py#L368)
...
apply_jvp(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/autograd/function.py#L376)
