...
*class*torch.fx.graph.CodeGen[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L366)

Warning

This API is experimental and is *NOT* backward-compatible.

additional_globals()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L493)
...
gen_fn_def(*free_vars*, *maybe_return_annotation*, ***, *expanded_def=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L430)
...
generate_output(*output_args*, ***, *descs=None*, *repr_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L454)
...
process_inputs(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L474)
...
process_outputs(*outputs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L485)
