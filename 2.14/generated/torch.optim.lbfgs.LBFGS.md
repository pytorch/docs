...
*class*torch.optim.lbfgs.LBFGS(*params*, *lr=1*, *max_iter=20*, *max_eval=None*, *tolerance_grad=1e-07*, *tolerance_change=1e-09*, *history_size=100*, *line_search_fn=None*, ***, *maximize=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lbfgs.py#L206)
...
step(*closure*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lbfgs.py#L302)
