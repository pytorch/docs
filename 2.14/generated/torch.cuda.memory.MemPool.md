...
*class*torch.cuda.memory.MemPool(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/memory.py#L1368)
...
snapshot(*include_traces=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/memory.py#L1403)
...
use_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/memory.py#L1399)
