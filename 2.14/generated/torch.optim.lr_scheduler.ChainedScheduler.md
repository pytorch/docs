...
*class*torch.optim.lr_scheduler.ChainedScheduler(*schedulers*, *optimizer=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L1478)
...
load_state_dict(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L1566)
...
state_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L1545)
...
step()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L1539)
