...
*class*torch.xpu.memory.MemPool(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/memory.py#L553)
...
snapshot()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/memory.py#L589)
...
use_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/memory.py#L585)
