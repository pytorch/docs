...
*class*torch.optim.lr_scheduler.LinearLR(*optimizer*, *start_factor=0.3333333333333333*, *end_factor=1.0*, *total_iters=5*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L877)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/lr_scheduler.py#L936)
