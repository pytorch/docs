...
*class*torch.nn.modules.padding.ZeroPad2d(*padding*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/padding.py#L743)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/padding.py#L793)
