...
torch.reshape(*input*, *shape*) → [Tensor](../tensors.html#torch.Tensor)
...
See [`torch.Tensor.view()`](torch.Tensor.view.html#torch.Tensor.view) on when it is possible to return a view.
