...
*class*torch.xpu.streams.Stream(*device=None*, *priority=0*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L17)
...
query()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L78)
...
record_event(*event=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L63)
...
synchronize()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L86)

Wait for all the kernels in this stream to complete.

wait_event(*event*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L44)
...
wait_stream(*stream*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/xpu/streams.py#L52)
