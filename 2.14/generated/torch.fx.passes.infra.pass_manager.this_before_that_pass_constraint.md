...
torch.fx.passes.infra.pass_manager.this_before_that_pass_constraint(*this*, *that*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/infra/pass_manager.py#L125)
