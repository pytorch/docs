...
*class*torch.nn.AdaptiveMaxPool2d(*output_size*, *return_indices=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/pooling.py#L1348)
