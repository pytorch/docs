...
torch.onnx.verification.verify_onnx_program(*onnx_program*, *args=None*, *kwargs=None*, *compare_intermediates=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/onnx/_internal/exporter/_verification.py#L148)
...
asdict()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/onnx/_internal/exporter/_verification.py#L100)
...
*classmethod*from_tensors(*name*, *expected*, *actual*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/onnx/_internal/exporter/_verification.py#L59)
