...
![../../../_images/tlparse4_pgo.png](../../../_images/tlparse4_pgo.png)
...
2. Mark them as dynamic using one of the [User Annotations](../torch.compiler_dynamic_shapes.html#user-annotations).

#### How to Identify Elements to Mark as Dynamic

Follow these guidelines:

1. **PGO artifact:** Follow the steps in Identifying Dynamic Elements Marked by PGO.
...
![../../../_images/tlparse5_dynamic_shapes.png](../../../_images/tlparse5_dynamic_shapes.png)
...
![../../../_images/tlparse6_size_related_recompilations.png](../../../_images/tlparse6_size_related_recompilations.png)

In the one below it is not, which indicates that dynamic shapes won't resolve it:

[![../../../_images/tlparse7_not_size_related_recompilations.png](../../../_images/tlparse7_not_size_related_recompilations.png)](../../../_images/tlparse7_not_size_related_recompilations.png)

1. **Compare Guards Files:** Ensure there are no guards on non-size-related
elementsthat exist in one graph but not the others.
2. **Early Check for Custom Triton Kernels:** Check if your model calls custom
...
![../../../_images/tlparse8_compilation_metrics.png](../../../_images/tlparse8_compilation_metrics.png)
