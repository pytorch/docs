...
- [torch.export](../export.html#torch-export) through calling [`torch.export.save()`](api_reference.html#torch.export.save)
- [AOTInductor](../torch.compiler_aot_inductor.html#torch-compiler-aot-inductor) through calling [`torch._inductor.aoti_compile_and_package()`](../torch.compiler_aot_inductor.html#torch._inductor.aoti_compile_and_package)
...
Lower level APIs like [`torch.export.pt2_archive._package.package_pt2()`](api_reference.html#torch.export.pt2_archive._package.package_pt2) and
[`torch.export.pt2_archive._package.load_pt2()`](api_reference.html#torch.export.pt2_archive._package.load_pt2) allow you to have
