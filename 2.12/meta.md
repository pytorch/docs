...
perform data-dependent operations like [`torch.nonzero()`](generated/torch.nonzero.html#torch.nonzero) or
[`item()`](generated/torch.Tensor.item.html#torch.Tensor.item). In some cases, not all device types (e.g., CPU
