...
torch.__future__.set_overwrite_module_params_on_conversion(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/__future__.py#L5)
...
torch.__future__.get_overwrite_module_params_on_conversion()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/__future__.py#L25)
...
torch.__future__.set_swap_module_params_on_conversion(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/__future__.py#L35)
...
torch.__future__.get_swap_module_params_on_conversion()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/__future__.py#L68)
