...
| [`Tensor.detach()`](generated/torch.Tensor.detach.html#torch.Tensor.detach), `torch.detach()` | Keeps input names |
...
| [`Tensor.get_device()`](generated/torch.Tensor.get_device.html#torch.Tensor.get_device), `torch.get_device()` | None |
...
| [`Tensor.is_signed()`](generated/torch.Tensor.is_signed.html#torch.Tensor.is_signed), `torch.is_signed()` | None |
...
| [`Tensor.masked_fill()`](generated/torch.Tensor.masked_fill.html#torch.Tensor.masked_fill), `torch.masked_fill()` | Keeps input names |
