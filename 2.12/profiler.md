...
*class*torch.profiler._KinetoProfile(***, *activities=None*, *record_shapes=False*, *profile_memory=False*, *with_stack=False*, *with_flops=False*, *with_modules=False*, *experimental_config=None*, *execution_trace_observer=None*, *acc_events=False*, *custom_trace_id_callback=None*, *post_processing_timeout_s=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L135)
...
- **profile_memory** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - track tensor memory allocation/deallocation (see `export_memory_timeline`
for more details).
...
- **with_flops** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - use formula to estimate the FLOPS of specific operators
...
add_metadata(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L425)

Adds a user defined metadata with a string key and a string value
into the trace file

add_metadata_json(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L433)

Adds a user defined metadata with a string key and a valid json value
into the trace file

events()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L416)

Returns the list of unaggregated profiler events,
to be used in the trace callback or after the profiling is finished

export_chrome_trace(*path*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L333)

Exports the collected trace in Chrome JSON format. If kineto is enabled, only
last cycle in schedule is exported.

export_memory_timeline(*path*, *device=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L480)
...
export_stacks(*path*, *metric='self_cpu_time_total'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L351)
...
key_averages(*group_by_input_shape=False*, *group_by_stack_n=0*, *group_by_overload_name=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L395)
...
preset_metadata_json(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L440)
...
toggle_collection_dynamic(*enable*, *activities*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L362)
...
get_trace_id()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L977)

Returns the current trace ID.

set_custom_trace_id_callback(*callback*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L971)

Sets a callback to be called when a new trace ID is generated.

step()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L949)

Signals the profiler that the next profiling step has started.

*class*torch.profiler.ProfilerAction(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L538)
...
torch.profiler.schedule(***, *wait*, *warmup*, *active*, *repeat=0*, *skip_first=0*, *skip_first_wait=0*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L549)
...
torch.profiler.tensorboard_trace_handler(*dir_name*, *worker_name=None*, *use_gzip=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L619)
...
torch.profiler.supported_activities()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/profiler.py#L77)
...
torch.profiler.itt.is_available()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/itt.py#L31)

Check if ITT feature is available or not

torch.profiler.itt.mark(*msg*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/itt.py#L57)
...
torch.profiler.itt.range_push(*msg*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/itt.py#L38)
...
torch.profiler.itt.range_pop()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/itt.py#L49)

Pops a range off of a stack of nested range spans. Returns the
zero-based depth of the range that is ended.

torch.profiler.itt.range(*msg*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/profiler/itt.py#L67)
