...
[Distributed RPC Framework](../rpc.html#distributed-rpc-framework) before proceeding.
...
[`remote()`](../rpc.html#torch.distributed.rpc.remote). Each RRef is owned by the callee worker
of the [`remote()`](../rpc.html#torch.distributed.rpc.remote) call (i.e., owner) and can be used
...
[`remote()`](../rpc.html#torch.distributed.rpc.remote) call.
...
[`rpc_sync()`](../rpc.html#torch.distributed.rpc.rpc_sync),
[`rpc_async()`](../rpc.html#torch.distributed.rpc.rpc_async) or
[`remote()`](../rpc.html#torch.distributed.rpc.remote) invocation, and the owner will be notified
...
[`rpc_sync()`](../rpc.html#torch.distributed.rpc.rpc_sync),
[`rpc_async()`](../rpc.html#torch.distributed.rpc.rpc_async) or
[`remote()`](../rpc.html#torch.distributed.rpc.remote) are not idempotent and therefore
...
owner calls [`rpc_sync()`](../rpc.html#torch.distributed.rpc.rpc_sync),
[`rpc_async()`](../rpc.html#torch.distributed.rpc.rpc_async), or
[`remote()`](../rpc.html#torch.distributed.rpc.remote) and uses its RRef as an argument. In this
...
creates the `OwnerRRef`. The method [`remote()`](../rpc.html#torch.distributed.rpc.remote)
returns immediately, meaning that the `UserRRef` can be forked/used before
the owner knows about it.

On the owner, when receiving the [`remote()`](../rpc.html#torch.distributed.rpc.remote) call, it
...
from A to B ([`remote()`](../rpc.html#torch.distributed.rpc.remote) and
`to_here()`) may
