...
| --- | --- |
| functorch.vmap | [`torch.vmap()`](generated/torch.vmap.html#torch.vmap) or [`torch.func.vmap()`](generated/torch.func.vmap.html#torch.func.vmap) |
| functorch.grad | [`torch.func.grad()`](generated/torch.func.grad.html#torch.func.grad) |
| functorch.vjp | [`torch.func.vjp()`](generated/torch.func.vjp.html#torch.func.vjp) |
| functorch.jvp | [`torch.func.jvp()`](generated/torch.func.jvp.html#torch.func.jvp) |
| functorch.jacrev | [`torch.func.jacrev()`](generated/torch.func.jacrev.html#torch.func.jacrev) |
| functorch.jacfwd | [`torch.func.jacfwd()`](generated/torch.func.jacfwd.html#torch.func.jacfwd) |
| functorch.hessian | [`torch.func.hessian()`](generated/torch.func.hessian.html#torch.func.hessian) |
| functorch.functionalize | [`torch.func.functionalize()`](generated/torch.func.functionalize.html#torch.func.functionalize) |

Furthermore, if you are using torch.autograd.functional APIs, please try out
the [`torch.func`](func.api.html#module-torch.func) equivalents instead. [`torch.func`](func.api.html#module-torch.func) function
...
| --- | --- |
| [`torch.autograd.functional.vjp()`](generated/torch.autograd.functional.vjp.html#torch.autograd.functional.vjp) | [`torch.func.grad()`](generated/torch.func.grad.html#torch.func.grad) or [`torch.func.vjp()`](generated/torch.func.vjp.html#torch.func.vjp) |
| [`torch.autograd.functional.jvp()`](generated/torch.autograd.functional.jvp.html#torch.autograd.functional.jvp) | [`torch.func.jvp()`](generated/torch.func.jvp.html#torch.func.jvp) |
| [`torch.autograd.functional.jacobian()`](generated/torch.autograd.functional.jacobian.html#torch.autograd.functional.jacobian) | [`torch.func.jacrev()`](generated/torch.func.jacrev.html#torch.func.jacrev) or [`torch.func.jacfwd()`](generated/torch.func.jacfwd.html#torch.func.jacfwd) |
| [`torch.autograd.functional.hessian()`](generated/torch.autograd.functional.hessian.html#torch.autograd.functional.hessian) | [`torch.func.hessian()`](generated/torch.func.hessian.html#torch.func.hessian) |
...
[`torch.func.functional_call()`](generated/torch.func.functional_call.html#torch.func.functional_call) is the replacement for
...
We recommend using [`torch.func.functional_call()`](generated/torch.func.functional_call.html#torch.func.functional_call) directly because it is a more explicit
and flexible API.
...
[`torch.func.functional_call()`](generated/torch.func.functional_call.html#torch.func.functional_call) allows one to call the forward pass of an existing
...
vs [`torch.func`](func.api.html#module-torch.func):
...
Please use [`torch.func.stack_module_state()`](generated/torch.func.stack_module_state.html#torch.func.stack_module_state) instead of
...
[`torch.func.stack_module_state()`](generated/torch.func.stack_module_state.html#torch.func.stack_module_state) returns two dictionaries, one of stacked parameters, and
one of stacked buffers, that can then be used with [`torch.vmap()`](generated/torch.vmap.html#torch.vmap) and [`torch.func.functional_call()`](generated/torch.func.functional_call.html#torch.func.functional_call)
for ensembling.
...
[`torch.compile()`](generated/torch.compile.html#torch.compile) instead.