...
*class*torch.distributed._local_tensor.LocalTensor(*local_tensors*, *requires_grad=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L922)
...
reconcile()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1124)
...
tolist()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1103)
...
*class*torch.distributed._local_tensor.LocalTensorMode(*ranks*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1225)
...
disable()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1425)
...
rank_map(*cb*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1448)
...
tensor_map(*tensor*, *cb*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1457)
...
*class*torch.distributed._local_tensor.LocalIntNode(*local_ints*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L423)
...
torch.distributed._local_tensor.local_tensor_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1696)
...
torch.distributed._local_tensor.enabled_local_tensor_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1713)
...
torch.distributed._local_tensor.maybe_run_for_local_tensor(*func*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1729)
...
torch.distributed._local_tensor.maybe_disable_local_tensor_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/distributed/_local_tensor/__init__.py#L1800)
