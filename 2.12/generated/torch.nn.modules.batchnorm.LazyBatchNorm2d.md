...
*class*torch.nn.modules.batchnorm.LazyBatchNorm2d(*eps=1e-05*, *momentum=0.1*, *affine=True*, *track_running_stats=True*, *device=None*, *dtype=None*, ***, *bias=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/batchnorm.py#L499)
...
cls_to_become[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/batchnorm.py#L420)
