...
*class*torch.nn.modules.lazy.LazyModuleMixin(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/lazy.py#L53)
...
has_uninitialized_params()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/lazy.py#L239)

Check if a module has parameters that are not initialized.

initialize_parameters(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/lazy.py#L229)
