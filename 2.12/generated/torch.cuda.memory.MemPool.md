...
*class*torch.cuda.memory.MemPool(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/memory.py#L1264)
...
snapshot(*include_traces=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/memory.py#L1299)
...
use_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/memory.py#L1295)
