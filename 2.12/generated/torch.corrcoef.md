...
torch.corrcoef(*input*) → [Tensor](../tensors.html#torch.Tensor)
...
Rij=CijCii∗CjjR_{ij} = \frac{ C_{ij} } { \sqrt{ C_{ii} * C_{jj} } }Rij​=Cii​∗Cjj​​Cij​​
...
[`torch.cov()`](torch.cov.html#torch.cov) covariance matrix.
