...
*class*torch.nn.modules.pixelshuffle.PixelShuffle(*upscale_factor*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/pixelshuffle.py#L10)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/pixelshuffle.py#L64)
...
forward(*input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/pixelshuffle.py#L58)
