...
*class*torch.ao.quantization.backend_config.DTypeConfig(*input_dtype=None*, *output_dtype=None*, *weight_dtype=None*, *bias_dtype=None*, *is_dynamic=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L114)
...
*classmethod*from_dict(*dtype_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L233)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L268)
