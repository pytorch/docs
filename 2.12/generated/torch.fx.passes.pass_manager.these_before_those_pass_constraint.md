...
torch.fx.passes.pass_manager.these_before_those_pass_constraint(*these*, *those*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/fx/passes/pass_manager.py#L147)
