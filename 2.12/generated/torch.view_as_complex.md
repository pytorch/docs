...
torch.view_as_complex(*input*) → [Tensor](../tensors.html#torch.Tensor)
...
[`torch.dtype`](../tensor_attributes.html#torch.dtype) `torch.float64` and `torch.float32`. The input is
