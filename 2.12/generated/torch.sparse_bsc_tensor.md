...
torch.sparse_bsc_tensor(*ccol_indices*, *row_indices*, *values*, *size=None*, ***, *dtype=None*, *device=None*, *pin_memory=False*, *requires_grad=False*, *check_invariants=None*) → [Tensor](../tensors.html#torch.Tensor)
