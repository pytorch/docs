...
*class*torch.optim.lr_scheduler.CyclicLR(*optimizer*, *base_lr*, *max_lr*, *step_size_up=2000*, *step_size_down=None*, *mode='triangular'*, *gamma=1.0*, *scale_fn=None*, *scale_mode='cycle'*, *cycle_momentum=True*, *base_momentum=0.8*, *max_momentum=0.9*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L1780)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L1992)
...
load_state_dict(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L2087)

Load the scheduler's state.

scale_fn(*x*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L1973)
...
state_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L2063)
