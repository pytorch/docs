...
torch.sparse_csc_tensor(*ccol_indices*, *row_indices*, *values*, *size=None*, ***, *dtype=None*, *device=None*, *pin_memory=False*, *requires_grad=False*, *check_invariants=None*) → [Tensor](../tensors.html#torch.Tensor)

Constructs a [sparse tensor in CSC (Compressed Sparse Column)](../sparse.html#sparse-csc-docs) with specified values at the given
