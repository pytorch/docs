...
*class*torch.optim.sgd.SGD(*params*, *lr=0.001*, *momentum=0*, *dampening=0*, *weight_decay=0*, *nesterov=False*, ***, *maximize=False*, *foreach=None*, *differentiable=False*, *fused=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/sgd.py#L28)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/sgd.py#L105)
