...
*class*torch.sparse.check_sparse_tensor_invariants(*enable=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/sparse/__init__.py#L453)
...
*static*disable()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/sparse/__init__.py#L529)
...
*static*enable()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/sparse/__init__.py#L509)
...
*static*is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/sparse/__init__.py#L497)
