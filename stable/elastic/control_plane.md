...
torch.distributed.elastic.control_plane.worker_main()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/distributed/elastic/control_plane.py#L26)
