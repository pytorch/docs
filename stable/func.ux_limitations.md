...
[`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) or one of torch.func's AD transforms ([`vjp()`](generated/torch.func.vjp.html#torch.func.vjp), [`jvp()`](generated/torch.func.jvp.html#torch.func.jvp),
[`jacrev()`](generated/torch.func.jacrev.html#torch.func.jacrev), [`jacfwd()`](generated/torch.func.jacfwd.html#torch.func.jacfwd)), the transform may not be able to transform over it.
...
[`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) is our most restrictive transform.
The grad-related transforms ([`grad()`](generated/torch.func.grad.html#torch.func.grad), [`vjp()`](generated/torch.func.vjp.html#torch.func.vjp), [`jvp()`](generated/torch.func.jvp.html#torch.func.jvp)) do not
have these limitations. [`jacfwd()`](generated/torch.func.jacfwd.html#torch.func.jacfwd) (and [`hessian()`](generated/torch.func.hessian.html#torch.func.hessian), which is
implemented with [`jacfwd()`](generated/torch.func.jacfwd.html#torch.func.jacfwd)) is a composition of [`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) and
[`jvp()`](generated/torch.func.jvp.html#torch.func.jvp) so it also has these limitations.
...
In the presence of side effects, [`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) no longer acts like it is running
...
[`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) executes `f` a single time, so all side effects only happen once.
...
operations. [`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) will raise an error if it encounters an unsupported PyTorch
...
[`vmap()`](generated/torch.vmap.html#torch.vmap) (i.e. it is being vmapped over).
...
- Replace [`torch.zeros()`](generated/torch.zeros.html#torch.zeros) with `Tensor.new_zeros()`
- Replace [`torch.empty()`](generated/torch.empty.html#torch.empty) with `Tensor.new_empty()`
...
Inside of [`vmap()`](generated/torch.vmap.html#torch.vmap), `result` is a Tensor of shape [3, 3].
...
Replacing [`torch.zeros()`](generated/torch.zeros.html#torch.zeros) with `Tensor.new_zeros()` makes it so that
...
[`vmap()`](generated/torch.func.vmap.html#torch.func.vmap) doesn't support the `out=` keyword argument in PyTorch operations.
