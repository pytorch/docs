...
rename(**names*, ***rename_map*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/_tensor.py#L1473)
...
rename_(**names*, ***rename_map*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/_tensor.py#L1458)

In-place version of `rename()`.

refine_names(**names*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/_tensor.py#L1351)
...
align_to(**names*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/_tensor.py#L1393)
