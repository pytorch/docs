...
torch.overrides.get_ignored_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L102)
...
torch.overrides.get_overridable_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L1946)
...
torch.overrides.resolve_name(*f*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L1959)
...
torch.overrides.get_testing_overrides()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L421)
...
torch.overrides.handle_torch_function(*public_api*, *relevant_args*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L1723)
...
torch.overrides.is_tensor_like(*inp*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L2014)
...
torch.overrides.is_tensor_method_or_property(*func*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L1988)
...
torch.overrides.wrap_torch_function(*dispatcher*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/overrides.py#L1602)
