...
torch.overrides.get_ignored_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L103)
...
torch.overrides.get_overridable_functions()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1943)
...
torch.overrides.resolve_name(*f*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1956)
...
torch.overrides.get_testing_overrides()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L421)
...
torch.overrides.handle_torch_function(*public_api*, *relevant_args*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1720)
...
torch.overrides.has_torch_function()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1809)
...
torch.overrides.is_tensor_like(*inp*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L2011)
...
torch.overrides.is_tensor_method_or_property(*func*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1985)
...
torch.overrides.wrap_torch_function(*dispatcher*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L1599)
...
torch.overrides.redispatch_function(*func*, *types*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/overrides.py#L2166)
