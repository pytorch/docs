...
*class*torch.nn.modules.loss.PoissonNLLLoss(*log_input=True*, *full=False*, *size_average=None*, *eps=1e-08*, *reduce=None*, *reduction='mean'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L287)
...
forward(*log_input*, *target*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L363)
