...
*class*torch.fx.experimental.symbolic_shapes.ShapeEnv(***, *should_record_events=None*, *tracked_fakes=None*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L3880)

add_backed_var_to_val(*expr*, *val*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L6013)

Adds a new symbol to the symbolic environment.

add_var_to_val(*expr*, *val*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L6029)

Deprecated: use add_backed_var_to_val instead.

bind_symbols(*placeholders*, *args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7092)
...
bound_sympy(*expr*, *size_oblivious=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7167)
...
check_equal(*other*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4323)

Compare another ShapeEnv for equivalence

cleanup()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L8958)
...
create_symbol(*val*, *source*, *dynamic_dim=DimDynamic.DUCK*, *constraint_dim=None*, *positive=True*, *do_not_specialize_zero_one=False*, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5698)
...
create_symbolic_sizes_strides_storage_offset(*ex*, *source*, ***, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4889)
...
create_symboolnode(*sym*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5489)
...
create_symfloatnode(*sym*, ***, *hint*, *source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5421)
...
create_symintnode(*sym*, ***, *hint*, *source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5375)
...
create_unbacked_symbool()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5641)
...
create_unbacked_symfloat()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5532)
...
create_unbacked_symint(*source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5559)
...
create_unspecified_symbol(*val*, *source*, *dynamic_dim=DimDynamic.DUCK*, *constraint_dim=None*, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5668)
...
create_unspecified_symint_and_symbol(*value*, *source*, *dynamic_dim*, *excluded_value=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5467)
...
deserialize_symexpr(*code*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7047)
...
error_on_new_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4757)
...
evaluate_expr(*orig_expr*, *hint=None*, *fx_node=None*, *size_oblivious=False*, *fallback_value=None*, ***, *forcing_spec=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L8593)
...
evaluate_guards_expression(*code*, *args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7057)
...
evaluate_guards_for_args(*placeholders*, *args*, ***, *ignore_static=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7065)
...
evaluate_sym_node(*sym_node*, *size_oblivious=False*, *fallback_value=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L8503)
...
evaluate_symexpr(*code*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7040)
...
format_guards(*verbose=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7159)
...
freeze()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4614)
...
freeze_runtime_asserts()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4623)
...
get_axioms(*symbols=None*, *compute_hint=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7185)
...
get_implications(*e*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7216)
...
get_nontrivial_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7148)
...
get_pruned_guards(*symints*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7078)
...
guard_or_defer_runtime_assert(*orig_expr*, *msg*, *fx_node=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L8994)
...
guarding_hint_or_throw(*expr*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7745)
...
ignore_fresh_unbacked_symbols()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4605)
...
is_unbacked_symint(*symbol*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5619)
...
optimization_hint(*expr*, *fallback=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7763)
...
patch_source_specialization(*source*, *check_fn*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4277)
...
produce_guards(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L6063)
...
produce_guards_expression(*placeholders*, ***, *guards=None*, *ignore_static=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7015)
...
produce_guards_verbose(*placeholders*, *sources*, *source_ref=<function ShapeEnv.<lambda>>*, ***, *guards=None*, *input_contexts=None*, *equalities_inputs=None*, *_simplified=False*, *ignore_static=True*, *langs=('python'*, *'verbose_python')*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L6070)
...
replace(*expr*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7419)
...
set_real_tensor_prop_unbacked_vals(*k*, *v*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4424)
...
simplify(*expr*, *size_oblivious=False*, ***, *axioms=None*, *var_to_range=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7457)
...
size_hint(*expr*, ***, *allow_none=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L7695)
...
suppress_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L4753)
...
transfer_symbols_from_foreign_shape_env(*sizes*, *strides*, *storage_offset*, *source*, ***, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/experimental/symbolic_shapes.py#L5022)
