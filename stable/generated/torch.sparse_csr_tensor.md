...
torch.sparse_csr_tensor(*crow_indices*, *col_indices*, *values*, *size=None*, ***, *dtype=None*, *device=None*, *pin_memory=False*, *requires_grad=False*, *check_invariants=None*) → [Tensor](../tensors.html#torch.Tensor)
