...
torch.gather(*input*, *dim*, *index*, ***, *sparse_grad=False*, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
When `index` is empty, we always return an empty output with the same shape
