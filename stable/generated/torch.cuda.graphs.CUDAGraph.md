...
*class*torch.cuda.graphs.CUDAGraph(*keep_graph=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L66)
...
capture_begin(*pool=None*, *capture_error_mode='global'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L96)
...
capture_end()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L117)
...
debug_dump(*debug_path*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L157)
...
enable_debug_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L153)

Enable debugging mode for CUDAGraph.debug_dump.

instantiate()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L128)
...
pool()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L145)
...
raw_cuda_graph()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L167)
...
raw_cuda_graph_exec()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L174)
...
replay()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L137)

Replay the CUDA work captured by this graph.

reset()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/graphs.py#L141)
