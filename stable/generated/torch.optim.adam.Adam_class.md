...
*class*torch.optim.adam.Adam(*params*, *lr=0.001*, *betas=(0.9, 0.999)*, *eps=1e-08*, *weight_decay=0*, *amsgrad=False*, ***, *foreach=None*, *maximize=False*, *capturable=False*, *differentiable=False*, *fused=None*, *decoupled_weight_decay=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/adam.py#L34)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/adam.py#L214)
