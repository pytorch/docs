...
torch.cuda.comm.broadcast_coalesced(*tensors*, *devices*, *buffer_size=10485760*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/parallel/comm.py#L50)
