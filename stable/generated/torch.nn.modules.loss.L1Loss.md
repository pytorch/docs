...
*class*torch.nn.modules.loss.L1Loss(*size_average=None*, *reduce=None*, *reduction='mean'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L66)
...
forward(*input*, *target*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L129)
