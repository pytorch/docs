...
*class*torch.optim.swa_utils.AveragedModel(*model*, *device=None*, *avg_fn=None*, *multi_avg_fn=None*, *use_buffers=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/swa_utils.py#L165)
...
forward(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/swa_utils.py#L290)
...
state_dict(**args*, *destination=None*, *prefix=''*, *keep_vars=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/module.py#L2199)
...
to(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/module.py#L1259)
...
update_parameters(*model*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/swa_utils.py#L294)
