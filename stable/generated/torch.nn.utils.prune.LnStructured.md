...
*class*torch.nn.utils.prune.LnStructured(*amount*, *n*, *dim=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/utils/prune.py#L675)
...
*classmethod*apply(*module*, *name*, *amount*, *n*, *dim*, *importance_scores=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/utils/prune.py#L769)
...
compute_mask(*t*, *default_mask*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/utils/prune.py#L698)
