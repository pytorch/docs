...
*class*torch.quasirandom.SobolEngine(*dimension*, *scramble=False*, *seed=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/quasirandom.py#L6)
...
draw(*n=1*, *out=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/quasirandom.py#L77)
...
draw_base2(*m*, *out=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/quasirandom.py#L130)
...
fast_forward(*n*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/quasirandom.py#L168)
...
reset()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/quasirandom.py#L160)
