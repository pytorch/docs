...
*class*torch.nn.Module(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/module.py#L407)
...
forward(**input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/module.py#L391)
...
state_dict(***, *destination: T_destination*, *prefix: [str](https://docs.python.org/3/library/stdtypes.html#str) = ''*, *keep_vars: [bool](https://docs.python.org/3/library/functions.html#bool) = False*) → T_destination[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/module.py#L2194)
