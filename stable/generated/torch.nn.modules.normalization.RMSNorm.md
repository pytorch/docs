...
*class*torch.nn.modules.normalization.RMSNorm(*normalized_shape*, *eps=None*, *elementwise_affine=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L343)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L429)
...
forward(*x*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L423)
...
reset_parameters()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L416)
