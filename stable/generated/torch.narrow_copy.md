...
torch.narrow_copy(*input*, *dim*, *start*, *length*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)

Same as [`Tensor.narrow()`](torch.Tensor.narrow.html#torch.Tensor.narrow) except this returns a copy rather
...
[`torch.narrow()`](torch.narrow.html#torch.narrow) for a non copy variant