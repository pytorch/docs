...
torch.copysign(*input*, *other*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)

Create a new floating-point tensor with the magnitude of `input` and the sign of `other`, elementwise.

outi={−∣inputi∣if otheri≤−0.0∣inputi∣if otheri≥0.0\text{out}_{i} = \begin{cases}
 -|\text{input}_{i}| & \text{if } \text{other}_{i} \leq -0.0 \\
 |\text{input}_{i}| & \text{if } \text{other}_{i} \geq 0.0 \\
\end{cases}

outi​={−∣inputi​∣∣inputi​∣​if otheri​≤−0.0if otheri​≥0.0​
...
- **input** ([*Tensor*](../tensors.html#torch.Tensor)) - magnitudes.
- **other** ([*Tensor*](../tensors.html#torch.Tensor)*or**Number*) - contains value(s) whose signbit(s) are
