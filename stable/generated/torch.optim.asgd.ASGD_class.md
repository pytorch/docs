...
*class*torch.optim.asgd.ASGD(*params*, *lr=0.01*, *lambd=0.0001*, *alpha=0.75*, *t0=1000000.0*, *weight_decay=0*, *foreach=None*, *maximize=False*, *differentiable=False*, *capturable=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/asgd.py#L29)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/asgd.py#L125)
