...
*class*torch.ao.nn.quantized.dynamic.Linear(*in_features*, *out_features*, *bias_=True*, *dtype=torch.qint8*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/nn/quantized/dynamic/modules/linear.py#L13)
