...
*class*torch.optim.lr_scheduler.PolynomialLR(*optimizer*, *total_iters=5*, *power=1.0*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L1236)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L1274)
