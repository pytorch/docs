...
*class*torch.autograd.function.NestedIOFunction(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L788)
...
backward(**gradients*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L812)
...
backward_extended(**grad_output*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L865)

User defined backward.

forward(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L822)
...
forward_extended(**input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L859)

User defined forward.

*static*jvp(*ctx*, **grad_inputs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L461)
...
mark_dirty(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L847)

See `Function.mark_dirty()`.

mark_non_differentiable(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L853)

See `Function.mark_non_differentiable()`.

save_for_backward(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L832)

See `Function.save_for_backward()`.

save_for_forward(**tensors*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L101)
...
set_materialize_grads(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L235)
...
*static*setup_context(*ctx*, *inputs*, *output*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L399)
...
*static*vjp(*ctx*, **grad_outputs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L416)
...
*static*vmap(*info*, *in_dims*, **args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/function.py#L547)
