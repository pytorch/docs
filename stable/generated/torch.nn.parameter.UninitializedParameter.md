...
*class*torch.nn.parameter.UninitializedParameter(*requires_grad=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/parameter.py#L204)
...
cls_to_become[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/parameter.py#L30)
