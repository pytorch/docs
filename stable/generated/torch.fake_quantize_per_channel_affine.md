...
torch.fake_quantize_per_channel_affine(*input*, *scale*, *zero_point*, *axis*, *quant_min*, *quant_max*) → [Tensor](../tensors.html#torch.Tensor)
...
- **input** ([*Tensor*](../tensors.html#torch.Tensor)) - the input value(s), in `torch.float32`
- **scale** ([*Tensor*](../tensors.html#torch.Tensor)) - quantization scale, per channel in `torch.float32`
- **zero_point** ([*Tensor*](../tensors.html#torch.Tensor)) - quantization zero_point, per channel in `torch.int32` or `torch.half` or `torch.float32`
