...
*class*torch.nn.modules.loss.BCEWithLogitsLoss(*weight=None*, *size_average=None*, *reduce=None*, *reduction='mean'*, *pos_weight=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L719)
...
forward(*input*, *target*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/loss.py#L836)
