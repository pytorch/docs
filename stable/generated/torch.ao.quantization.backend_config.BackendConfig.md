...
*class*torch.ao.quantization.backend_config.BackendConfig(*name=''*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L291)
...
*classmethod*from_dict(*backend_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L406)
...
set_backend_pattern_config(*config*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L376)
...
set_backend_pattern_configs(*configs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L388)
...
set_name(*name*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L369)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/backend_config/backend_config.py#L428)
