...
torch.round(*input*, ***, *decimals=0*, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
[`torch.ceil()`](torch.ceil.html#torch.ceil), which rounds up.
[`torch.floor()`](torch.floor.html#torch.floor), which rounds down.
[`torch.trunc()`](torch.trunc.html#torch.trunc), which rounds towards zero.
