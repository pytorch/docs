...
*class*torch.optim.lr_scheduler.ExponentialLR(*optimizer*, *gamma*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/optim/lr_scheduler.py#L1007)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/optim/lr_scheduler.py#L1037)
