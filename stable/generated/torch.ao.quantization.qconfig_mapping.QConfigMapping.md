...
*class*torch.ao.quantization.qconfig_mapping.QConfigMapping[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L205)
...
*classmethod*from_dict(*qconfig_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L351)
...
set_global(*global_qconfig*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L248)
...
set_module_name(*module_name*, *qconfig*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L288)
...
set_module_name_object_type_order(*module_name*, *object_type*, *index*, *qconfig*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L296)
...
set_module_name_regex(*module_name_regex*, *qconfig*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L265)
...
set_object_type(*object_type*, *qconfig*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L255)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/qconfig_mapping.py#L324)
