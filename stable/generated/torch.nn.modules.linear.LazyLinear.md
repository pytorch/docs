...
*class*torch.nn.modules.linear.LazyLinear(*out_features*, *bias=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/nn/modules/linear.py#L259)
