...
*class*torch.ao.quantization.backend_config.BackendPatternConfig(*pattern=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L439)
...
add_dtype_config(*dtype_config*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L514)
...
*classmethod*from_dict(*backend_pattern_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L632)
...
set_dtype_configs(*dtype_configs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L522)
...
set_fused_module(*fused_module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L569)
...
set_fuser_method(*fuser_method*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L578)
...
set_observation_type(*observation_type*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L488)
...
set_pattern(*pattern*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L473)
...
set_qat_module(*qat_module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L550)
...
set_reference_quantized_module(*reference_quantized_module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L557)
...
set_root_module(*root_module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L532)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/ao/quantization/backend_config/backend_config.py#L708)
