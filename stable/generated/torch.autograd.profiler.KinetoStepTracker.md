...
*class*torch.autograd.profiler.KinetoStepTracker[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/profiler.py#L1225)
...
*classmethod*current_step()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/profiler.py#L1309)
...
*classmethod*erase_step_count(*requester*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/profiler.py#L1277)
...
*classmethod*increment_step(*requester*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/profiler.py#L1284)
...
*classmethod*init_step_count(*requester*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/profiler.py#L1270)
