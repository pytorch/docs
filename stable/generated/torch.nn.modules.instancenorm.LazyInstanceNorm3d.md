...
*class*torch.nn.modules.instancenorm.LazyInstanceNorm3d(*eps=1e-05*, *momentum=0.1*, *affine=True*, *track_running_stats=True*, *device=None*, *dtype=None*, ***, *bias=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/instancenorm.py#L455)
...
cls_to_become[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/instancenorm.py#L375)
