...
*class*torch.nn.utils.prune.CustomFromMask(*mask*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L805)

*classmethod*apply(*module*, *name*, *mask*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L820)
