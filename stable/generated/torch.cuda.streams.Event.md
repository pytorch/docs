...
*class*torch.cuda.streams.Event(*enable_timing=False*, *blocking=False*, *interprocess=False*, *external=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/cuda/streams.py#L159)
