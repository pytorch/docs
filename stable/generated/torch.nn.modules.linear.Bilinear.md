...
*class*torch.nn.modules.linear.Bilinear(*in1_features*, *in2_features*, *out_features*, *bias=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L162)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L249)
...
forward(*input1*, *input2*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L243)
...
reset_parameters()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L230)
