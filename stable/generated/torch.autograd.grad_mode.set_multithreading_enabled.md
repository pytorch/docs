...
*class*torch.autograd.grad_mode.set_multithreading_enabled(*mode*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/grad_mode.py#L313)
...
clone()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/autograd/grad_mode.py#L348)
