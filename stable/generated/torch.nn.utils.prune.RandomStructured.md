...
*class*torch.nn.utils.prune.RandomStructured(*amount*, *dim=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L569)
...
*classmethod*apply(*module*, *name*, *amount*, *dim=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L653)
...
compute_mask(*t*, *default_mask*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L589)
