...
*class*torch.ao.nn.intrinsic.qat.LinearReLU(*in_features*, *out_features*, *bias=True*, *qconfig=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/ao/nn/intrinsic/qat/modules/linear_relu.py#L19)
