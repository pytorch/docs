...
*class*torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(*optimizer*, *T_0*, *T_mult=1*, *eta_min=0.0*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L2097)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L2161)
...
step(*epoch=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/optim/lr_scheduler.py#L2202)
