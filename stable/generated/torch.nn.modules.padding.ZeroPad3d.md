...
*class*torch.nn.modules.padding.ZeroPad3d(*padding*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/padding.py#L800)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/modules/padding.py#L838)
