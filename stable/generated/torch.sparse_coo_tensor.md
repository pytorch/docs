...
torch.sparse_coo_tensor(*indices*, *values*, *size=None*, ***, *dtype=None*, *device=None*, *pin_memory=False*, *requires_grad=False*, *check_invariants=None*, *is_coalesced=None*) → [Tensor](../tensors.html#torch.Tensor)

Constructs a [sparse tensor in COO(rdinate) format](../sparse.html#sparse-coo-docs) with specified values at the given
`indices`.
...
- **size** (list, tuple, or [`torch.Size`](../size.html#torch.Size), optional) - Size of the sparse tensor. If not
