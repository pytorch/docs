...
*class*torch.nn.modules.loss.TripletMarginLoss(*margin=1.0*, *p=2.0*, *eps=1e-06*, *swap=False*, *size_average=None*, *reduce=None*, *reduction='mean'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/loss.py#L1906)
...
forward(*anchor*, *positive*, *negative*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/loss.py#L2002)
