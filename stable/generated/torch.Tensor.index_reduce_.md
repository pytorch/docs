...
Tensor.index_reduce_(*dim*, *index*, *source*, *reduce*, ***, *include_self=True*) → [Tensor](../tensors.html#torch.Tensor)
...
The [`dim`](torch.Tensor.dim.html#torch.Tensor.dim)th dimension of `source` must have the same size as the
