...
*class*torch.optim.rprop.Rprop(*params*, *lr=0.01*, *etas=(0.5, 1.2)*, *step_sizes=(1e-06, 50)*, ***, *capturable=False*, *foreach=None*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/rprop.py#L30)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/optim/rprop.py#L118)
