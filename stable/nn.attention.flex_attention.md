...
*class*torch.nn.attention.flex_attention.AuxOutput(*lse=None*, *max_scores=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L238)

Auxiliary outputs from flex_attention operation.

Fields will be None if not requested, or contain the tensor if requested.

*class*torch.nn.attention.flex_attention.AuxRequest(*lse=False*, *max_scores=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L228)
...
torch.nn.attention.flex_attention.create_block_mask(*mask_mod*, *B*, *H*, *Q_LEN*, *KV_LEN*, *device=None*, *BLOCK_SIZE=128*, *_compile=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1481)
...
torch.nn.attention.flex_attention.create_mask(*mod_fn*, *B*, *H*, *Q_LEN*, *KV_LEN*, *device=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1430)
...
torch.nn.attention.flex_attention.and_masks(**mask_mods*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1375)
...
torch.nn.attention.flex_attention.or_masks(**mask_mods*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1361)
...
torch.nn.attention.flex_attention.noop_mask(*batch*, *head*, *token_q*, *token_kv*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L352)
...
*class*torch.nn.attention.flex_attention.FlexKernelOptions[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L89)
...
*class*torch.nn.attention.flex_attention.BlockMask(*seq_lengths*, *kv_num_blocks*, *kv_indices*, *full_kv_num_blocks*, *full_kv_indices*, *q_num_blocks*, *q_indices*, *full_q_num_blocks*, *full_q_indices*, *BLOCK_SIZE*, *mask_mod*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L683)
...
*classmethod*from_kv_blocks(*kv_num_blocks*, *kv_indices*, *full_kv_num_blocks=None*, *full_kv_indices=None*, *BLOCK_SIZE=128*, *mask_mod=None*, *seq_lengths=None*, *compute_q_blocks=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L815)
...
numel()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1093)
...
sparsity()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1102)
...
to(*device*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1193)
...
to_dense()[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1113)
...
to_string(*grid_size=(20, 20)*, *limit=4*)[[source]](https://github.com/pytorch/pytorch/blob/v2.12.0/torch/nn/attention/flex_attention.py#L1125)
