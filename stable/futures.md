...
add_done_callback(*callback*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L168)
...
done()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L48)
...
set_exception(*result*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L253)
...
set_result(*result*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L213)
...
then(*callback*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L103)
...
value()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L82)
...
wait()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L61)
...
torch.futures.collect_all(*futures*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L285)
...
torch.futures.wait_all(*futures*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/futures/__init__.py#L317)
