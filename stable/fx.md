...
torch.fx.symbolic_trace(*root*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L1378)
...
torch.fx.wrap(*fn_or_name: _F*) → _F[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L1309)
...
*class*torch.fx.GraphModule(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L517)
...
__init__(*root*, *graph*, *class_name='GraphModule'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L551)
...
add_submodule(*target*, *m*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L774)
...
delete_all_unused_submodules()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L856)
...
delete_submodule(*target*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L814)
...
print_readable(*print_output=True*, *include_stride=False*, *include_device=False*, *colored=False*, ***, *fast_sympy_print=False*, *expanded_def=False*, *additional_meta=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L1124)
...
recompile()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L924)
...
to_folder(*folder*, *module_name='FxModule'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph_module.py#L689)
...
*class*torch.fx.Graph(*owning_module=None*, *tracer_cls=None*, *tracer_extras=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1396)
...
__init__(*owning_module=None*, *tracer_cls=None*, *tracer_extras=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1445)
...
call_function(*the_function*, *args=None*, *kwargs=None*, *type_expr=None*, *name=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1958)
...
call_method(*method_name*, *args=None*, *kwargs=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1919)
...
call_module(*module_name*, *args=None*, *kwargs=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1866)
...
create_node(*op*, *target*, *args=None*, *kwargs=None*, *name=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1584)
...
create_size_node(*tensor_node*, *dim*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2017)
...
create_storage_offset_node(*tensor_node*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2035)
...
create_stride_node(*tensor_node*, *dim*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2026)
...
eliminate_dead_code(*is_impure_node=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2689)
...
erase_node(*to_erase*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1674)
...
find_nodes(***, *op*, *target=None*, *sort=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1497)
...
get_attr(*qualified_name*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1798)
...
graph_copy(*g*, *val_map*, *return_output_node=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1524)
...
inserting_after(*n=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1740)
...
inserting_before(*n=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1715)
...
lint()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2609)
...
materialize_symint(*value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2380)
...
materialize_symints(*values*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2109)
...
node_copy(*node*, *arg_transform=<function Graph.<lambda>>*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2385)
...
on_generate_code(*make_transformer*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2782)
...
output(*result*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2422)
...
output_node()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1490)
...
placeholder(*name*, *type_expr=None*, *default_value*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1765)
...
print_tabular()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2587)
...
process_inputs(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1663)
...
process_outputs(*out*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L1670)
...
python_code(*root_module*, ***, *verbose=False*, *include_stride=False*, *include_device=False*, *colored=False*, *expanded_def=False*, *record_func=False*, *additional_meta=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2460)
...
set_codegen(*codegen*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/graph.py#L2778)

Warning

This API is experimental and is *NOT* backward-compatible.

*class*torch.fx.Node(*graph*, *name*, *op*, *target*, *args*, *kwargs*, *return_type=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L257)
...
append(*x*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L440)
...
format_node(*placeholder_names=None*, *maybe_return_typename=None*, ***, *include_tensor_metadata=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L615)
...
insert_arg(*idx*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L527)
...
is_impure(*impure_random=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L759)
...
normalized_arguments(*root*, *arg_types=None*, *kwarg_types=None*, *normalize_to_only_use_kwargs=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L810)
...
prepend(*x*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L424)
...
replace_all_uses_with(*replace_with*, *delete_user_cb=None*, ***, *propagate_meta=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L712)
...
replace_input_with(*old_input*, *new_input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L868)
...
update_arg(*idx*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L512)
...
update_kwarg(*key*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/node.py#L554)
...
*class*torch.fx.Tracer(*autowrap_modules=(math,)*, *autowrap_functions=()*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L281)
...
call_module(*m*, *forward*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L547)
...
create_arg(*a*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L391)
...
create_args_for_root(*root_fn*, *is_module*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L676)
...
create_node(*kind*, *target*, *args*, *kwargs*, *name=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L214)
...
create_proxy(*kind*, *target*, *args*, *kwargs*, *name=None*, *type_expr=None*, *proxy_factory_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L339)
...
get_fresh_qualname(*prefix*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L365)
...
getattr(*attr*, *attr_val*, *parameter_proxy_cache*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L607)
...
is_leaf_module(*m*, *module_qualified_name*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L494)
...
iter(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L496)
...
keys(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L514)
...
path_of_module(*mod*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L519)
...
proxy(*node*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L335)
...
to_bool(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L485)
...
trace(*root*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/_symbolic_trace.py#L787)
...
*class*torch.fx.Proxy(*node*, *tracer=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/proxy.py#L599)
...
*class*torch.fx.Interpreter(*module*, *garbage_collect_values=True*, *graph=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L51)
...
boxed_run(*args_list*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L239)
...
call_function(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L356)
...
call_method(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L379)
...
call_module(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L404)
...
fetch_args_kwargs_from_env(*n*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L472)
...
fetch_attr(*target*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L451)
...
get_attr(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L334)
...
map_nodes_to_values(*args*, *n*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L494)
...
output(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L430)
...
placeholder(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L297)
...
run(**args*, *initial_env=None*, *enable_io_processing=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L147)
...
run_node(*n*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L273)
...
*class*torch.fx.Transformer(*module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L517)
...
call_function(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L640)
...
call_module(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L630)
...
get_attr(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L610)
...
placeholder(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L587)
...
transform()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/interpreter.py#L647)
...
torch.fx.replace_pattern(*gm*, *pattern*, *replacement*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/subgraph_rewriter.py#L95)
...
torch.fx.traceback.annotate(*annotation_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/traceback.py#L311)
...
torch.fx.passes.tools_common.stable_topological_sort(*gm*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/tools_common.py#L333)
...
torch.fx.passes.graph_manipulation.get_size_of_all_nodes(*fx_module*, *args=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/graph_manipulation.py#L56)
...
torch.fx.passes.graph_manipulation.get_size_of_node(*fx_module*, *node*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/graph_manipulation.py#L87)
...
torch.fx.passes.param_fetch.default_matching(*name*, *target_version*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/param_fetch.py#L18)
...
torch.fx.passes.param_fetch.extract_attrs_for_lowering(*mod*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/param_fetch.py#L58)
...
torch.fx.passes.param_fetch.lift_lowering_attrs_to_nodes(*fx_module*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/param_fetch.py#L85)
...
torch.fx.passes.split_utils.split_by_tags(*gm*, *tags*, *return_fqn_mapping=False*, *return_tuple=False*, *GraphModuleCls=<class 'torch.fx.graph_module.GraphModule'>*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/split_utils.py#L76)
...
torch.fx.passes.utils.common.lift_subgraph_as_module(*gm*, *subgraph*, *comp_name=''*, *class_name='GraphModule'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/utils/common.py#L24)
...
torch.fx.passes.utils.fuser_utils.fuse_as_graphmodule(*gm*, *nodes*, *module_name*, *partition_lookup_table=None*, ***, *always_return_tuple=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/utils/fuser_utils.py#L97)
...
torch.fx.passes.utils.source_matcher_utils.get_source_partitions(*graph*, *wanted_sources*, *filter_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/utils/source_matcher_utils.py#L55)
...
torch.fx.passes.annotate_getitem_nodes.annotate_getitem_nodes(*graph*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/annotate_getitem_nodes.py#L7)
...
torch.fx.passes.split_utils.move_non_tensor_nodes_on_boundary(*subgraphs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/split_utils.py#L346)
...
torch.fx.passes.splitter_base.generate_inputs_for_submodules(*model*, *inputs*, *target_submodules*, *deepcopy=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/fx/passes/splitter_base.py#L440)
