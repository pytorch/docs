...
torch.cuda.tunable.enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L217)

This is the big on/off switch for all TunableOp implementations.

torch.cuda.tunable.is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L222)
...
torch.cuda.tunable.tuning_enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L227)
...
torch.cuda.tunable.tuning_is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L236)
...
torch.cuda.tunable.record_untuned_enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L241)
...
torch.cuda.tunable.record_untuned_is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L249)
...
torch.cuda.tunable.set_max_tuning_duration(*duration*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L254)
...
torch.cuda.tunable.get_max_tuning_duration()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L263)
...
torch.cuda.tunable.set_max_tuning_iterations(*iterations*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L268)
...
torch.cuda.tunable.get_max_tuning_iterations()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L277)
...
torch.cuda.tunable.set_filename(*filename*, *insert_device_ordinal=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L282)
...
torch.cuda.tunable.get_filename()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L292)
...
torch.cuda.tunable.get_results()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L297)
...
torch.cuda.tunable.get_validators()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L302)
...
torch.cuda.tunable.read_file(*filename=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L307)
...
torch.cuda.tunable.tune_gemm_in_file(*filename*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L337)

tune GEMM in file.

torch.cuda.tunable.mgpu_tune_gemm_in_file(*filename_pattern*, *num_gpus*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L797)

Process one or more files and distribute work over one or more GPUs.

torch.cuda.tunable.set_rotating_buffer_size(*buffer_size*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L317)
...
torch.cuda.tunable.get_rotating_buffer_size()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L325)
...
torch.cuda.tunable.set_numerical_check_tolerances(*enable*, *atol=1e-05*, *rtol=1e-05*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/tunable.py#L330)
