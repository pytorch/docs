...
torch.cuda.tunable.enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L227)

This is the big on/off switch for all TunableOp implementations.

torch.cuda.tunable.is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L232)
...
torch.cuda.tunable.tuning_enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L237)
...
torch.cuda.tunable.tuning_is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L246)
...
torch.cuda.tunable.record_untuned_enable(*val=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L251)
...
torch.cuda.tunable.record_untuned_is_enabled()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L259)
...
torch.cuda.tunable.set_max_tuning_duration(*duration*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L264)
...
torch.cuda.tunable.get_max_tuning_duration()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L273)
...
torch.cuda.tunable.set_max_tuning_iterations(*iterations*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L278)
...
torch.cuda.tunable.get_max_tuning_iterations()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L287)
...
torch.cuda.tunable.set_cublaslt_requested_algo_count(*count*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L292)

Set the number of cuBLASLt heuristic algorithms to request on CUDA.

Values less than 1 are clamped to 1.

torch.cuda.tunable.get_cublaslt_requested_algo_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L300)
...
torch.cuda.tunable.set_filename(*filename*, *insert_device_ordinal=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L308)
...
torch.cuda.tunable.get_filename()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L318)
...
torch.cuda.tunable.get_results()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L323)
...
torch.cuda.tunable.get_validators()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L328)
...
torch.cuda.tunable.read_file(*filename=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L333)
...
torch.cuda.tunable.tune_gemm_in_file(*filename*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L363)

tune GEMM in file.

torch.cuda.tunable.mgpu_tune_gemm_in_file(*filename_pattern*, *num_gpus*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L841)

Process one or more files and distribute work over one or more GPUs.

torch.cuda.tunable.set_rotating_buffer_size(*buffer_size*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L343)
...
torch.cuda.tunable.get_rotating_buffer_size()[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L351)
...
torch.cuda.tunable.set_numerical_check_tolerances(*enable*, *atol=1e-05*, *rtol=1e-05*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/cuda/tunable.py#L356)
