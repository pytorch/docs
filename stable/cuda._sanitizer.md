...
torch.cuda._sanitizer.enable_cuda_sanitizer()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/_sanitizer.py#L659)
...
torch.cuda._sanitizer.zip_arguments(*schema*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/_sanitizer.py#L474)
...
torch.cuda._sanitizer.zip_by_key(*a*, *b*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/_sanitizer.py#L468)
