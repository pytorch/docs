...
torch._higher_order_ops.switch.switch(*index*, *branches*, *operands=()*)[[source]](https://github.com/pytorch/pytorch/blob/v2.14.0/torch/_higher_order_ops/switch.py#L95)
