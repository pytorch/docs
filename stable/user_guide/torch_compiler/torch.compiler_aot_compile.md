...
[AOTInductor](torch.compiler_aot_inductor.html#torch-compiler-aot-inductor) operates on
[`torch.export()`](export/api_reference.html#module-torch.export)-ed models and produces shared libraries for deployment in
...
Using the same `MyModel` from Compiling a module
above:
...
[`DTensor`](../../distributed.tensor.html#torch.distributed.tensor.DTensor), `aot_compile()` can be combined
