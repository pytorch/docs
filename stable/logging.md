...
| [`set_logs`](generated/torch._logging.set_logs.html#torch._logging.set_logs) | Sets the log level for individual components and toggles individual log artifact types. |
| --- | --- |
