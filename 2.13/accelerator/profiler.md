...
[`torch::profiler::impl::OpenRegMethods`](https://github.com/pytorch/pytorch/blob/main/test/cpp_extensions/open_registration_extension/torch_openreg/csrc/profiler/stubs/openreg.cpp) inherits from `ProfilerStubs` and wires the hooks described above:
