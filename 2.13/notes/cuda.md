...
Certain GPUs have increased performance when doing *all* FP16 GEMM accumulation
...
1. Your warmup must run at least 11 DDP-enabled eager iterations before capture.
