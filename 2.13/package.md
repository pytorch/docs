...
*class*torch.package.PackagingError(*dependency_graph*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L118)
...
*class*torch.package.EmptyMatchError[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L112)
...
*class*torch.package.PackageExporter(*f*, *importer=<torch.package.importer._SysImporter object>*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L175)
...
__init__(*f*, *importer=<torch.package.importer._SysImporter object>*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L206)
...
add_dependency(*module_name*, *dependencies=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L455)

Given a module, add it to the dependency graph according to patterns
specified by the user.

all_paths(*src*, *dst*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1186)
...
close()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1089)
...
denied_modules()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1166)
...
deny(*include*, ***, *exclude=()*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L912)
...
dependency_graph_string()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1120)
...
extern(*include*, ***, *exclude=()*, *allow_empty=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L881)
...
externed_modules()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1139)
...
get_rdeps(*module_name*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1175)
...
get_unique_id()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L319)
...
intern(*include*, ***, *exclude=()*, *allow_empty=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L814)
...
interned_modules()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1148)
...
mock(*include*, ***, *exclude=()*, *allow_empty=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L840)
...
mocked_modules()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L1157)
...
register_extern_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L757)
...
register_intern_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L795)
...
register_mock_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L776)
...
save_binary(*package*, *resource*, *binary*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L746)
...
save_module(*module_name*, *dependencies=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L514)
...
save_pickle(*package*, *resource*, *obj*, *dependencies=True*, *pickle_protocol=3*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L586)
...
save_source_file(*module_name*, *file_or_directory*, *dependencies=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L265)
...
save_source_string(*module_name*, *src*, *is_package=False*, *dependencies=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L374)
...
save_text(*package*, *resource*, *text*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_exporter.py#L736)
...
*class*torch.package.PackageImporter(*file_or_buffer*, *module_allowed=<function PackageImporter.<lambda>>*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L66)
...
__init__(*file_or_buffer*, *module_allowed=<function PackageImporter.<lambda>>*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L86)
...
file_structure(***, *include='**'*, *exclude=()*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L326)
...
id()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L317)
...
import_module(*name*, *package=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L158)
...
load_binary(*package*, *resource*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L181)
...
load_pickle(*package*, *resource*, *map_location=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L216)
...
load_text(*package*, *resource*, *encoding='utf-8'*, *errors='strict'*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L195)
...
python_version()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/package_importer.py#L345)
...
*class*torch.package.Directory(*name*, *is_dir*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/file_structure_representation.py#L9)
...
has_file(*filename*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/file_structure_representation.py#L47)
...
torch.package.analyze.find_first_use_of_broken_modules.find_first_use_of_broken_modules(*exc*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/analyze/find_first_use_of_broken_modules.py#L7)
...
torch.package.analyze.is_from_package.is_from_package(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/analyze/is_from_package.py#L7)
...
torch.package.analyze.trace_dependencies.trace_dependencies(*callable*, *inputs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/package/analyze/trace_dependencies.py#L10)
