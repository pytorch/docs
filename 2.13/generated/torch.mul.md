...
torch.mul(*input*, *other*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
- **other** ([*Tensor*](../tensors.html#torch.Tensor)*or**Number*) - the tensor or number to multiply input by.
