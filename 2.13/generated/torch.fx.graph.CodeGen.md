...
*class*torch.fx.graph.CodeGen[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L359)

Warning

This API is experimental and is *NOT* backward-compatible.

additional_globals()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L486)
...
gen_fn_def(*free_vars*, *maybe_return_annotation*, ***, *expanded_def=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L423)
...
generate_output(*output_args*, ***, *descs=None*, *repr_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L447)
...
process_inputs(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L467)
...
process_outputs(*outputs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/graph.py#L478)
