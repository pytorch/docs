...
*class*torch.ao.quantization.fx.custom_config.FuseCustomConfig[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/fx/custom_config.py#L471)
...
*classmethod*from_dict(*fuse_custom_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/fx/custom_config.py#L498)
...
set_preserved_attributes(*attributes*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/fx/custom_config.py#L489)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/ao/quantization/fx/custom_config.py#L513)
