...
*class*torch.autograd.grad_mode.set_grad_enabled(*mode*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/grad_mode.py#L144)
...
clone()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/grad_mode.py#L206)
