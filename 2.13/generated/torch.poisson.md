...
torch.poisson(*input*, *generator=None*) → [Tensor](../tensors.html#torch.Tensor)
...
**input** ([*Tensor*](../tensors.html#torch.Tensor)) - the input tensor containing the rates of the Poisson distribution
