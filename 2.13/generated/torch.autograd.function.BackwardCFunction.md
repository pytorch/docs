...
*class*torch.autograd.function.BackwardCFunction[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/function.py#L297)

This class is used for internal autograd work. Do not use.

apply(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/function.py#L313)
...
apply_boxed(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/function.py#L327)
...
apply_jvp(**args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/function.py#L335)
