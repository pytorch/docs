...
torch.addcmul(*input*, *tensor1*, *tensor2*, ***, *value=1*, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
The shapes of [`tensor`](torch.tensor.html#torch.tensor), `tensor1`, and `tensor2` must be
...
- **tensor1** ([*Tensor*](../tensors.html#torch.Tensor)) - the tensor to be multiplied
- **tensor2** ([*Tensor*](../tensors.html#torch.Tensor)) - the tensor to be multiplied
