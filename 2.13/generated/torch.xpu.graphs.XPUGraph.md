...
*class*torch.xpu.graphs.XPUGraph(*keep_graph=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L53)
...
capture_begin(*pool=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L73)
...
capture_end()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L86)
...
debug_dump(*debug_path*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L125)
...
enable_debug_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L121)

Enable debugging mode for XPUGraph.debug_dump.

instantiate()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L96)
...
pool()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L113)
...
raw_xpu_graph()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L135)
...
raw_xpu_graph_exec()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L142)
...
replay()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L105)

Replay the XPU work captured by this graph.

reset()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/graphs.py#L109)
