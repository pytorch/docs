...
*class*torch.autograd.grad_mode.enforce_grad_layout_policy(*enable=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/grad_mode.py#L356)
...
clone()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/autograd/grad_mode.py#L407)
