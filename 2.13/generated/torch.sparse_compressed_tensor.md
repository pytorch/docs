...
torch.sparse_compressed_tensor(*compressed_indices*, *plain_indices*, *values*, *size=None*, ***, *dtype=None*, *layout=None*, *device=None*, *pin_memory=False*, *requires_grad=False*, *check_invariants=None*) → [Tensor](../tensors.html#torch.Tensor)
...
`values`.
- **layout** ([`torch.layout`](../tensor_attributes.html#torch.layout), required) - the desired layout of
