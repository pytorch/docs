...
*class*torch.nn.utils.prune.BasePruningMethod[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L11)
...
*abstract*compute_mask(*t*, *default_mask*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L33)
