...
torch.triu(*input*, *diagonal=0*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
The argument [`diagonal`](torch.diagonal.html#torch.diagonal) controls which diagonal to consider. If
[`diagonal`](torch.diagonal.html#torch.diagonal) = 0, all elements on and above the main diagonal are
