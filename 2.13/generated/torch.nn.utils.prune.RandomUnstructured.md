...
*class*torch.nn.utils.prune.RandomUnstructured(*amount*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L444)
...
*classmethod*apply(*module*, *name*, *amount*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/utils/prune.py#L483)
