...
*class*torch.nn.modules.flatten.Flatten(*start_dim=1*, *end_dim=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/flatten.py#L12)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/flatten.py#L57)
...
forward(*input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/flatten.py#L51)
