...
*class*torch.nn.modules.batchnorm.SyncBatchNorm(*num_features*, *eps=1e-05*, *momentum=0.1*, *affine=True*, *track_running_stats=True*, *process_group=None*, *device=None*, *dtype=None*, ***, *bias=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/batchnorm.py#L650)
...
*classmethod*convert_sync_batchnorm(*module*, *process_group=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/batchnorm.py#L889)
...
forward(*input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/batchnorm.py#L790)
