...
*class*torch.optim.sparse_adam.SparseAdam(*params*, *lr=0.001*, *betas=(0.9, 0.999)*, *eps=1e-08*, *maximize=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/optim/sparse_adam.py#L13)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/optim/sparse_adam.py#L63)
