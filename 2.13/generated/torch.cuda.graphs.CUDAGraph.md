...
*class*torch.cuda.graphs.CUDAGraph(*keep_graph=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L78)
...
capture_begin(*pool=None*, *capture_error_mode='global'*, *check_input_liveness=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L120)
...
capture_end()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L160)
...
debug_dump(*debug_path*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L207)
...
enable_debug_mode()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L203)

Enable debugging mode for CUDAGraph.debug_dump.

get_graph_data()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L231)
...
instantiate()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L173)
...
pool()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L195)
...
raw_cuda_graph()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L217)
...
raw_cuda_graph_exec()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L224)
...
replay()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L182)

Replay the CUDA work captured by this graph.

reset()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/cuda/graphs.py#L188)
