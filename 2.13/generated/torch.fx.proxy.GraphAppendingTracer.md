...
*class*torch.fx.proxy.GraphAppendingTracer(*graph*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/proxy.py#L578)

Note

Backwards-compatibility for this API is guaranteed.

create_arg(*a*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/proxy.py#L410)
