...
*class*torch.nn.modules.normalization.LocalResponseNorm(*size*, *alpha=0.0001*, *beta=0.75*, *k=1.0*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L16)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L67)

Return the extra representation of the module.

forward(*input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/normalization.py#L61)
