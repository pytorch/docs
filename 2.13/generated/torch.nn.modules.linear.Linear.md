...
*class*torch.nn.modules.linear.Linear(*in_features*, *out_features*, *bias=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L53)
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L136)
...
forward(*input*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L130)
...
reset_parameters()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/linear.py#L117)
