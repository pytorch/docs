...
*class*torch.xpu.memory.MemPool(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/memory.py#L550)
...
snapshot()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/memory.py#L586)
...
use_count()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/xpu/memory.py#L582)
