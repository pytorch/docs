...
*class*torch.fx.experimental.symbolic_shapes.ShapeEnv(***, *should_record_events=None*, *tracked_fakes=None*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L3845)

add_backed_var_to_val(*expr*, *val*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5805)

Adds a new symbol to the symbolic environment.

add_var_to_val(*expr*, *val*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5821)

Deprecated: use add_backed_var_to_val instead.

bind_symbols(*placeholders*, *args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6956)
...
bound_sympy(*expr*, *size_oblivious=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7031)
...
check_equal(*other*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4279)

Compare another ShapeEnv for equivalence

cleanup()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L8636)
...
create_symbol(*val*, *source*, *dynamic_dim=DimDynamic.DUCK*, *constraint_dim=None*, *positive=True*, *do_not_specialize_zero_one=False*, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5492)
...
create_symbolic_sizes_strides_storage_offset(*ex*, *source*, ***, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4788)
...
create_symboolnode(*sym*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5317)
...
create_symfloatnode(*sym*, ***, *hint*, *source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5249)
...
create_symintnode(*sym*, ***, *hint*, *source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5203)
...
create_unbacked_symbool()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5435)
...
create_unbacked_symfloat()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5360)
...
create_unbacked_symint(*source=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5387)
...
create_unspecified_symbol(*val*, *source*, *dynamic_dim=DimDynamic.DUCK*, *constraint_dim=None*, *symbolic_context=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5462)
...
create_unspecified_symint_and_symbol(*value*, *source*, *dynamic_dim*, *excluded_value=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5295)
...
deserialize_symexpr(*code*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6890)
...
error_on_new_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4656)
...
evaluate_expr(*orig_expr*, *hint=None*, *fx_node=None*, *size_oblivious=False*, *fallback_value=None*, ***, *forcing_spec=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L8270)
...
evaluate_guards_expression(*code*, *args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6900)
...
evaluate_guards_expression_with_source_info(*guards*, *args*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6908)
...
evaluate_guards_for_args(*placeholders*, *args*, ***, *ignore_static=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6929)
...
evaluate_sym_node(*sym_node*, *size_oblivious=False*, *fallback_value=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L8180)
...
evaluate_symexpr(*code*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6883)
...
format_guards(*verbose=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7023)
...
freeze()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4513)
...
freeze_runtime_asserts()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4522)
...
get_axioms(*symbols=None*, *compute_hint=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7049)
...
get_implications(*e*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7080)
...
get_nontrivial_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7012)
...
get_pruned_guards(*symints*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6942)
...
guard_or_defer_runtime_assert(*orig_expr*, *msg*, *fx_node=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L8672)
...
guarding_hint_or_throw(*expr*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7446)
...
ignore_fresh_unbacked_symbols()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4504)
...
is_unbacked_symint(*symbol*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5413)
...
optimization_hint(*expr*, *fallback=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7464)
...
patch_source_specialization(*source*, *check_fn*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4233)
...
produce_guards(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5855)
...
produce_guards_expression(*placeholders*, ***, *guards=None*, *ignore_static=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6831)
...
produce_guards_expression_with_source_info(*placeholders*, ***, *guards=None*, *ignore_static=True*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L6848)
...
produce_guards_verbose(*placeholders*, *sources*, *source_ref=<function ShapeEnv.<lambda>>*, ***, *guards=None*, *input_contexts=None*, *equalities_inputs=None*, *_simplified=False*, *ignore_static=True*, *langs=('python'*, *'verbose_python')*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L5862)
...
replace(*expr*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7278)
...
set_real_tensor_prop_unbacked_vals(*k*, *v*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4378)
...
simplify(*expr*, *size_oblivious=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7316)
...
size_hint(*expr*, ***, *allow_none=False*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L7396)
...
suppress_guards()[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4652)
...
transfer_symbols_from_foreign_shape_env(*sizes*, *strides*, *storage_offset*, *source*, ***, *symbolic_context=None*, *hint_overrides=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/fx/experimental/symbolic_shapes.py#L4822)
