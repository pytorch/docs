...
*class*torch.optim.lr_scheduler.LRScheduler(*optimizer*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/optim/lr_scheduler.py#L95)
