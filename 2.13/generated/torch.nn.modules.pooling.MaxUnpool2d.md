...
*class*torch.nn.modules.pooling.MaxUnpool2d(*kernel_size*, *stride=None*, *padding=0*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/pooling.py#L407)
...
forward(*input*, *indices*, *output_size=None*)[[source]](https://github.com/pytorch/pytorch/blob/v2.13.0/torch/nn/modules/pooling.py#L494)
