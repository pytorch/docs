...
*class*torch.distributed.pipelining.SplitPoint(*value*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/_IR.py#L1192)
...
torch.distributed.pipelining.pipeline(*module*, *mb_args*, *mb_kwargs=None*, *split_spec=None*, *split_policy=None*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/_IR.py#L1247)
...
*class*torch.distributed.pipelining.Pipe(*split_gm*, *num_stages*, *has_loss_and_backward*, *loss_spec*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/_IR.py#L561)

torch.distributed.pipelining.pipe_split()[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/_IR.py#L363)
...
*class*torch.distributed.pipelining.microbatch.TensorChunkSpec(*split_dim*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/microbatch.py#L60)

Class used to specify chunking of inputs

torch.distributed.pipelining.microbatch.split_args_kwargs_into_chunks(*args*, *kwargs*, *chunks*, *args_chunk_spec=None*, *kwargs_chunk_spec=None*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/microbatch.py#L378)
...
torch.distributed.pipelining.microbatch.merge_chunks(*chunks*, *chunk_spec*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/microbatch.py#L493)
...
torch.distributed.pipelining.stage.build_stage(*stage_module*, *stage_index*, *pipe_info*, *device*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/stage.py#L1554)
...
step(**args*, *target=None*, *losses=None*, *return_outputs=True*, *loss_kwargs=None*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/schedules.py#L730)
...
step(**args*, *target=None*, *losses=None*, *return_outputs=True*, *loss_kwargs=None*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/schedules.py#L1924)
...
torch.distributed.pipelining.schedules.get_schedule_class(*schedule_name*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/distributed/pipelining/schedules.py#L3610)
