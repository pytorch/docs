...
torch.compiler.config.accumulated_recompile_limit*: [int](https://docs.python.org/3/builtins/functions.html#int)**= 256*
...
torch.compiler.config.allow_unspec_int_on_nn_module*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.assume_static_by_default*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= True*
...
torch.compiler.config.automatic_dynamic_shapes*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= True*
...
torch.compiler.config.capture_dynamic_output_shape_ops*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.capture_scalar_outputs*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.compile_on_one_rank*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.fail_on_recompile_limit_hit*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.force_disable_caches*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*

Force disables all caching - This will take precedence over and override any other caching flag

torch.compiler.config.job_id*: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)**= None*
...
torch.compiler.config.log_file_name*: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None)**= None*
...
torch.compiler.config.recompile_limit*: [int](https://docs.python.org/3/builtins/functions.html#int)**= 8*
...
torch.compiler.config.reorderable_logging_functions*: [set](https://docs.python.org/3/builtins/stdtypes.html#set)**= {}*
...
torch.compiler.config.skip_tensor_guards_with_matching_dict_tags*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= True*
...
torch.compiler.config.verbose*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
...
torch.compiler.config.wrap_top_frame*: [bool](https://docs.python.org/3/builtins/functions.html#bool)**= False*
