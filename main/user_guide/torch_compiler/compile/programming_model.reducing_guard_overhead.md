...
conceptual background, see [Guards](programming_model.dynamo_core_concepts.html) in
...
compilation, see [Dealing with Recompilations](programming_model.recompilation.html).
...
`TORCH_LOGS=guards`; see [tlparse / TORCH_TRACE](programming_model.observability.html).
