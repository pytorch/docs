...
[The torch.compile troubleshooting doc](torch.compiler_troubleshooting.html#torch-compiler-troubleshooting)
...
Which NumPy features does torch.compile support?. More generally, it is useful to keep in mind
