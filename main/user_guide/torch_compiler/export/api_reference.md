...
torch.export.export(*mod*, *args*, *kwargs=None*, ***, *dynamic_shapes=None*, *strict=False*, *preserve_module_call_signature=()*, *prefer_deferred_runtime_asserts_over_guards=False*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/__init__.py#L59)
...
*class*torch.export.ExportedProgram(*root*, *graph*, *graph_signature*, *state_dict*, *range_constraints*, *module_call_graph*, *example_inputs=None*, *constants=None*, ***, *verifiers=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1062)
...
buffers()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1204)
...
module(*check_guards=True*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1471)
...
named_buffers()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1212)
...
named_parameters()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1195)
...
parameters()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1187)
...
run_decompositions(*decomp_table=None*, *decompose_custom_triton_ops=False*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1506)
...
validate()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L1692)
...
*class*torch.export.dynamic_shapes.AdditionalInputs[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L841)
...
add(*args*, *kwargs=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L874)

Additional input `args()` and `kwargs()`.

dynamic_shapes(*m*, *args*, *kwargs=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L887)
...
verify(*ep*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L929)

Verifies that an exported program is valid for each additional input.

*class*torch.export.dynamic_shapes.Dim(*name*, ***, *min=None*, *max=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L109)
...
*class*torch.export.dynamic_shapes.ShapesCollection[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L741)
...
dynamic_shapes(*m*, *args*, *kwargs=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L815)

Generates the `dynamic_shapes()` pytree structure according to `args()` and `kwargs()`.

torch.export.dynamic_shapes.dims(**names*, *min=None*, *max=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L360)
...
torch.export.dynamic_shapes.refine_dynamic_shapes_from_suggested_fixes(*msg*, *dynamic_shapes*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/dynamic_shapes.py#L1287)
...
torch.export.save(*ep*, *f*, ***, *extra_files=None*, *opset_version=None*, *pickle_protocol=2*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/__init__.py#L264)
...
torch.export.load(*f*, ***, *extra_files=None*, *expected_opset_version=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/__init__.py#L336)
...
torch.export.pt2_archive._package.package_pt2(*f*, ***, *exported_programs=None*, *aoti_files=None*, *extra_files=None*, *opset_version=None*, *pickle_protocol=2*, *executorch_files=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L646)
...
torch.export.pt2_archive._package.load_pt2(*f*, ***, *expected_opset_version=None*, *run_single_threaded=False*, *num_runners=1*, *device_index=-1*, *load_weights_from_disk=False*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L1080)
...
torch.export.draft_export(*mod*, *args*, *kwargs=None*, ***, *dynamic_shapes=None*, *preserve_module_call_signature=()*, *strict=False*, *prefer_deferred_runtime_asserts_over_guards=False*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/__init__.py#L490)
...
*class*torch.export.unflatten.FlatArgsAdapter[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L311)

Adapts input arguments with `input_spec` to align `target_spec`.

*abstract*adapt(*target_spec*, *input_spec*, *input_args*, *metadata=None*, *obj=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L316)
...
get_flat_arg_paths()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L328)
...
*class*torch.export.unflatten.InterpreterModule(*graph*, *ty=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L167)
...
*class*torch.export.unflatten.InterpreterModuleDispatcher(*attrs*, *call_modules*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L262)
...
torch.export.unflatten.unflatten(*module*, *flat_args_adapter=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/unflatten.py#L803)
...
torch.export.register_dataclass(*cls*, ***, *serialized_type_name=None*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/__init__.py#L526)
...
*class*torch.export.decomp_utils.CustomDecompTable[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L31)
...
copy()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L104)

Return type:

*CustomDecompTable*

items()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L141)

keys()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L74)

materialize()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L145)
...
pop(**args*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L111)

update(*other_dict*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/decomp_utils.py#L81)

torch.export.passes.move_to_device_pass(*ep*, *location*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/passes/__init__.py#L11)
...
archive_version()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L229)
...
get_file_names()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L242)
...
read_bytes(*name*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L214)
...
read_string(*name*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L221)
...
close()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L188)

Close the archive.

count_prefix(*prefix*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L125)
...
has_record(*name*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L119)
...
write_bytes(*name*, *data*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L135)

Write a bytes object to the archive.
name: The destination file inside the archive.
data: The bytes object to write.

write_file(*name*, *file_path*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L156)

Copy a file into the archive.
name: The destination file inside the archive.
file_path: The source file on disk.

write_folder(*archive_dir*, *folder_dir*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L169)

Copy a folder into the archive.
archive_dir: The destination folder inside the archive.
folder_dir: The source folder on disk.

write_string(*name*, *data*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L145)

Write a string object to the archive.
name: The destination file inside the archive.
data: The string object to write.

torch.export.pt2_archive.is_pt2_package(*serialized_model*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/pt2_archive/_package.py#L74)
...
torch.export.exported_program.default_decompositions()[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/exported_program.py#L322)
...
*class*torch.export.custom_obj.ScriptObjectMeta(*constant_name*, *class_fqn*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/custom_obj.py#L7)

Metadata which is stored on nodes representing ScriptObjects.

*class*torch.export.graph_signature.ConstantArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*, *value: [int](https://docs.python.org/3/library/functions.html#int) | [float](https://docs.python.org/3/library/functions.html#float) | [bool](https://docs.python.org/3/library/functions.html#bool) | [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L64)
...
*class*torch.export.graph_signature.ExportGraphSignature(*input_specs*, *output_specs*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L165)
...
get_replace_hook(*replace_inputs=False*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L568)
...
replace_all_uses(*old*, *new*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L543)
...
*class*torch.export.graph_signature.InputKind(*value*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L81)
...
*class*torch.export.graph_signature.OutputKind(*value*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L121)
...
*class*torch.export.graph_signature.SymBoolArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L52)

name*: [str](https://docs.python.org/3/library/stdtypes.html#str)*

*class*torch.export.graph_signature.SymFloatArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L47)

name*: [str](https://docs.python.org/3/library/stdtypes.html#str)*

*class*torch.export.graph_signature.SymIntArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L42)

name*: [str](https://docs.python.org/3/library/stdtypes.html#str)*

*class*torch.export.graph_signature.TensorArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L32)

name*: [str](https://docs.python.org/3/library/stdtypes.html#str)*

*class*torch.export.graph_signature.TokenArgument(*name: [str](https://docs.python.org/3/library/stdtypes.html#str)*)[[source]](https://github.com/pytorch/pytorch/blob/bb84990ad380b2b3991c759fcefffdbd0400ad85/torch/export/graph_signature.py#L37)
