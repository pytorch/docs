...
[`torch.export.export()`](api_reference.html#torch.export.export). It is intended to help build your intuition
for how [`torch.export.export()`](api_reference.html#torch.export.export) handles code.

## Basics of Tracing

[`torch.export.export()`](api_reference.html#torch.export.export) captures a graph representing your model by
...
The basic output of [`torch.export.export()`](api_reference.html#torch.export.export) is a single graph of PyTorch
operations, with associated metadata. The exact format of this output is
covered in the [export IR spec](ir_spec.html#export-ir-spec).

### Strict vs. Non-Strict Tracing

[`torch.export.export()`](api_reference.html#torch.export.export) provides two modes of tracing.
...
[TorchDynamo](../torch.compiler_dynamo_deepdive.html#torch-compiler-dynamo-deepdive), a Python bytecode
...
On the one hand, this analysis allows [`torch.export.export()`](api_reference.html#torch.export.export) to provide
...
A key concept in understanding the behavior of [`torch.export.export()`](api_reference.html#torch.export.export) is
...
[`torch.export.export()`](api_reference.html#torch.export.export) will specialize to their default values. As a
...
Control flow is supported by [`torch.export.export()`](api_reference.html#torch.export.export). The behavior of
...
calling [`torch.nonzero()`](../../../generated/torch.nonzero.html#torch.nonzero), an operator whose output shape depends on input
...
the output of [`torch.cat()`](../../../generated/torch.cat.html#torch.cat) is the sum of the shapes of its inputs.
...
For example, note how the fake implementation of [`torch.index_select()`](../../../generated/torch.index_select.html#torch.index_select)
...
[`torch.no_grad()`](../../../generated/torch.no_grad.html#torch.no_grad) to avoid parameter updates at export time.
