...
torch._inductor.aoti_compile_and_package(*exported_program*, *_deprecated_unused_args=None*, *_deprecated_unused_kwargs=None*, ***, *package_path=None*, *inductor_configs=None*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/_inductor/__init__.py#L64)
...
torch._inductor.aoti_load_package(*path*, *run_single_threaded=False*, *device_index=-1*, ***, *num_runners=1*, *use_stream_affinity=False*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/_inductor/__init__.py#L257)
