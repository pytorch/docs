...
torch.distributed.elastic.timer.configure(*timer_client*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L240)

Configures a timer client. Must be called before using `expires`.

torch.distributed.elastic.timer.expires(*after*, *scope=None*, *client=None*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L249)
...
*class*torch.distributed.elastic.timer.LocalTimerServer(*mp_queue*, *max_interval=60*, *daemon=True*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/local_timer.py#L78)
...
*class*torch.distributed.elastic.timer.LocalTimerClient(*mp_queue*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/local_timer.py#L23)
...
*class*torch.distributed.elastic.timer.FileTimerServer(*file_path*, *run_id*, *max_interval=10*, *daemon=True*, *log_event=None*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/file_based_local_timer.py#L179)
...
*class*torch.distributed.elastic.timer.FileTimerClient(*file_path*, *signal=Signals.SIGKILL*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/file_based_local_timer.py#L107)
...
*class*torch.distributed.elastic.timer.TimerRequest(*worker_id*, *scope_id*, *expiration_time*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L28)
...
*class*torch.distributed.elastic.timer.TimerServer(*request_queue*, *max_interval*, *daemon=True*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L113)
...
*abstract*clear_timers(*worker_ids*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L145)

Clears all timers for the given `worker_ids`.

*abstract*get_expired_timers(*deadline*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L151)
...
*abstract*register_timers(*timer_requests*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L136)
...
*class*torch.distributed.elastic.timer.TimerClient[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L57)

Client library to acquire and release countdown timers by communicating
with the TimerServer.

*abstract*acquire(*scope_id*, *expiration_time*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L63)
...
*abstract*release(*scope_id*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/api.py#L71)
...
torch.distributed.elastic.timer.debug_info_logging.log_debug_info_for_expired_timers(*run_id*, *expired_timers*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/distributed/elastic/timer/debug_info_logging.py#L19)