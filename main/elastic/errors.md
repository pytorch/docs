...
torch.distributed.elastic.multiprocessing.errors.record(*fn*, *error_handler=None*)[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/distributed/elastic/multiprocessing/errors/__init__.py#L318)
...
*class*torch.distributed.elastic.multiprocessing.errors.ChildFailedError(*name*, *failures*)[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/distributed/elastic/multiprocessing/errors/__init__.py#L205)
...
*class*torch.distributed.elastic.multiprocessing.errors.ErrorHandler[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/distributed/elastic/multiprocessing/errors/error_handler.py#L24)
...
*class*torch.distributed.elastic.multiprocessing.errors.ProcessFailure(*local_rank*, *pid*, *exitcode*, *error_file*)[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/distributed/elastic/multiprocessing/errors/__init__.py#L91)
