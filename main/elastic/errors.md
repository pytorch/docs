...
torch.distributed.elastic.multiprocessing.errors.record(*fn*, *error_handler=None*)[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/distributed/elastic/multiprocessing/errors/__init__.py#L331)
...
*class*torch.distributed.elastic.multiprocessing.errors.ChildFailedError(*name*, *failures*)[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/distributed/elastic/multiprocessing/errors/__init__.py#L205)
...
*class*torch.distributed.elastic.multiprocessing.errors.ErrorHandler[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/distributed/elastic/multiprocessing/errors/error_handler.py#L24)
...
*class*torch.distributed.elastic.multiprocessing.errors.ProcessFailure(*local_rank*, *pid*, *exitcode*, *error_file*)[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/distributed/elastic/multiprocessing/errors/__init__.py#L91)
