...
*class*torch.distributed.elastic.agent.server.ElasticAgent[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L393)
...
*abstract*get_worker_group(*role='default'*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L443)
...
*abstract*run(*role='default'*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L428)
...
*class*torch.distributed.elastic.agent.server.WorkerSpec(*role*, *local_world_size*, *rdzv_handler*, *fn=None*, *entrypoint=None*, *args=()*, *max_restarts=3*, *monitor_interval=0.1*, *master_port=None*, *master_addr=None*, *local_addr=None*, *event_log_handler='null'*, *numa_options=None*, *duplicate_stdout_filters=None*, *duplicate_stderr_filters=None*, *virtual_local_rank=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L49)
...
- **role** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - user-defined role for the workers with this spec
- **local_world_size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - number local workers to run
...
- **entrypoint** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)*|*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**None*) - worker function or command
- **args** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)) - arguments to pass to `entrypoint`
...
- **max_restarts** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - number of max retries for the workers
- **monitor_interval** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - monitor status of workers every `n` seconds
- **master_port** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*|**None*) - fixed port to run the c10d store on rank 0
if not specified then will choose a random free port
- **master_addr** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**None*) - fixed master_addr to run the c10d store on rank 0
...
- **event_log_handler** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - name of the event logging handler as registered in
[elastic/events/handlers.py](https://docs.pytorch.org/docs/stable/elastic/events.html).
- **duplicate_stdout_filters** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*]**|**None*) - If non-empty, duplicates stdout to a file containing only lines
that match _any_ of the filter strings.
- **duplicate_stderr_filters** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*]**|**None*) - If non-empty, duplicates stderr to a file containing only lines
that match _any_ of the filter strings.
- **virtual_local_rank** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Enable virtual local rank mode for workers (defaults to False).
...
get_entrypoint_name()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L124)
...
*class*torch.distributed.elastic.agent.server.WorkerState(*value*, *names=None*, ***, *module=None*, *qualname=None*, *type=None*, *start=1*, *boundary=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L212)
...
*static*is_running(*state*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L255)
...
*class*torch.distributed.elastic.agent.server.Worker(*local_rank*, *global_rank=-1*, *role_rank=-1*, *world_size=-1*, *role_world_size=-1*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L138)
...
- **local_rank** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - local rank of the worker
- **global_rank** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - global rank of the worker
- **role_rank** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - rank of the worker across all workers that have the same role
...
*class*torch.distributed.elastic.agent.server.WorkerGroup(*spec*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L266)
...
*class*torch.distributed.elastic.agent.server.SimpleElasticAgent(*spec*, *exit_barrier_timeout=300*, *shutdown_timeout=30*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L455)
...
_assign_worker_ranks(*store*, *group_rank*, *group_world_size*, *spec*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L584)
...
_exit_barrier()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L976)
...
_initialize_workers(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L694)
...
*abstract*_monitor_workers(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L498)
...
_rendezvous(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L518)
...
_restart_workers(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L729)

Restart (stops, rendezvous, starts) all local workers in the group.

*abstract*_shutdown(*death_sig=Signals.SIGTERM*, *timeout=30*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L506)
...
*abstract*_start_workers(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L479)
...
*abstract*_stop_workers(*worker_group*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L488)
...
*class*torch.distributed.elastic.agent.server.api.RunResult(*state*, *return_values=<factory>*, *failures=<factory>*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/api.py#L355)
...
*class*torch.distributed.elastic.agent.server.health_check_server.HealthCheckServer(*alive_callback*, *port*, *timeout*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/health_check_server.py#L19)
...
- **alive_callback** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)*[**[**]**,*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) - Callable[[], int], callback to last progress time of agent
...
start()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/health_check_server.py#L44)

Unsupported functionality for PyTorch, doesn't start any health check server

stop()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/health_check_server.py#L50)

Function to stop health check server

torch.distributed.elastic.agent.server.health_check_server.create_healthcheck_server(*alive_callback*, *port*, *timeout*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/elastic/agent/server/health_check_server.py#L61)
