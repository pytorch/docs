...
torch.special.airy_ai(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L982)
...
torch.special.bessel_j0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L999)
...
torch.special.bessel_j1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1016)
...
torch.special.bessel_y0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1033)
...
torch.special.bessel_y1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1050)
...
torch.special.chebyshev_polynomial_t(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1067)
...
torch.special.chebyshev_polynomial_u(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1098)
...
torch.special.chebyshev_polynomial_v(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1130)
...
torch.special.chebyshev_polynomial_w(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1148)
...
torch.special.digamma(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L109)
...
torch.special.entr(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L67)
...
torch.special.erf(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L202)
...
torch.special.erfc(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L226)
...
torch.special.erfcx(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L251)
...
torch.special.erfinv(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L279)
...
torch.special.exp2(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L379)
...
torch.special.expit(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L352)
...
torch.special.expm1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L404)
...
torch.special.gammainc(*input*, *other*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L885)
...
torch.special.gammaincc(*input*, *other*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L934)
...
torch.special.gammaln(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L140)
...
torch.special.hermite_polynomial_h(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1166)
...
torch.special.hermite_polynomial_he(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1192)
...
torch.special.i0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L522)
...
torch.special.i0e(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L548)
...
torch.special.i1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L573)
...
torch.special.i1e(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L598)
...
torch.special.laguerre_polynomial_l(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1218)
...
torch.special.legendre_polynomial_p(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1244)
...
torch.special.log1p(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L702)

Alias for [`torch.log1p()`](generated/torch.log1p.html#torch.log1p).

torch.special.log_ndtr(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L677)
...
torch.special.log_softmax(*input*, *dim*, ***, *dtype=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L782)
...
torch.special.logit(*input*, *eps=None*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L305)
...
torch.special.logsumexp(*input*, *dim*, *keepdim=False*, ***, *out=None*)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L343)

Alias for [`torch.logsumexp()`](generated/torch.logsumexp.html#torch.logsumexp).

torch.special.modified_bessel_i0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1270)
...
torch.special.modified_bessel_i1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1287)
...
torch.special.modified_bessel_k0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1304)
...
torch.special.modified_bessel_k1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1321)
...
torch.special.multigammaln(*input*, *p*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L848)
...
torch.special.ndtr(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L624)
...
torch.special.ndtri(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L649)
...
torch.special.polygamma(*n*, *input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L166)
...
torch.special.psi(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L100)

Alias for `torch.special.digamma()`.

torch.special.round(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L743)

Alias for [`torch.round()`](generated/torch.round.html#torch.round).

torch.special.scaled_modified_bessel_k0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1338)
...
torch.special.scaled_modified_bessel_k1(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1355)
...
torch.special.shifted_chebyshev_polynomial_t(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1372)
...
torch.special.shifted_chebyshev_polynomial_u(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1390)
...
torch.special.shifted_chebyshev_polynomial_v(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1408)
...
torch.special.shifted_chebyshev_polynomial_w(*input*, *n*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1426)
...
torch.special.sinc(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L711)
...
torch.special.softmax(*input*, *dim*, ***, *dtype=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L752)
...
torch.special.spherical_bessel_j0(*input*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L1444)
...
torch.special.xlog1py(*input*, *other*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L432)
...
torch.special.xlogy(*input*, *other*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L477)
...
torch.special.zeta(*input*, *other*, ***, *out=None*) → [Tensor](tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/12a9ea264bf805a66cd87e19e767ab23c2f59fef/torch/special/__init__.py#L814)
