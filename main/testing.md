...
torch.testing.assert_close(*actual*, *expected*, ***, *allow_subclasses=True*, *rtol=None*, *atol=None*, *equal_nan=False*, *check_device=True*, *check_dtype=True*, *check_layout=True*, *check_stride=False*, *msg=None*)[[source]](https://github.com/pytorch/pytorch/blob/fbfd15846f570ac46ff9e34a533162fb2054dbd9/torch/testing/_comparison.py#L1357)
...
torch.testing.make_tensor(**shape*, *dtype*, *device*, *low=None*, *high=None*, *requires_grad=False*, *noncontiguous=False*, *exclude_zero=False*, *memory_format=None*)[[source]](https://github.com/pytorch/pytorch/blob/fbfd15846f570ac46ff9e34a533162fb2054dbd9/torch/testing/_creation.py#L45)
...
torch.testing.assert_allclose(*actual*, *expected*, *rtol=None*, *atol=None*, *equal_nan=True*, *msg=''*)[[source]](https://github.com/pytorch/pytorch/blob/fbfd15846f570ac46ff9e34a533162fb2054dbd9/torch/testing/_comparison.py#L1634)
