...
torch.backends.cpu.get_cpu_capability()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cpu/__init__.py#L9)
...
torch.backends.cuda.is_built()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L43)
...
A [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) that controls the internal computation precision of CUDA
...
cuBLAS uses native FP32 on other architectures. See [TensorFloat-32 (TF32) on Ampere (and later) devices](notes/cuda.html#tf32-on-ampere).

torch.backends.cuda.matmul.allow_tf32

A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether TensorFloat-32 tensor cores may be used in matrix
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether reduced precision reductions (e.g.,
...
A readonly [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that reports whether split-K heuristics may be used
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether supported grouped GEMMs prefer the
cuBLASLt backend.

torch.backends.cuda.matmul.allow_bf16_reduced_precision_reduction

A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether reduced precision reductions are
...
A readonly [`int`](https://docs.python.org/3/builtins/functions.html#int) that shows the number of plans currently in a cuFFT plan cache.

torch.backends.cuda.cufft_plan_cache.max_size

A [`int`](https://docs.python.org/3/builtins/functions.html#int) that controls the capacity of a cuFFT plan cache.

torch.backends.cuda.cufft_plan_cache.clear()

Clears a cuFFT plan cache.

torch.backends.cuda.preferred_blas_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L296)
...
This flag (a [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) allows overriding which BLAS library to use.
...
torch.backends.cuda.cublas_workspace_size(*size=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L340)
...
**size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - workspace size in bytes. Must be non-negative.
...
torch.backends.cuda.cublaslt_workspace_size(*size=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L360)
...
torch.backends.cuda.blas_workspace_size(*size=None*, *backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L380)
...
- **backend** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**torch._C._BlasBackend**,**optional*) - which backend's
...
[**RuntimeError**](https://docs.python.org/3/builtins/exceptions.html#RuntimeError) - if the resolved backend is CK (no workspace concept).

torch.backends.cuda.preferred_rocm_fa_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L457)
...
This flag (a [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) allows users to override this backend to use composable_kernel
...
torch.backends.cuda.is_ck_sdpa_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L502)
...
torch.backends.cuda.preferred_linalg_library(*backend=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L225)
...
This flag (a [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) allows overriding those heuristics.
...
torch.backends.cuda.flash_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L513)
...
torch.backends.cuda.enable_mem_efficient_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L540)
...
torch.backends.cuda.mem_efficient_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L531)
...
torch.backends.cuda.enable_flash_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L522)
...
torch.backends.cuda.math_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L549)
...
torch.backends.cuda.enable_math_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L558)
...
torch.backends.cuda.fp16_bf16_reduction_math_sdp_allowed()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L576)
...
torch.backends.cuda.allow_fp16_bf16_reduction_math_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L567)
...
torch.backends.cuda.cudnn_sdp_enabled()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L658)
...
torch.backends.cuda.enable_cudnn_sdp(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L667)
...
torch.backends.cuda.is_flash_attention_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L585)
...
torch.backends.cuda.can_use_flash_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L598)
...
- **debug** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to logging.warn debug information as to why FlashAttention could not be run.
Defaults to False.
...
torch.backends.cuda.can_use_efficient_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L618)
...
key, value, an optional attention mask, dropout rate, and
a flag indicating if the attention is causal.
- **debug** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to logging.warn with information as to why efficient_attention could not be run.
Defaults to False.
...
torch.backends.cuda.can_use_cudnn_attention(*params*, *debug=False*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L638)
...
key, value, an optional attention mask, dropout rate, and
a flag indicating if the attention is causal.
- **debug** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to logging.warn with information as to why cuDNN attention could not be run.
Defaults to False.
...
torch.backends.cuda.sdp_kernel(*enable_flash=True*, *enable_math=True*, *enable_mem_efficient=True*, *enable_cudnn=True*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cuda/__init__.py#L676)
...
torch.backends.cudnn.version()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cudnn/__init__.py#L110)

Return the version of cuDNN.

torch.backends.cudnn.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cudnn/__init__.py#L124)

Return a bool indicating if CUDNN is currently available.

torch.backends.cudnn.enabled

A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether cuDNN is enabled.

torch.backends.cudnn.allow_tf32

A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls where TensorFloat-32 tensor cores may be used in cuDNN
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that, if True, causes cuDNN to only use deterministic convolution algorithms.
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that, if True, causes cuDNN to benchmark multiple convolution algorithms
and select the fastest.

torch.backends.cudnn.benchmark_limit

A [`int`](https://docs.python.org/3/builtins/functions.html#int) that specifies the maximum number of cuDNN convolution algorithms to try when
...
torch.backends.cusparselt.version()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cusparselt/__init__.py#L42)
...
torch.backends.cusparselt.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cusparselt/__init__.py#L49)
...
torch.backends.cusparselt.get_max_alg_id()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/cusparselt/__init__.py#L54)
...
torch.backends.mha.get_fastpath_enabled()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mha/__init__.py#L9)
...
torch.backends.mha.set_fastpath_enabled(*value*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mha/__init__.py#L22)
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that, if True, causes MIOpen to use Immediate Mode
...
torch.backends.mps.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L28)
...
torch.backends.mps.is_built()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L18)
...
torch.backends.mps.get_core_count()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L52)
...
torch.backends.mps.get_name()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L46)
...
torch.backends.mps.is_macos13_or_newer(*minor=0*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L40)
...
torch.backends.mps.is_macos_or_newer(*major*, *minor*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mps/__init__.py#L34)
...
torch.backends.mkl.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mkl/__init__.py#L5)

Return whether PyTorch is built with MKL support.

*class*torch.backends.mkl.verbose(*enable*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mkl/__init__.py#L14)
...
torch.backends.mkldnn.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mkldnn/__init__.py#L114)

*class*torch.backends.mkldnn.verbose(*level*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/mkldnn/__init__.py#L33)
...
torch.backends.nnpack.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/nnpack/__init__.py#L11)

Return whether PyTorch is built with NNPACK support.

torch.backends.nnpack.flags(*enabled=False*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/nnpack/__init__.py#L23)

Context manager for setting if nnpack is enabled globally

torch.backends.nnpack.set_flags(*_enabled*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/nnpack/__init__.py#L16)

Set if nnpack is enabled globally

## torch.backends.openmp

torch.backends.openmp.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/openmp/__init__.py#L5)

Return whether PyTorch is built with OpenMP support.

torch.backends.kleidiai.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/kleidiai/__init__.py#L5)

Return whether PyTorch is built with KleidiAI support.

## torch.backends.opt_einsum

torch.backends.opt_einsum.is_available()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/opt_einsum/__init__.py#L17)
...
torch.backends.opt_einsum.get_opt_einsum()[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/opt_einsum/__init__.py#L30)
...
A [`bool`](https://docs.python.org/3/builtins/functions.html#bool) that controls whether opt_einsum is enabled (`True` by default). If so,
...
A [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) that specifies which strategies to try when `torch.backends.opt_einsum.enabled`
...
torch.backends.python_native.get_dsl_operations(*dsl_name*, *lib_symbol='aten'*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L232)

Get list of operations registered by a specific DSL in one namespace.

Parameters:

- **dsl_name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Name of the DSL to query (e.g., 'triton', 'cutedsl').
- **lib_symbol** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Namespace to report on, `"aten"` by default.
One namespace per call: op symbols are unique within a
namespace but not across them.

Returns:

Sorted list of op symbols the DSL registered on
`lib_symbol`.
...
torch.backends.python_native.disable_operations(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L254)

Disable specific operations across all DSLs.

Parameters:

***op_symbols** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Names of operations to disable.
...
torch.backends.python_native.enable_operations(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L273)

Re-enable specific operations across all DSLs.

Parameters:

***op_symbols** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Names of operations to re-enable.
...
torch.backends.python_native.disable_dispatch_keys(**dispatch_keys*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L289)

Disable operations at specific dispatch keys.

Parameters:

***dispatch_keys** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Dispatch keys to disable (e.g., 'CUDA', 'CPU').
...
torch.backends.python_native.enable_dispatch_keys(**dispatch_keys*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L303)

Re-enable operations at specific dispatch keys.

Parameters:

***dispatch_keys** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Dispatch keys to re-enable (e.g., 'CUDA', 'CPU').
...
torch.backends.python_native.operations_disabled(**op_symbols*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/python_native/__init__.py#L317)

Context manager to temporarily disable operations.

Parameters:

***op_symbols** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Names of operations to temporarily disable.
...
A [`list`](https://docs.python.org/3/builtins/stdtypes.html#list) of [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) containing the names of DSLs that are available at runtime.
This is a subset of `all_dsls` that have their runtime dependencies satisfied.

torch.backends.python_native.all_dsls

A [`list`](https://docs.python.org/3/builtins/stdtypes.html#list) of [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) containing the names of all registered DSLs, whether
...
torch.backends.xeon.run_cpu.create_args(*parser=None*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/backends/xeon/run_cpu.py#L913)
