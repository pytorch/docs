...
*class*torch.utils.benchmark.Timer(*stmt='pass'*, *setup='pass'*, *global_setup=''*, *timer=<function timer>*, *globals=None*, *label=None*, *sub_label=None*, *description=None*, *env=None*, *num_threads=1*, *language=Language.PYTHON*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/timer.py#L66)
...
- **stmt** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Code snippet to be run in a loop and timed.
- **setup** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Optional setup code. Used to define variables used in stmt
- **global_setup** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - (C++ only)
Code which is placed at the top level of the file for things like
#include statements.
- **timer** ([*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)*[**[**]**,*[*float*](https://docs.python.org/3/builtins/functions.html#float)*]*) - Callable which returns the current time. If PyTorch was built
...
measuring the time.
- **globals** ([*dict*](https://docs.python.org/3/builtins/stdtypes.html#dict)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,*[*Any*](https://docs.python.org/3/library/typing.html#typing.Any)*]**|**None*) - A dict which defines the global variables when stmt is being
executed. This is the other method for providing variables which
stmt needs.
- **label** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**None*) - String which summarizes stmt. For instance, if stmt is
"torch.nn.functional.relu(torch.add(x, 1, out=out))"
one might set label to "ReLU(x + 1)" to improve readability.
- **sub_label** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**None*) -
...
- **env** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*|**None*) - This tag indicates that otherwise identical tasks were run in
...
- **num_threads** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The size of the PyTorch threadpool when executing stmt. Single
...
adaptive_autorange(*threshold=0.1*, ***, *min_run_time=0.01*, *max_run_time=10.0*, *callback=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/timer.py#L384)
...
- **threshold** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - value of iqr/median threshold for stopping
- **min_run_time** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - total runtime needed before checking threshold
- **max_run_time** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - total runtime for all measurements regardless of threshold
...
blocked_autorange(*callback=None*, *min_run_time=0.2*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/timer.py#L324)
...
collect_callgrind(*number: [int](https://docs.python.org/3/builtins/functions.html#int)*, ***, *repeats: [None](https://docs.python.org/3/builtins/constants.html#None)*, *collect_baseline: [bool](https://docs.python.org/3/builtins/functions.html#bool)*, *retain_out_file: [bool](https://docs.python.org/3/builtins/functions.html#bool)*) → CallgrindStats[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/timer.py#L469)

collect_callgrind(*number: [int](https://docs.python.org/3/builtins/functions.html#int)*, ***, *repeats: [int](https://docs.python.org/3/builtins/functions.html#int)*, *collect_baseline: [bool](https://docs.python.org/3/builtins/functions.html#bool)*, *retain_out_file: [bool](https://docs.python.org/3/builtins/functions.html#bool)*) → [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[CallgrindStats, ...]
...
timeit(*number=1000000*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/timer.py#L259)
...
*class*torch.utils.benchmark.Measurement(*number_per_run*, *raw_times*, *task_spec*, *metadata=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/common.py#L74)
...
*static*merge(*measurements*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/common.py#L230)
...
[list](https://docs.python.org/3/builtins/stdtypes.html#list)[Measurement]

*property*significant_figures*: [int](https://docs.python.org/3/builtins/functions.html#int)*
...
*class*torch.utils.benchmark.CallgrindStats(*task_spec*, *number_per_run*, *built_with_debug_symbols*, *baseline_inclusive_stats*, *baseline_exclusive_stats*, *stmt_inclusive_stats*, *stmt_exclusive_stats*, *stmt_callgrind_out*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L169)
...
as_standardized()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L244)
...
counts(***, *denoise=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L218)
...
delta(*other*, *inclusive=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L227)
...
stats(*inclusive=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L204)
...
*class*torch.utils.benchmark.FunctionCounts(*_data*, *inclusive*, *truncate_rows=True*, *_linewidth=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L44)
...
denoise()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L137)
...
filter(*filter_fn*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L130)
...
transform(*map_fn*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L117)
...
*class*torch.utils.benchmark.Compare(*results*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L269)
...
**results** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*[**Measurement**]*) - List of Measurement to display.

colorize(*rowwise=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L311)

Colorize formatted table.

Colorize columnwise by default.

extend_results(*results*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L295)

Append results to already stored ones.

All added results must be instances of `Measurement`.

highlight_warnings()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L318)

Enables warning highlighting when building formatted table.

print()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L322)

Print formatted table

trim_significant_figures()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compare.py#L307)

Enables trimming of significant figures when building the formatted table.

torch.utils.benchmark.examples.op_benchmark.assert_dicts_equal(*dict_0*, *dict_1*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/examples/op_benchmark.py#L19)
...
torch.utils.benchmark.utils.fuzzer.prod(*values*, *base=1*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/fuzzer.py#L177)
...
torch.utils.benchmark.utils.common.select_unit(*t*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/common.py#L258)
...
torch.utils.benchmark.utils.common.trim_sigfig(*x*, *n*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/common.py#L277)
...
torch.utils.benchmark.utils.compile.bench_all(*model*, *sample_input*, *num_iters=5*, *optimizer=None*, *loss_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compile.py#L121)
...
torch.utils.benchmark.utils.compile.benchmark_compile(*model*, *sample_input*, *num_iters=5*, *backend=None*, *mode='default'*, *optimizer=None*, *loss_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/utils/benchmark/utils/compile.py#L76)
