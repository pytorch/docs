...
*class*torch.utils.benchmark.Timer(*stmt='pass'*, *setup='pass'*, *global_setup=''*, *timer=<function timer>*, *globals=None*, *label=None*, *sub_label=None*, *description=None*, *env=None*, *num_threads=1*, *language=Language.PYTHON*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/timer.py#L66)
...
adaptive_autorange(*threshold=0.1*, ***, *min_run_time=0.01*, *max_run_time=10.0*, *callback=None*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/timer.py#L384)
...
blocked_autorange(*callback=None*, *min_run_time=0.2*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/timer.py#L324)
...
timeit(*number=1000000*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/timer.py#L259)
...
*class*torch.utils.benchmark.Measurement(*number_per_run*, *raw_times*, *task_spec*, *metadata=None*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/common.py#L74)
...
*static*merge(*measurements*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/common.py#L230)
...
*class*torch.utils.benchmark.CallgrindStats(*task_spec*, *number_per_run*, *built_with_debug_symbols*, *baseline_inclusive_stats*, *baseline_exclusive_stats*, *stmt_inclusive_stats*, *stmt_exclusive_stats*, *stmt_callgrind_out*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L169)
...
as_standardized()[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L244)
...
counts(***, *denoise=False*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L218)
...
delta(*other*, *inclusive=False*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L227)
...
stats(*inclusive=False*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L204)
...
*class*torch.utils.benchmark.FunctionCounts(*_data*, *inclusive*, *truncate_rows=True*, *_linewidth=None*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L44)
...
denoise()[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L137)
...
filter(*filter_fn*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L130)
...
transform(*map_fn*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/valgrind_wrapper/timer_interface.py#L117)
...
*class*torch.utils.benchmark.Compare(*results*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L269)
...
colorize(*rowwise=False*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L311)

Colorize formatted table.

Colorize columnwise by default.

extend_results(*results*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L295)

Append results to already stored ones.

All added results must be instances of `Measurement`.

highlight_warnings()[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L318)

Enables warning highlighting when building formatted table.

print()[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L322)

Print formatted table

trim_significant_figures()[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compare.py#L307)

Enables trimming of significant figures when building the formatted table.

torch.utils.benchmark.examples.op_benchmark.assert_dicts_equal(*dict_0*, *dict_1*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/examples/op_benchmark.py#L19)
...
torch.utils.benchmark.utils.fuzzer.prod(*values*, *base=1*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/fuzzer.py#L177)
...
torch.utils.benchmark.utils.common.select_unit(*t*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/common.py#L258)
...
torch.utils.benchmark.utils.common.trim_sigfig(*x*, *n*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/common.py#L277)
...
torch.utils.benchmark.utils.compile.bench_all(*model*, *sample_input*, *num_iters=5*, *optimizer=None*, *loss_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compile.py#L121)
...
torch.utils.benchmark.utils.compile.benchmark_compile(*model*, *sample_input*, *num_iters=5*, *backend=None*, *mode='default'*, *optimizer=None*, *loss_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/3565a492def04bf126af9d46958533d16fb88274/torch/utils/benchmark/utils/compile.py#L76)
