...
torch.distributed.rpc.init_rpc(*name*, *backend=None*, *rank=-1*, *world_size=None*, *rpc_backend_options=None*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/__init__.py#L93)
...
torch.distributed.rpc.is_available()[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/__init__.py#L24)
...
torch.distributed.rpc.rpc_sync(*to*, *func*, *args=None*, *kwargs=None*, *timeout=-1.0*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/api.py#L771)
...
torch.distributed.rpc.rpc_async(*to*, *func*, *args=None*, *kwargs=None*, *timeout=-1.0*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/api.py#L845)
...
torch.distributed.rpc.remote(*to*, *func*, *args=None*, *kwargs=None*, *timeout=-1.0*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/api.py#L554)
...
torch.distributed.rpc.get_worker_info(*worker_name=None*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/api.py#L427)
...
torch.distributed.rpc.shutdown(*graceful=True*, *timeout=0*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/api.py#L326)
...
torch.distributed.rpc.functions.async_execution(*fn*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/functions.py#L5)
...
torch.distributed.rpc.backend_registry.backend_registered(*backend_name*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/backend_registry.py#L51)
...
torch.distributed.rpc.backend_registry.register_backend(*backend_name*, *construct_rpc_backend_options_handler*, *init_backend_handler*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/backend_registry.py#L64)
...
*class*torch.distributed.rpc.TensorPipeRpcBackendOptions(***, *num_worker_threads=16*, *rpc_timeout=60.0*, *init_method='env://'*, *device_maps=None*, *devices=None*, *_transports=None*, *_channels=None*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/options.py#L50)
...
set_device_map(*to*, *device_map*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/options.py#L111)
...
set_devices(*devices*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/rpc/options.py#L169)
...
*class*torch.distributed.nn.api.remote_module.RemoteModule(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/nn/api/remote_module.py#L605)
...
get_module_rref()[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/nn/api/remote_module.py#L296)
...
remote_parameters(*recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/nn/api/remote_module.py#L277)
...
*class*torch.distributed.autograd.context[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/autograd/__init__.py#L37)
...
torch.distributed.autograd.is_available()[[source]](https://github.com/pytorch/pytorch/blob/6468763e46fe7b5527a52dfbb151d63938d7288a/torch/distributed/autograd/__init__.py#L12)
