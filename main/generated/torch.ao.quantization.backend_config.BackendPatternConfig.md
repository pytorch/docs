...
*class*torch.ao.quantization.backend_config.BackendPatternConfig(*pattern=None*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L439)
...
add_dtype_config(*dtype_config*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L514)
...
*classmethod*from_dict(*backend_pattern_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L632)

Create a `BackendPatternConfig` from a dictionary with the following items:

> "pattern": the pattern being configured
> "observation_type": the [`ObservationType`](torch.ao.quantization.backend_config.ObservationType.html#torch.ao.quantization.backend_config.ObservationType) that specifies how
> observers should be inserted for this pattern
> "dtype_configs": a list of dictionaries that represents [`DTypeConfig`](torch.ao.quantization.backend_config.DTypeConfig.html#torch.ao.quantization.backend_config.DTypeConfig) s
> "root_module": a [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module) that represents the root for this pattern
> "qat_module": a [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module) that represents the QAT implementation for this pattern
> "reference_quantized_module": a [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module) that represents the reference quantized
> implementation for this pattern's root module.
> "fused_module": a [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module) that represents the fused implementation for this pattern
...
set_dtype_configs(*dtype_configs*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L522)
...
set_fused_module(*fused_module*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L569)
...
set_fuser_method(*fuser_method*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L578)
...
For a more complicated example, see [https://gist.github.com/jerryzh168/8bea7180a8ba3c279f2c9b050f2a69a6](https://gist.github.com/jerryzh168/8bea7180a8ba3c279f2c9b050f2a69a6).

Return type:

BackendPatternConfig

set_observation_type(*observation_type*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L488)
...
set_pattern(*pattern*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L473)
...
set_qat_module(*qat_module*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L550)
...
set_reference_quantized_module(*reference_quantized_module*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L557)
...
set_root_module(*root_module*)[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L532)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/01eee25952cb32e0868ff00f26f080d46ef71e27/torch/ao/quantization/backend_config/backend_config.py#L708)
