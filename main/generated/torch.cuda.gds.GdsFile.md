...
*class*torch.cuda.gds.GdsFile(*filename*, *flags*)[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/cuda/gds.py#L86)
...
deregister_handle()[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/cuda/gds.py#L141)

Deregisters file descriptor from cuFile Driver.

This is a wrapper around `cuFileHandleDeregister`.

load_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/cuda/gds.py#L151)
...
register_handle()[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/cuda/gds.py#L132)

Registers file descriptor to cuFile Driver.

This is a wrapper around `cuFileHandleRegister`.

save_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/cuda/gds.py#L165)
