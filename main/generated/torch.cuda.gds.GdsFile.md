...
*class*torch.cuda.gds.GdsFile(*filename*, *flags*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/gds.py#L96)
...
deregister_handle()[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/gds.py#L151)

Deregisters file descriptor from cuFile Driver.

This is a wrapper around `cuFileHandleDeregister`.

load_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/gds.py#L161)
...
register_handle()[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/gds.py#L142)

Registers file descriptor to cuFile Driver.

This is a wrapper around `cuFileHandleRegister`.

save_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/gds.py#L175)
