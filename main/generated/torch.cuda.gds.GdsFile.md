...
*class*torch.cuda.gds.GdsFile(*filename*, *flags*)[[source]](https://github.com/pytorch/pytorch/blob/5cd392bfe432d57e7beb9ab67037ddc0fcc01205/torch/cuda/gds.py#L86)
...
deregister_handle()[[source]](https://github.com/pytorch/pytorch/blob/5cd392bfe432d57e7beb9ab67037ddc0fcc01205/torch/cuda/gds.py#L141)

Deregisters file descriptor from cuFile Driver.

This is a wrapper around `cuFileHandleDeregister`.

load_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/5cd392bfe432d57e7beb9ab67037ddc0fcc01205/torch/cuda/gds.py#L151)
...
register_handle()[[source]](https://github.com/pytorch/pytorch/blob/5cd392bfe432d57e7beb9ab67037ddc0fcc01205/torch/cuda/gds.py#L132)

Registers file descriptor to cuFile Driver.

This is a wrapper around `cuFileHandleRegister`.

save_storage(*storage*, *offset=0*)[[source]](https://github.com/pytorch/pytorch/blob/5cd392bfe432d57e7beb9ab67037ddc0fcc01205/torch/cuda/gds.py#L165)
