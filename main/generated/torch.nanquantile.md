...
- **q** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*or*[*Tensor*](../tensors.html#torch.Tensor)) - a scalar or 1D tensor of quantile values in the range [0, 1]
...
- **interpolation** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - interpolation method to use when the desired quantile lies between two data points.
