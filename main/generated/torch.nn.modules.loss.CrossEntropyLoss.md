...
*class*torch.nn.modules.loss.CrossEntropyLoss(*weight=None*, *size_average=None*, *ignore_index=-100*, *reduce=None*, *reduction='mean'*, *label_smoothing=0.0*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/nn/modules/loss.py#L1200)
...
- **ignore_index** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - Specifies a target value that is ignored
...
- **label_smoothing** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - A float in [0.0, 1.0]. Specifies the amount
...
forward(*input*, *target*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/nn/modules/loss.py#L1398)
