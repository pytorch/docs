...
*class*torch.optim.lr_scheduler.MultiStepLR(*optimizer*, *milestones*, *gamma=0.1*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/optim/lr_scheduler.py#L679)
...
- **milestones** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)) - List of epoch indices. Must be increasing.
- **gamma** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - Multiplicative factor of learning rate decay.
Default: 0.1.
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/optim/lr_scheduler.py#L718)
