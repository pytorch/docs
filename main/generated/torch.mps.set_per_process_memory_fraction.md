...
torch.mps.set_per_process_memory_fraction(*fraction*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/mps/__init__.py#L85)
...
**fraction** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - Range: 0~2. Allowed memory equals total_memory * fraction.
