...
*class*torch.nn.utils.prune.LnStructured(*amount*, *n*, *dim=-1*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L675)

Prune entire (currently unpruned) channels in a tensor based on their L`n`-norm.

Parameters:

- **amount** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*or*[*float*](https://docs.python.org/3/builtins/functions.html#float)) - quantity of channels to prune.
...
- **dim** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - index of the dim along which we define
channels to prune. Default: -1.

*classmethod*apply(*module*, *name*, *amount*, *n*, *dim*, *importance_scores=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L769)
...
- **n** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,*[*float*](https://docs.python.org/3/builtins/functions.html#float)*,**inf**,**-inf**,**'fro'**,**'nuc'*) - See documentation of valid
entries for argument `p` in [`torch.norm()`](torch.norm.html#torch.norm).
- **dim** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - index of the dim along which we define channels to
prune.
...
apply_mask(*module*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L53)
...
compute_mask(*t*, *default_mask*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L698)
...
[**IndexError**](https://docs.python.org/3/builtins/exceptions.html#IndexError) - if `self.dim >= len(t.shape)`

prune(*t*, *default_mask=None*, *importance_scores=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L208)
...
remove(*module*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/utils/prune.py#L240)
