...
torch.load(*f*, *map_location=None*, *pickle_module=pickle*, ***, *weights_only=True*, *mmap=None*, ***pickle_load_args*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/serialization.py#L1316)
...
- **mmap** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*|**None*) - Indicates whether the file should be mapped rather than loading all the storages into memory.
