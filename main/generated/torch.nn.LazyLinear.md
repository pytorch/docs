...
*class*torch.nn.LazyLinear(*out_features*, *bias=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/e708521bdf92712674ed3a0d332b56c356502328/torch/nn/modules/linear.py#L259)
...
cls_to_become[[source]](https://github.com/pytorch/pytorch/blob/e708521bdf92712674ed3a0d332b56c356502328/torch/nn/modules/linear.py#L53)

alias of [`Linear`](torch.nn.modules.linear.Linear.html#torch.nn.modules.linear.Linear)

initialize_parameters(*input*)[[source]](https://github.com/pytorch/pytorch/blob/e708521bdf92712674ed3a0d332b56c356502328/torch/nn/modules/linear.py#L316)

Infers `in_features` based on `input` and initializes parameters.

reset_parameters()[[source]](https://github.com/pytorch/pytorch/blob/e708521bdf92712674ed3a0d332b56c356502328/torch/nn/modules/linear.py#L308)
