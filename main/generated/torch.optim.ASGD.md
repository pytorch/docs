...
*class*torch.optim.ASGD(*params*, *lr=0.01*, *lambd=0.0001*, *alpha=0.75*, *t0=1000000.0*, *weight_decay=0*, *foreach=None*, *maximize=False*, *differentiable=False*, *capturable=False*)[[source]](https://github.com/pytorch/pytorch/blob/4144bea4b7c2f67da9d4840f4659f977bbd754e5/torch/optim/asgd.py#L30)
