...
*class*torch.optim.ASGD(*params*, *lr=0.01*, *lambd=0.0001*, *alpha=0.75*, *t0=1000000.0*, *weight_decay=0*, *foreach=None*, *maximize=False*, *differentiable=False*, *capturable=False*)[[source]](https://github.com/pytorch/pytorch/blob/211c61413d1f81c4a6ec8f1820328bef5cb24d86/torch/optim/asgd.py#L29)
