...
*class*torch.optim.ASGD(*params*, *lr=0.01*, *lambd=0.0001*, *alpha=0.75*, *t0=1000000.0*, *weight_decay=0*, *foreach=None*, *maximize=False*, *differentiable=False*, *capturable=False*)[[source]](https://github.com/pytorch/pytorch/blob/7438967adaaabe37e14e1d7d26e1ab5ed2ed9054/torch/optim/asgd.py#L29)
