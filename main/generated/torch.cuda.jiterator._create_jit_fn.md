...
torch.cuda.jiterator._create_jit_fn(*code_string*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/55f1d787eeab8196db1c529de1754add16feec18/torch/cuda/jiterator.py#L101)
...
- **code_string** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - CUDA code string to be compiled by jiterator. The entry functor must return by value.
