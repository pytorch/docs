...
torch.cuda.jiterator._create_jit_fn(*code_string*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/e3966c93e0ae877c1150f9fceaab6055109ce1c8/torch/cuda/jiterator.py#L101)
...
- **code_string** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - CUDA code string to be compiled by jiterator. The entry functor must return by value.
