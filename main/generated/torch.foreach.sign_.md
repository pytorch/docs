...
torch.foreach.sign_(*inputs: TensorList*, */*) → [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[[Tensor](../tensors.html#torch.Tensor), ...] | [list](https://docs.python.org/3/library/stdtypes.html#list)[[Tensor](../tensors.html#torch.Tensor)][[source]](https://github.com/pytorch/pytorch/blob/d7a82dcfcb838549a84f49516bc5c32ecf1eef90/torch/foreach/__init__.py#L606)

Applies [`torch.sign()`](torch.sign.html#torch.sign) to each tensor in `inputs` in-place.

This is semantically equivalent to applying [`torch.sign()`](torch.sign.html#torch.sign) independently
