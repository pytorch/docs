...
torch.functional.einsum(*equation*, **operands*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/8df61039f8235b92b0ca250355cc296020f46e2d/torch/functional.py#L176)
...
by optimizing contraction order through our opt_einsum backend [`torch.backends.opt_einsum`](../backends.html#module-torch.backends.opt_einsum) (The _ vs - is
...
As of PyTorch 1.10 [`torch.einsum()`](torch.einsum.html#torch.einsum) also supports the sublist format (see examples below). In this format,
