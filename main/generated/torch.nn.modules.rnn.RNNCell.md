...
*class*torch.nn.modules.rnn.RNNCell(*input_size*, *hidden_size*, *bias=True*, *nonlinearity='tanh'*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/nn/modules/rnn.py#L1542)
...
- **input_size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The number of expected features in the input x
- **hidden_size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The number of features in the hidden state h
- **bias** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `False`, then the layer does not use bias weights b_ih and b_hh.
Default: `True`
- **nonlinearity** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - The non-linearity to use. Can be either `'tanh'` or `'relu'`. Default: `'tanh'`
