...
*class*torch.nn.ConvTranspose2d(*in_channels*, *out_channels*, *kernel_size*, *stride=1*, *padding=0*, *output_padding=0*, *groups=1*, *bias=True*, *dilation=1*, *padding_mode='zeros'*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/a483bad75086c479c263d54ad3dbf19e1fde74d8/torch/nn/modules/conv.py#L1012)
...
when a [`Conv2d`](torch.nn.Conv2d.html#torch.nn.Conv2d) and a `ConvTranspose2d`
are initialized with same parameters, they are inverses of each other in
regard to the input and output shapes. However, when `stride > 1`,
[`Conv2d`](torch.nn.Conv2d.html#torch.nn.Conv2d) maps multiple input shapes to the same output
...
k=groupsCout∗∏i=01kernel_size[i]k = \frac{groups}{C_\text{out} * \prod_{i=0}^{1}\text{kernel\_size}[i]}k=Cout​∗∏i=01​kernel_size[i]groups​
...
forward(*input*, *output_size=None*)[[source]](https://github.com/pytorch/pytorch/blob/a483bad75086c479c263d54ad3dbf19e1fde74d8/torch/nn/modules/conv.py#L1169)
...
- **output_size** ([*list*](https://docs.python.org/3/builtins/stdtypes.html#list)*[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]**,**optional*) - A list of integers representing
