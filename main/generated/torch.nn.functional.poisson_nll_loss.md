...
torch.nn.functional.poisson_nll_loss(*input*, *target*, *log_input=True*, *full=False*, *size_average=None*, *eps=1e-08*, *reduce=None*, *reduction='mean'*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/nn/functional.py#L3247)
...
- **log_input** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True` the loss is computed as
...
- **full** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to compute full loss, i. e. to add the Stirling
