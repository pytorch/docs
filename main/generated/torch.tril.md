...
torch.tril(*input*, *diagonal=0*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
[`diagonal`](torch.diagonal.html#torch.diagonal) = 0, all elements on and below the main diagonal are
