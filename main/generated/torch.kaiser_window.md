...
- **window_length** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - length of the window.
- **periodic** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - If True, returns a periodic window suitable for use in spectral analysis.
If False, returns a symmetric window suitable for use in filter design.
- **beta** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - shape parameter for the window.
