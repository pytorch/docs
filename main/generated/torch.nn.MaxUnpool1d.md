...
*class*torch.nn.MaxUnpool1d(*kernel_size*, *stride=None*, *padding=0*)[[source]](https://github.com/pytorch/pytorch/blob/09c9b1ec9c2e88520d11a9c64b206359e8ca912b/torch/nn/modules/pooling.py#L324)

Computes a partial inverse of [`MaxPool1d`](torch.nn.MaxPool1d.html#torch.nn.MaxPool1d).

[`MaxPool1d`](torch.nn.MaxPool1d.html#torch.nn.MaxPool1d) is not fully invertible, since the non-maximal values are lost.

`MaxUnpool1d` takes in as input the output of [`MaxPool1d`](torch.nn.MaxPool1d.html#torch.nn.MaxPool1d)
...
[`MaxPool1d`](torch.nn.MaxPool1d.html#torch.nn.MaxPool1d) can map several input sizes to the same output
