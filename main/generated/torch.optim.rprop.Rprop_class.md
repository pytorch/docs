...
*class*torch.optim.rprop.Rprop(*params*, *lr=0.01*, *etas=(0.5, 1.2)*, *step_sizes=(1e-06, 50)*, ***, *capturable=False*, *foreach=None*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/rprop.py#L31)

Implements the resilient backpropagation algorithm.

input:θ0∈Rd (params),f(θ) (objective),η+/− (etaplus, etaminus),Γmax/min (step sizes)initialize:gprev0←0, η0←lr (learning rate)for t=1 to ... dogt←∇θft(θt−1)for i=0,1,...,d−1 doif gprevigti>0ηti←min(ηt−1iη+,Γmax)else if gprevigti<0ηti←max(ηt−1iη−,Γmin)gti←0else ηti←ηt−1iθt←θt−1−ηtsign(gt)gprev←gtreturn θt\begin{aligned}
 &\rule{110mm}{0.4pt} \\
...
​input:θ0​∈Rd (params),f(θ) (objective),η+/−​ (etaplus, etaminus),Γmax/min​ (step sizes)initialize:gprev0​←0,η0​←lr (learning rate)fort=1to...dogt​←∇θ​ft​(θt−1​)for i=0,1,...,d−1doifgprevi​gti​>0ηti​←min(ηt−1i​η+​,Γmax​)else ifgprevi​gti​<0ηti​←max(ηt−1i​η−​,Γmin​)gti​←0elseηti​←ηt−1i​θt​←θt−1​−ηt​sign(gt​)gprev​←gt​returnθt​​

For further details regarding the algorithm we refer to the paper
[A Direct Adaptive Method for Faster Backpropagation Learning: The RPROP Algorithm](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.21.1417).
...
- **lr** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - learning rate (default: 1e-2)
- **etas** (*Tuple**[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*,*[*float*](https://docs.python.org/3/builtins/functions.html#float)*]**,**optional*) - pair of (etaminus, etaplus), that
are multiplicative increase and decrease factors
(default: (0.5, 1.2))
- **step_sizes** (*Tuple**[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*,*[*float*](https://docs.python.org/3/builtins/functions.html#float)*]**,**optional*) - a pair of minimal and
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/rprop.py#L119)
