...
*class*torch.optim.lbfgs.LBFGS(*params*, *lr=1*, *max_iter=20*, *max_eval=None*, *tolerance_grad=1e-07*, *tolerance_change=1e-09*, *history_size=100*, *line_search_fn=None*, ***, *maximize=False*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/optim/lbfgs.py#L206)
...
- **lr** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - learning rate (default: 1)
- **max_iter** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - maximal number of iterations per optimization step
(default: 20)
- **max_eval** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - maximal number of function evaluations per optimization
step (default: max_iter * 1.25).
- **tolerance_grad** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - termination tolerance on first order optimality
(default: 1e-7).
- **tolerance_change** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - termination tolerance on function
value/parameter changes (default: 1e-9).
- **history_size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - update history size (default: 100).
- **line_search_fn** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**optional*) - either 'strong_wolfe' or None (default: None).
...
step(*closure*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/optim/lbfgs.py#L302)
