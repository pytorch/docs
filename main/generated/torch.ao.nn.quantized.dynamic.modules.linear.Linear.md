...
*class*torch.ao.nn.quantized.dynamic.modules.linear.Linear(*in_features*, *out_features*, *bias_=True*, *dtype=torch.qint8*)[[source]](https://github.com/pytorch/pytorch/blob/411c8477fa2478b2318f3823d57cf684a3a1f389/torch/ao/nn/quantized/dynamic/modules/linear.py#L13)
