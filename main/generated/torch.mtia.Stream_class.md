...
record_event(*event*) → [Event](torch.mtia.Event.html#torch.mtia.Event)
...
[Event](torch.mtia.Event.html#torch.mtia.Event)
...
**stream** ([`torch.Stream`](torch.Stream.html#torch.Stream)) - a stream to synchronize.
