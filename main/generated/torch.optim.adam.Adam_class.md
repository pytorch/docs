...
*class*torch.optim.adam.Adam(*params*, *lr=0.001*, *betas=(0.9, 0.999)*, *eps=1e-08*, *weight_decay=0*, *amsgrad=False*, ***, *foreach=None*, *maximize=False*, *capturable=False*, *differentiable=False*, *fused=None*, *decoupled_weight_decay=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/adam.py#L35)

Implements Adam algorithm.

input:γ (lr),β1,β2 (betas),θ0 (params),f(θ) (objective)λ (weight decay), amsgrad, maximize, ϵ (epsilon)initialize:m0←0 ( first moment),v0←0 (second moment), v0max←0for t=1 to ... doif maximize:gt←−∇θft(θt−1)elsegt←∇θft(θt−1)if λ≠0gt←gt+λθt−1mt←β1mt−1+(1−β1)gtvt←β2vt−1+(1−β2)gt2mt^←mt/(1−β1t)if amsgradvtmax←max(vt−1max,vt)vt^←vtmax/(1−β2t)elsevt^←vt/(1−β2t)θt←θt−1−γmt^/(vt^+ϵ)return θt\begin{aligned}
 &\rule{110mm}{0.4pt} \\
 ...
 &\rule{110mm}{0.4pt} \\[-1.ex]
\end{aligned}​input:γ (lr),β1​,β2​ (betas),θ0​ (params),f(θ) (objective)λ (weight decay),amsgrad,maximize,ϵ (epsilon)initialize:m0​←0 ( first moment),v0​←0 (second moment),v0max​←0fort=1to...doifmaximize:gt​←−∇θ​ft​(θt−1​)elsegt​←∇θ​ft​(θt−1​)ifλ=0gt​←gt​+λθt−1​mt​←β1​mt−1​+(1−β1​)gt​vt​←β2​vt−1​+(1−β2​)gt2​mt​​←mt​/(1−β1t​)ifamsgradvtmax​←max(vt−1max​,vt​)vt​​←vtmax​/(1−β2t​)elsevt​​←vt​/(1−β2t​)θt​←θt−1​−γmt​​/(vt​​​+ϵ)returnθt​​
...
- **lr** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,*[*Tensor*](../tensors.html#torch.Tensor)*,**optional*) - learning rate (default: 1e-3). A tensor LR
is not yet supported for all our implementations. Please use a float
LR if you are not also specifying fused=True or capturable=True.
- **betas** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*[*[*float*](https://docs.python.org/3/builtins/functions.html#float)*|*[*Tensor*](../tensors.html#torch.Tensor)*,*[*float*](https://docs.python.org/3/builtins/functions.html#float)*|*[*Tensor*](../tensors.html#torch.Tensor)*]**,**optional*) - coefficients used for computing running averages of gradient and
...
- **decoupled_weight_decay** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - if True, this optimizer is
equivalent to AdamW and the algorithm will not accumulate weight
decay in the momentum nor variance. (default: False)
- **amsgrad** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - whether to use the AMSGrad variant of this
...
- **fused** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - whether the fused implementation is used.
...
add_param_group(*param_group*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L1136)
...
load_state_dict(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L909)
...
register_load_state_dict_post_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L873)
...
register_load_state_dict_pre_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L834)
...
register_state_dict_post_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L675)
...
register_state_dict_pre_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L643)
...
register_step_post_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L622)
...
register_step_pre_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L599)
...
state_dict()[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L709)
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/adam.py#L215)
...
zero_grad(*set_to_none=True*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/optim/optimizer.py#L1057)
