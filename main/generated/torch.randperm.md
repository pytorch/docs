...
torch.randperm(*n*, ***, *generator=None*, *out=None*, *dtype=torch.int64*, *layout=torch.strided*, *device=None*, *requires_grad=False*, *pin_memory=False*) → [Tensor](../tensors.html#torch.Tensor)

Returns a random permutation of integers from `0` to `n - 1`.

Parameters:

**n** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - the upper bound (exclusive)
