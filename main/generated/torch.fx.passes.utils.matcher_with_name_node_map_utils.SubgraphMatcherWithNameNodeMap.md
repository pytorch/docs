...
*class*torch.fx.passes.utils.matcher_with_name_node_map_utils.SubgraphMatcherWithNameNodeMap(*pattern_gm*, *match_output=False*, *match_placeholder=False*, *remove_overlapping_matches=True*, *ignore_literals=False*)[[source]](https://github.com/pytorch/pytorch/blob/1af0b90bbfa06b98936ac35f25070579cffc8d74/torch/fx/passes/utils/matcher_with_name_node_map_utils.py#L43)
...
match(*graph*, *node_name_match=''*)[[source]](https://github.com/pytorch/pytorch/blob/1af0b90bbfa06b98936ac35f25070579cffc8d74/torch/fx/passes/utils/matcher_with_name_node_map_utils.py#L94)
