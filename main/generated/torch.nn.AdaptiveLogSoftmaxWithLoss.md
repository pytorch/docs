...
*class*torch.nn.AdaptiveLogSoftmaxWithLoss(*in_features*, *n_classes*, *cutoffs*, *div_value=4.0*, *head_bias=False*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/e01c6ae6acffaccede59e20d14af54437c5342d8/torch/nn/modules/adaptive.py#L21)
