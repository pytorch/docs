...
*class*torch.ao.nn.quantized.ConvTranspose3d(*in_channels*, *out_channels*, *kernel_size*, *stride=1*, *padding=0*, *output_padding=0*, *groups=1*, *bias=True*, *dilation=1*, *padding_mode='zeros'*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/b14e6fb508b03fc0a98fefe9b0750ba0d63500da/torch/ao/nn/quantized/modules/conv.py#L1125)
...
Currently only the FBGEMM engine is implemented.
Please, set the torch.backends.quantized.engine = 'fbgemm'

For special notes, please, see [`Conv3d`](torch.ao.nn.quantized.Conv3d.html#torch.ao.nn.quantized.Conv3d)
