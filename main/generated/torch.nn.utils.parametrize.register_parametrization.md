...
torch.nn.utils.parametrize.register_parametrization(*module*, *tensor_name*, *parametrization*, ***, *unsafe=False*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/nn/utils/parametrize.py#L450)
...
`parametrizations` to the module of type [`ParametrizationList`](torch.nn.utils.parametrize.ParametrizationList.html#torch.nn.utils.parametrize.ParametrizationList).
...
using the context manager [`cached()`](torch.nn.utils.parametrize.cached.html#torch.nn.utils.parametrize.cached).
...
[right inverse](https://en.wikipedia.org/wiki/Inverse_function#Right_inverses)).
