...
*class*torch.optim.Adadelta(*params*, *lr=1.0*, *rho=0.9*, *eps=1e-06*, *weight_decay=0*, *foreach=None*, ***, *capturable=False*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/7b5f32b1c4911f959ed9f61cd0aefb7ed57e0317/torch/optim/adadelta.py#L28)
