...
*class*torch.optim.Adadelta(*params*, *lr=1.0*, *rho=0.9*, *eps=1e-06*, *weight_decay=0*, *foreach=None*, ***, *capturable=False*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/9abc5460749ef85e489d960cb5facefc8cc1eb7c/torch/optim/adadelta.py#L28)
