...
torch.diagflat(*input*, *offset=0*) → [Tensor](../tensors.html#torch.Tensor)
...
- **offset** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - the diagonal to consider. Default: 0 (main
diagonal).
