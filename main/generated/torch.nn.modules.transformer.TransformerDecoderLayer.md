...
*class*torch.nn.modules.transformer.TransformerDecoderLayer(*d_model*, *nhead*, *dim_feedforward=2048*, *dropout=0.1*, *activation=<function relu>*, *layer_norm_eps=1e-05*, *batch_first=False*, *norm_first=False*, *bias=True*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/nn/modules/transformer.py#L985)
...
- **norm_first** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - if `True`, layer norm is done prior to self attention, multihead
...
forward(*tgt*, *memory*, *tgt_mask=None*, *memory_mask=None*, *tgt_key_padding_mask=None*, *memory_key_padding_mask=None*, *tgt_is_causal=False*, *memory_is_causal=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/nn/modules/transformer.py#L1086)
...
- **tgt_is_causal** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If specified, applies a causal mask as `tgt mask`.
Default: `False`.
Warning:
