...
*class*torch.optim.lr_scheduler.LRScheduler(*optimizer*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/0c8b4a78ffbbce776adc0823e790158b26435f40/torch/optim/lr_scheduler.py#L95)
...
learning rates of.
- **last_epoch** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Index of the last epoch seen by the scheduler. Use
