...
*class*torch.cuda.streams.ExternalStream(*stream_ptr*, *device=None*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/cuda/streams.py#L136)
