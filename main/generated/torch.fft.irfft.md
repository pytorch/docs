...
torch.fft.irfft(*input*, *n=None*, *dim=-1*, *norm=None*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/fft/__init__.py#L411)

Computes the inverse of [`rfft()`](torch.fft.rfft.html#torch.fft.rfft).

`input` is interpreted as a one-sided Hermitian signal in the Fourier
domain, as produced by [`rfft()`](torch.fft.rfft.html#torch.fft.rfft). By the Hermitian property, the
...
- **dim** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - The dimension along which to take the one dimensional real IFFT.
...
Calling the forward transform ([`rfft()`](torch.fft.rfft.html#torch.fft.rfft)) with the same
