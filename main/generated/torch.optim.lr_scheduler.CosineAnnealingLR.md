...
*class*torch.optim.lr_scheduler.CosineAnnealingLR(*optimizer*, *T_max*, *eta_min=0.0*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/optim/lr_scheduler.py#L1338)
...
- **T_max** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Maximum number of iterations.
- **eta_min** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - Minimum learning rate. Default: 0.
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/optim/lr_scheduler.py#L1399)
