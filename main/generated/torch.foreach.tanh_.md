...
torch.foreach.tanh_(*inputs: TensorList*, */*) → [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[[Tensor](../tensors.html#torch.Tensor), ...] | [list](https://docs.python.org/3/library/stdtypes.html#list)[[Tensor](../tensors.html#torch.Tensor)][[source]](https://github.com/pytorch/pytorch/blob/d4258aa05fc98e7852a6c78350d44e3fa7bdb2ab/torch/foreach/__init__.py#L661)

Applies [`torch.tanh()`](torch.tanh.html#torch.tanh) to each tensor in `inputs` in-place.

This is semantically equivalent to applying [`torch.tanh()`](torch.tanh.html#torch.tanh) independently
