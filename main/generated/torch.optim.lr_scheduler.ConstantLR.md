...
*class*torch.optim.lr_scheduler.ConstantLR(*optimizer*, *factor=0.3333333333333333*, *total_iters=5*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/optim/lr_scheduler.py#L773)
...
- **factor** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - The number we multiply learning rate until the milestone. Default: 1./3.
- **total_iters** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The number of steps that the scheduler multiplies the learning rate by the factor.
Default: 5.
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/optim/lr_scheduler.py#L822)
