...
*class*torch.optim.rmsprop.RMSprop(*params*, *lr=0.01*, *alpha=0.99*, *eps=1e-08*, *weight_decay=0*, *momentum=0*, *centered=False*, *capturable=False*, *foreach=None*, *maximize=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/optim/rmsprop.py#L31)
...
- **alpha** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - smoothing constant (default: 0.99)
...
- **centered** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - if `True`, compute the centered RMSProp,
...
step(*closure=None*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/optim/rmsprop.py#L145)
