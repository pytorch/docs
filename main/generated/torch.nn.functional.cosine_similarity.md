...
torch.nn.functional.cosine_similarity(*x1*, *x2*, *dim=1*, *eps=1e-8*, *keepdim=False*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/d1e2802e366c287c4773a50f4f0e8c35e8647bbb/torch/nn/functional.py#L5895)
