...
*class*torch.nn.SmoothL1Loss(*size_average=None*, *reduce=None*, *reduction='mean'*, *beta=1.0*)[[source]](https://github.com/pytorch/pytorch/blob/5ad9b8adb58904fa51d72bb483f93b8514080068/torch/nn/modules/loss.py#L988)
...
Smooth L1 loss can be seen as exactly [`L1Loss`](torch.nn.L1Loss.html#torch.nn.L1Loss), but with the ∣x−y∣<beta|x - y| < beta∣x−y∣<beta
...
Smooth L1 loss is closely related to [`HuberLoss`](torch.nn.HuberLoss.html#torch.nn.HuberLoss), being
...
- As beta -> 0, Smooth L1 loss converges to [`L1Loss`](torch.nn.L1Loss.html#torch.nn.L1Loss), while [`HuberLoss`](torch.nn.HuberLoss.html#torch.nn.HuberLoss)
...
[`HuberLoss`](torch.nn.HuberLoss.html#torch.nn.HuberLoss) converges to [`MSELoss`](torch.nn.MSELoss.html#torch.nn.MSELoss).
- For Smooth L1 loss, as beta varies, the L1 segment of the loss has a constant slope of 1.
For [`HuberLoss`](torch.nn.HuberLoss.html#torch.nn.HuberLoss), the slope of the L1 segment is beta.
...
forward(*input*, *target*)[[source]](https://github.com/pytorch/pytorch/blob/5ad9b8adb58904fa51d72bb483f93b8514080068/torch/nn/modules/loss.py#L1076)
