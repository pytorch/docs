...
torch.linalg.multi_dot(*tensors*, ***, *out=None*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/linalg/__init__.py#L1669)
...
This function is implemented by chaining [`torch.mm()`](torch.mm.html#torch.mm) calls after
computing the optimal matrix multiplication order.

Note

The cost of multiplying two matrices with shapes (a, b) and (b, c) is
...
**tensors** (*Sequence**[*[*Tensor*](../tensors.html#torch.Tensor)*]*) - two or more tensors to multiply. The first and last
