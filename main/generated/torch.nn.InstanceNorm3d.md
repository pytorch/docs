...
*class*torch.nn.InstanceNorm3d(*num_features*, *eps=1e-05*, *momentum=0.1*, *affine=False*, *track_running_stats=False*, *device=None*, *dtype=None*, ***, *bias=True*)[[source]](https://github.com/pytorch/pytorch/blob/211c61413d1f81c4a6ec8f1820328bef5cb24d86/torch/nn/modules/instancenorm.py#L375)
...
`InstanceNorm3d` and [`LayerNorm`](torch.nn.LayerNorm.html#torch.nn.LayerNorm) are very similar, but
