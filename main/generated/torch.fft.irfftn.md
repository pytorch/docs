...
torch.fft.irfftn(*input*, *s=None*, *dim=None*, *norm=None*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/c9fded8194d3b089ed610b586eb746a6e74c6616/torch/fft/__init__.py#L704)

Computes the inverse of [`rfftn()`](torch.fft.rfftn.html#torch.fft.rfftn).

`input` is interpreted as a one-sided Hermitian signal in the Fourier
domain, as produced by [`rfftn()`](torch.fft.rfftn.html#torch.fft.rfftn). By the Hermitian property, the
...
Calling the forward transform ([`rfftn()`](torch.fft.rfftn.html#torch.fft.rfftn)) with the same
...
Without specifying the output length to [`irfft()`](torch.fft.irfft.html#torch.fft.irfft), the output
