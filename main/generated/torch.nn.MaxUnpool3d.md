...
*class*torch.nn.MaxUnpool3d(*kernel_size*, *stride=None*, *padding=0*)[[source]](https://github.com/pytorch/pytorch/blob/fe3f518c806b6f1fb8acc283135e5414b8606887/torch/nn/modules/pooling.py#L503)

Computes a partial inverse of [`MaxPool3d`](torch.nn.MaxPool3d.html#torch.nn.MaxPool3d).

[`MaxPool3d`](torch.nn.MaxPool3d.html#torch.nn.MaxPool3d) is not fully invertible, since the non-maximal values are lost.
`MaxUnpool3d` takes in as input the output of [`MaxPool3d`](torch.nn.MaxPool3d.html#torch.nn.MaxPool3d)
...
[`MaxPool3d`](torch.nn.MaxPool3d.html#torch.nn.MaxPool3d) can map several input sizes to the same output
...
forward(*input*, *indices*, *output_size=None*)[[source]](https://github.com/pytorch/pytorch/blob/fe3f518c806b6f1fb8acc283135e5414b8606887/torch/nn/modules/pooling.py#L573)
