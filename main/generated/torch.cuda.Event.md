...
*class*torch.cuda.Event(*enable_timing=False*, *blocking=False*, *interprocess=False*, *external=False*)[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L159)
...
elapsed_time(*end_event*)[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L234)
...
*classmethod*from_ipc_handle(*device*, *handle*)[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L194)

Reconstruct an event from an IPC handle on the given device.

ipc_handle()[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L256)

Return an IPC handle of this event.

If not recorded yet, the event will use the current device.

query()[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L225)
...
record(*stream=None*)[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L199)
...
synchronize()[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L245)
...
wait(*stream=None*)[[source]](https://github.com/pytorch/pytorch/blob/6e3cf2e4280672104341718ea51a55799bb3aca4/torch/cuda/streams.py#L211)
