...
torch.linalg.vecdot(*x*, *y*, ***, *dim=-1*, *out=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/0c8b4a78ffbbce776adc0823e790158b26435f40/torch/linalg/__init__.py#L3091)
...
- **dim** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Dimension along which to compute the dot product. Default: -1.
