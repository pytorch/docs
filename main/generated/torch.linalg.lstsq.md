...
torch.linalg.lstsq(*A*, *B*, *rcond=None*, ***, *driver=None*)[[source]](https://github.com/pytorch/pytorch/blob/09c9b1ec9c2e88520d11a9c64b206359e8ca912b/torch/linalg/__init__.py#L1078)

Computes a solution to the least squares problem of a system of linear equations.

Letting K\mathbb{K}K be R\mathbb{R}R or C\mathbb{C}C,
the **least squares problem** for a linear system AX=BAX = BAX=B with
A∈Km×n,B∈Km×kA \in \mathbb{K}^{m \times n}, B \in \mathbb{K}^{m \times k}A∈Km×n,B∈Km×k is defined as

min⁡X∈Kn×k∥AX−B∥F\min_{X \in \mathbb{K}^{n \times k}} \|AX - B\|_FX∈Kn×kmin​∥AX−B∥F​
...
In this case, if σi\sigma_iσi​ are the singular values of A in decreasing order,
σi\sigma_iσi​ will be rounded down to zero if σi≤rcond⋅σ1\sigma_i \leq \text{rcond} \cdot \sigma_1σi​≤rcond⋅σ1​.
...
- residuals: the squared residuals of the solutions, that is, ∥AX−B∥F2\|AX - B\|_F^2∥AX−B∥F2​.
It has shape (*, k).
