...
Tensor.scatter_(*dim*, *index*, *src*, ***, *reduce=None*) → [Tensor](../tensors.html#torch.Tensor)
...
This is the reverse operation of the manner described in [`gather()`](torch.Tensor.gather.html#torch.Tensor.gather).
...
Moreover, as for [`gather()`](torch.Tensor.gather.html#torch.Tensor.gather), the values of `index` must be
