...
torch.fft.fftshift(*input*, *dim=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/a533e5c93d4fb8c4eb7bd23c7d297cbba493caa1/torch/fft/__init__.py#L1329)
...
0<i≤n/20 < i \leq n/20<i≤n/2 in Python gives the negative frequency terms.
`fftshift()` rearranges all frequencies into ascending order
...
[`fftfreq()`](torch.fft.fftfreq.html#torch.fft.fftfreq).
...
applying an [`ifftshift()`](torch.fft.ifftshift.html#torch.fft.ifftshift).
