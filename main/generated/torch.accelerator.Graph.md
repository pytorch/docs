...
*class*torch.accelerator.Graph(*keep_graph=False*, ***, *pool=None*, *capture_error_mode='default'*)[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L9)
...
capture_begin()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L76)
...
capture_end()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L87)

End graph capture on the current stream of the current device.

After this call, the graph can be replayed via `replay`.

debug_dump(*path*)[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L140)
...
enable_debug_mode()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L136)

Enable debugging mode for `debug_dump`.

instantiate()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L95)
...
pool()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L116)
...
replay()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L103)

Replay the work captured by this graph.

reset()[[source]](https://github.com/pytorch/pytorch/blob/2c911a1e1af237cf87c0e6e42a0fc9589043282b/torch/accelerator/graphs.py#L107)
