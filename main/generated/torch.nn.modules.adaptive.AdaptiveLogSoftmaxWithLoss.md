...
*class*torch.nn.modules.adaptive.AdaptiveLogSoftmaxWithLoss(*in_features*, *n_classes*, *cutoffs*, *div_value=4.0*, *head_bias=False*, *device=None*, *dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/nn/modules/adaptive.py#L21)
...
- **in_features** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Number of features in the input tensor
- **n_classes** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Number of classes in the dataset
- **cutoffs** (*Sequence*) - Cutoffs used to assign targets to their buckets
- **div_value** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*,**optional*) - value used as an exponent to compute sizes
of the clusters. Default: 4.0
- **head_bias** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - If `True`, adds a bias term to the 'head' of the
...
forward(*input_*, *target_*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/nn/modules/adaptive.py#L186)
...
log_prob(*input*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/nn/modules/adaptive.py#L286)
...
predict(*input*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/nn/modules/adaptive.py#L305)
...
reset_parameters()[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/nn/modules/adaptive.py#L177)
