...
torch.foreach.neg(*inputs: TensorList*, */*) → [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[Tensor](../tensors.html#torch.Tensor), ...][[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/foreach/__init__.py#L534)

Applies [`torch.neg()`](torch.neg.html#torch.neg) to each tensor in `inputs`.

This is semantically equivalent to applying [`torch.neg()`](torch.neg.html#torch.neg) independently
