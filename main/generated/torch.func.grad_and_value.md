...
torch.func.grad_and_value(*func*, *argnums=0*, *has_aux=False*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/_functorch/apis.py#L468)
...
- **argnums** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*or**Tuple**[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]*) - Specifies arguments to compute gradients
with respect to. `argnums` can be single integer or tuple of
integers. Default: 0.
- **has_aux** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Flag indicating that `func` returns a tensor and
...
[*Callable*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable)[[~_P], [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[*Any*](https://docs.python.org/3/library/typing.html#typing.Any), [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)]]
