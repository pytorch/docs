...
torch.fft.irfft2(*input*, *s=None*, *dim=(-2, -1)*, *norm=None*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/6a231d0d3e1ccd63dd51479bcadc969d0a8de2b9/torch/fft/__init__.py#L555)
...
domain, as produced by [`rfft2()`](torch.fft.rfft2.html#torch.fft.rfft2). By the Hermitian property, the
...
Calling the forward transform ([`rfft2()`](torch.fft.rfft2.html#torch.fft.rfft2)) with the same
