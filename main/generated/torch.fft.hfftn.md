...
torch.fft.hfftn(*input*, *s=None*, *dim=None*, *norm=None*, ***, *out=None*) → [Tensor](../tensors.html#torch.Tensor)[[source]](https://github.com/pytorch/pytorch/blob/847b7df02b84551445eda7d44d08f15bda4c6159/torch/fft/__init__.py#L1068)
...
`hfftn()`/[`ihfftn()`](torch.fft.ihfftn.html#torch.fft.ihfftn) are analogous to
[`rfftn()`](torch.fft.rfftn.html#torch.fft.rfftn)/[`irfftn()`](torch.fft.irfftn.html#torch.fft.irfftn). The real FFT expects
...
same way as with [`irfftn()`](torch.fft.irfftn.html#torch.fft.irfftn).
...
Calling the backward transform ([`ihfftn()`](torch.fft.ihfftn.html#torch.fft.ihfftn)) with the same
normalization mode will apply an overall normalization of `1/n` between
the two transforms. This is required to make [`ihfftn()`](torch.fft.ihfftn.html#torch.fft.ihfftn)
the exact inverse.
