...
torch.func.jvp(*func*, *primals*, *tangents*, ***, *strict=False*, *has_aux=False*)[[source]](https://github.com/pytorch/pytorch/blob/e5aa1320b162fc3b9d0d53207fe340a6d3aa03d1/torch/_functorch/eager_transforms.py#L1092)
...
`jvp()` can support functions with multiple inputs by passing in the
