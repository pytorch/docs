...
*class*torch.ao.quantization.fx.custom_config.PrepareCustomConfig[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L46)
...
*classmethod*from_dict(*prepare_custom_config_dict*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L184)
...
set_float_to_observed_mapping(*float_class*, *observed_class*, *quant_type=QuantType.STATIC*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L120)
...
set_input_quantized_indexes(*indexes*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L159)
...
set_non_traceable_module_classes(*module_classes*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L150)
...
set_non_traceable_module_names(*module_names*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L141)
...
set_output_quantized_indexes(*indexes*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L167)
...
set_preserved_attributes(*attributes*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L175)
...
set_standalone_module_class(*module_class*, *qconfig_mapping*, *example_inputs*, *prepare_custom_config*, *backend_config*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L100)
...
set_standalone_module_name(*module_name*, *qconfig_mapping*, *example_inputs*, *prepare_custom_config*, *backend_config*)[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L80)
...
to_dict()[[source]](https://github.com/pytorch/pytorch/blob/9ab94917c245d16efe77f546d30d73800c8d728d/torch/ao/quantization/fx/custom_config.py#L320)
