...
*class*torch.optim.swa_utils.AveragedModel(*model*, *device=None*, *avg_fn=None*, *multi_avg_fn=None*, *use_buffers=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/optim/swa_utils.py#L165)
...
AveragedModel class creates a copy of the provided module `model`
on the device `device` and allows to compute running averages of the
parameters of the `model`.

Parameters:

- **model** ([*torch.nn.Module*](torch.nn.Module.html#torch.nn.Module)) - model to use with SWA/EMA
- **device** ([*torch.device*](../tensor_attributes.html#torch.device)*,**optional*) - if provided, the averaged model will be
...
This can be done either by using the [`torch.optim.swa_utils.update_bn()`](../optim.html#torch.optim.swa_utils.update_bn)
or by setting `use_buffers` to True. The first approach updates the
...
When `update_parameters()` is called for the first time (i.e.
`n_averaged` is 0) the parameters of model are copied
to the parameters of `AveragedModel`. For every subsequent
call of `update_parameters()` the function avg_fn is used
to update the parameters.

add_module(*name*, *module*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L642)
...
apply(*fn*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1038)
...
bfloat16()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1213)
...
buffers(*recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2722)
...
children()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2776)
...
compile(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L3044)
...
cpu()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1155)
...
cuda(*device=None*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1079)
...
double()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1191)
...
eval()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2907)
...
This is equivalent with [`self.train(False)`](torch.nn.Module.html#torch.nn.Module.train).
...
extra_repr()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2984)
...
float()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1180)
...
forward(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/optim/swa_utils.py#L290)

Forward pass.

get_buffer(*target*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L856)
...
get_extra_state()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L892)
...
get_parameter(*target*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L820)
...
get_submodule(*target*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L674)
...
[torch.nn.Module](torch.nn.Module.html#torch.nn.Module)
...
half()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1202)
...
ipu(*device=None*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1098)
...
load_state_dict(*state_dict*, *strict=True*, *assign=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2530)

Copy parameters and buffers from `state_dict` into this module and its descendants.

If `strict` is `True`, then
the keys of `state_dict` must exactly match the keys returned
by this module's [`state_dict()`](torch.nn.Module.html#torch.nn.Module.state_dict) function.
...
modules(*remove_duplicate=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2805)
...
mtia(*device=None*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1136)
...
named_buffers(*prefix=''*, *recurse=True*, *remove_duplicate=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2745)
...
named_children()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2785)
...
named_modules(*memo=None*, *prefix=''*, *remove_duplicate=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2836)
...
named_parameters(*prefix=''*, *recurse=True*, *remove_duplicate=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2690)
...
parameters(*recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2665)
...
register_backward_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1434)

Register a backward hook on the module.

This function is deprecated in favor of [`register_full_backward_hook()`](torch.nn.Module.html#torch.nn.Module.register_full_backward_hook) and
...
register_buffer(*name*, *tensor*, *persistent=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L528)
...
register_forward_hook(*hook*, ***, *prepend=False*, *with_kwargs=False*, *always_call=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1687)
...
this [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module). Note that global
...
register_forward_pre_hook(*hook*, ***, *prepend=False*, *with_kwargs=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1624)
...
on this [`torch.nn.Module`](torch.nn.Module.html#torch.nn.Module). Note that global
...
register_full_backward_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1460)
...
register_full_backward_pre_hook(*hook*, *prepend=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1385)
...
register_load_state_dict_post_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2316)
...
register_load_state_dict_pre_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2304)
...
register_module(*name*, *module*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L670)

Alias for `add_module()`.

register_parameter(*name*, *param*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L592)
...
register_state_dict_post_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2106)
...
register_state_dict_pre_hook(*hook*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2130)
...
requires_grad_(*requires_grad=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2925)
...
set_extra_state(*state*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L913)
...
set_submodule(*target*, *module*, *strict=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L739)
...
share_memory()[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2977)
...
state_dict(**args*, *destination=None*, *prefix=''*, *keep_vars=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2194)
...
to(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1254)

Move and/or cast the parameters and buffers.

This can be called as

to(*device=None*, *dtype=None*, *non_blocking=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1254)

to(*dtype*, *non_blocking=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1254)

to(*tensor*, *non_blocking=False*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1254)

to(*memory_format=torch.channels_last*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1254)
...
to_empty(***, *device*, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1224)
...
train(*mode=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2885)
...
type(*dst_type*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1166)
...
update_parameters(*model*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/optim/swa_utils.py#L294)

Update model parameters.

xpu(*device=None*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L1117)
...
zero_grad(*set_to_none=True*)[[source]](https://github.com/pytorch/pytorch/blob/c8f2d26abd0de59995af555e80c82ca1221bc21b/torch/nn/modules/module.py#L2948)
