...
*class*torch.nn.utils.prune.Identity[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/nn/utils/prune.py#L419)

Utility pruning method that does not prune any units but generates the pruning parametrization with a mask of ones.

*classmethod*apply(*module*, *name*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/nn/utils/prune.py#L428)
