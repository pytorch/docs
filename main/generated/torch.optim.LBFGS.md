...
*class*torch.optim.LBFGS(*params*, *lr=1*, *max_iter=20*, *max_eval=None*, *tolerance_grad=1e-07*, *tolerance_change=1e-09*, *history_size=100*, *line_search_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/063b516448b60c5818cfe255e27825810710849a/torch/optim/lbfgs.py#L206)
