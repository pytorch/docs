...
torch.func.functional_call(*module*, *parameter_and_buffer_dicts*, *args=None*, *kwargs=None*, ***, *tie_weights=True*, *strict=False*)[[source]](https://github.com/pytorch/pytorch/blob/b7954b2399da4803024b9a2850e39c588522015f/torch/_functorch/functional_call.py#L12)
...
`parameter_and_buffer_dicts` argument with the name set to the regular parameter
...
If the user does not need grad tracking outside of grad transforms, they can detach all of the
