...
torch.autograd.grad(*outputs: _TensorOrTensorsOrGradEdge*, *inputs: _TensorOrTensorsOrGradEdge*, *grad_outputs: [Tensor](../tensors.html#torch.Tensor) | [Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[Tensor](../tensors.html#torch.Tensor) | [None](https://docs.python.org/3/builtins/constants.html#None)] | [None](https://docs.python.org/3/builtins/constants.html#None) = None*, *retain_graph: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None*, *create_graph: [bool](https://docs.python.org/3/builtins/functions.html#bool) = False*, *only_inputs: [bool](https://docs.python.org/3/builtins/functions.html#bool) = True*, *allow_unused: [bool](https://docs.python.org/3/builtins/functions.html#bool) | [None](https://docs.python.org/3/builtins/constants.html#None) = None*, *is_grads_batched: [bool](https://docs.python.org/3/builtins/functions.html#bool) = False*, *materialize_grads: [bool](https://docs.python.org/3/builtins/functions.html#bool) = False*) → [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[Tensor](../tensors.html#torch.Tensor), ...][[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/autograd/__init__.py#L434)
...
- **inputs** (*sequence**of*[*Tensor*](../tensors.html#torch.Tensor)*or*[*GradientEdge*](../autograd.html#torch.autograd.graph.GradientEdge)*or*[*dict*](https://docs.python.org/3/builtins/stdtypes.html#dict)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,*[*Tensor*](../tensors.html#torch.Tensor)*]*) - Inputs w.r.t. which
...
Default: `False`.
- **allow_unused** (*Optional**[*[*bool*](https://docs.python.org/3/builtins/functions.html#bool)*]**,**optional*) - If `False`, specifying inputs
...
- **is_grads_batched** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - If `True`, the first dimension of each
...
- **materialize_grads** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - If `True`, set the gradient for unused inputs
