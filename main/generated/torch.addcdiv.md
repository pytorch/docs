...
torch.addcdiv(*input*, *tensor1*, *tensor2*, ***, *value=1*, *out=None*) → [Tensor](../tensors.html#torch.Tensor)
...
- **tensor1** ([*Tensor*](../tensors.html#torch.Tensor)) - the numerator tensor
- **tensor2** ([*Tensor*](../tensors.html#torch.Tensor)) - the denominator tensor
