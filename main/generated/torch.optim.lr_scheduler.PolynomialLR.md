...
*class*torch.optim.lr_scheduler.PolynomialLR(*optimizer*, *total_iters=5*, *power=1.0*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/optim/lr_scheduler.py#L1237)
...
- **total_iters** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The number of steps that the scheduler decays the learning rate. Default: 5.
- **power** ([*float*](https://docs.python.org/3/builtins/functions.html#float)) - The power of the polynomial. Default: 1.0.
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/optim/lr_scheduler.py#L1275)
