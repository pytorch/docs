...
*class*torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(*optimizer*, *T_0*, *T_mult=1*, *eta_min=0.0*, *last_epoch=-1*)[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/optim/lr_scheduler.py#L2105)
...
get_lr()[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/optim/lr_scheduler.py#L2169)
...
step(*epoch=None*)[[source]](https://github.com/pytorch/pytorch/blob/3fadfe4be9707a8a43a23db6e0da32dc1b507694/torch/optim/lr_scheduler.py#L2210)
