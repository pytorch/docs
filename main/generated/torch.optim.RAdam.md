...
*class*torch.optim.RAdam(*params*, *lr=0.001*, *betas=(0.9, 0.999)*, *eps=1e-08*, *weight_decay=0*, *decoupled_weight_decay=False*, ***, *foreach=None*, *maximize=False*, *capturable=False*, *differentiable=False*)[[source]](https://github.com/pytorch/pytorch/blob/a533e5c93d4fb8c4eb7bd23c7d297cbba493caa1/torch/optim/radam.py#L31)
