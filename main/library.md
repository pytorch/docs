...
torch.library.opcheck(*op*, *args*, *kwargs=None*, ***, *test_utils=('test_schema', 'test_autograd_registration', 'test_faketensor', 'test_aot_dispatch_dynamic')*, *raise_exception=True*, *atol=None*, *rtol=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1787)
...
torch.library.custom_op(*name*, *fn=None*, */*, ***, *mutates_args*, *device_types=None*, *schema=None*, *tags=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/custom_ops.py#L66)
...
torch.library.triton_op(*name*, *fn=None*, */*, ***, *mutates_args*, *schema=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/triton.py#L296)
...
torch.library.wrap_triton(*triton_kernel*, */*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/triton.py#L534)
...
torch.library.register_kernel(*op*, *device_types*, *func=None*, */*, ***, *lib=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1017)
...
torch.library.register_autocast(*op*, *device_type*, *cast_inputs*, */*, ***, *lib=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1076)
...
torch.library.register_autograd(*op*, *backward*, */*, ***, *setup_context=None*, *lib=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1322)
...
torch.library.register_fake(*op*, *func=None*, */*, ***, *lib=None*, *_stacklevel=1*, *allow_override=True*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1159)
...
torch.library.register_vmap(*op*, *func=None*, */*, ***, *lib=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1514)
...
torch.library.impl_abstract(*qualname*, *func=None*, ***, *lib=None*, *_stacklevel=1*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L973)

This API was renamed to `torch.library.register_fake()` in PyTorch 2.4.
Please use that instead.

torch.library.get_ctx()[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1696)
...
torch.library.register_torch_dispatch(*op*, *torch_dispatch_class*, *func=None*, */*, ***, *lib=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1446)
...
torch.library.infer_schema(*prototype_function*, */*, ***, *mutates_args*, *op_name=None*, *tags=()*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/infer_schema.py#L23)
...
*class*torch._library.custom_ops.CustomOpDef(*namespace*, *name*, *schema*, *fn*, *tags=None*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/custom_ops.py#L272)
...
set_kernel_enabled(*device_type*, *enabled=True*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/_library/custom_ops.py#L322)
...
torch.library.get_kernel(*op*, *dispatch_key*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L1705)
...
*class*torch.library.Library(*ns*, *kind*, *dispatch_key=''*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L212)
...
define(*schema*, *alias_analysis=''*, ***, *tags=()*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L272)
...
fallback(*fn*, *dispatch_key=''*, ***, *with_keyset=False*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L551)
...
impl(*op_name*, *fn*, *dispatch_key=''*, ***, *with_keyset=False*, *allow_override=True*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L441)
...
register_symm_mem_args(*op_name*, *arg_names*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L518)
...
torch.library.fallthrough_kernel()[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L60)

A dummy function to pass to `Library.impl` in order to register a fallthrough.

torch.library.define(*qualname*, *schema*, ***, *lib=None*, *tags=()*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L694)
...
torch.library.impl(*lib*, *name*, *dispatch_key=''*)[[source]](https://github.com/pytorch/pytorch/blob/3af07571b9d7402fd74352d079e6ff5fa307ec5f/torch/library.py#L804)
