...
- [`torch.ones()`](generated/torch.ones.html#torch.ones)
- [`torch.tensor()`](generated/torch.tensor.html#torch.tensor)
- [`torch.zeros()`](generated/torch.zeros.html#torch.zeros)

## Named dimensions

See `names` for restrictions on tensor names.

Use `names` to access the dimension names of a tensor and
...
[`torch.Tensor`](tensors.html#torch.Tensor). Unnamed tensors have `None`-named dimensions. Named
...
all unnamed dimensions to be named dimensions by using `refine_names()`.
...
Use `align_as()` or `align_to()` to align tensor dimensions
...
mentioning all of them as in required by [`permute()`](generated/torch.Tensor.permute.html#torch.Tensor.permute).
...
Use [`flatten()`](generated/torch.Tensor.flatten.html#torch.Tensor.flatten) and [`unflatten()`](generated/torch.Tensor.unflatten.html#torch.Tensor.unflatten) to flatten and unflatten
dimensions, respectively. These methods are more verbose than [`view()`](generated/torch.Tensor.view.html#torch.Tensor.view)
and [`reshape()`](generated/torch.Tensor.reshape.html#torch.Tensor.reshape), but have more semantic meaning to someone reading the code.
...
- [`torch.nn.functional.relu()`](generated/torch.nn.functional.relu.html#torch.nn.functional.relu)
- [`torch.nn.functional.softmax()`](generated/torch.nn.functional.softmax.html#torch.nn.functional.softmax)
- [`torch.nn.functional.log_softmax()`](generated/torch.nn.functional.log_softmax.html#torch.nn.functional.log_softmax)
- [`torch.nn.functional.tanh()`](generated/torch.nn.functional.tanh.html#torch.nn.functional.tanh)
- [`torch.nn.functional.sigmoid()`](generated/torch.nn.functional.sigmoid.html#torch.nn.functional.sigmoid)
- [`torch.nn.functional.dropout()`](generated/torch.nn.functional.dropout.html#torch.nn.functional.dropout)

### Subsystems

Autograd is supported, see Autograd support.
...
- distributions
- serialization ([`torch.load()`](generated/torch.load.html#torch.load), [`torch.save()`](generated/torch.save.html#torch.save))
- multiprocessing
- JIT
- distributed
- ONNX
...
flatten(*dims*, *out_dim*) → [Tensor](tensors.html#torch.Tensor)
