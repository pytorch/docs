...
torch.nn.init.calculate_gain(*nonlinearity*, *param=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L173)
...
torch.nn.init.uniform_(*tensor*, *a=0.0*, *b=1.0*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L247)
...
torch.nn.init.normal_(*tensor*, *mean=0.0*, *std=1.0*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L274)
...
torch.nn.init.constant_(*tensor*, *val*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L337)
...
torch.nn.init.ones_(*tensor*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L355)
...
torch.nn.init.zeros_(*tensor*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L368)
...
torch.nn.init.eye_(*tensor*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L381)
...
torch.nn.init.dirac_(*tensor*, *groups=1*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L402)
...
torch.nn.init.xavier_uniform_(*tensor*, *gain=1.0*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L479)
...
torch.nn.init.xavier_normal_(*tensor*, *gain=1.0*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L512)
...
torch.nn.init.kaiming_uniform_(*tensor*, *a=0*, *mode='fan_in'*, *nonlinearity='leaky_relu'*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L554)
...
torch.nn.init.kaiming_normal_(*tensor*, *a=0*, *mode='fan_in'*, *nonlinearity='leaky_relu'*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L619)
...
torch.nn.init.trunc_normal_(*tensor*, *mean=0.0*, *std=1.0*, *a=-2.0*, *b=2.0*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L301)
...
torch.nn.init.orthogonal_(*tensor*, *gain=1*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L672)
...
torch.nn.init.sparse_(*tensor*, *sparsity*, *std=0.01*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/6421eecbd685d270304ca7e0136286a344319752/torch/nn/init.py#L723)
