...
torch.distributed.fsdp.fully_shard(*module*, ***, *mesh=None*, *reshard_after_forward=None*, *shard_placement_fn=None*, *mp_policy=MixedPrecisionPolicy(param_dtype=None, reduce_dtype=None, output_dtype=None, cast_forward_inputs=True)*, *offload_policy=OffloadPolicy()*, *ignored_params=None*, *dp_mesh_dims=None*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L97)
...
current device.
- **reshard_after_forward** (*Optional**[**Union**[*[*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]**]*) -
...
- **ignored_params** ([*set*](https://docs.python.org/3/builtins/stdtypes.html#set)*[**nn.Parameter**]**|**None*) - Optional(Set[nn.Parameter]): The set of parameters to be
...
finalize_backward()[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L448)
...
reset_iter_state()[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L375)
...
reshard()[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L335)
...
set_all_reduce_hook(*hook*, ***, *stream=None*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L653)
...
set_allocate_memory_from_process_group_for_comm(*enable*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L869)
...
set_custom_all_gather(*comm*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L615)
...
set_custom_reduce_scatter(*comm*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L634)
...
set_force_sum_reduction_for_comms(*enable*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L721)
...
set_gradient_divide_factor(*factor*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L708)
...
set_is_last_backward(*is_last_backward*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L403)
...
set_manual_backward_finalization(*enabled*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L413)

Set whether the caller must finalize backward.

This must be called on the root FSDP module. When enabled, manual
finalization supersedes `set_is_last_backward()`. Call
`finalize_backward()` after all backward passes in the logical
...
set_modules_to_backward_prefetch(*modules*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L595)
...
set_modules_to_forward_prefetch(*modules*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L575)
...
set_post_optim_event(*event*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L684)
...
set_reduce_scatter_divide_factor(*factor*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L703)

Use `set_gradient_divide_factor()` instead

set_reduce_scatter_max_input_buffers(*max_input_buffers*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L769)
...
- **max_input_buffers** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Max reduce-scatter input buffers retained in
...
set_reduce_scatter_unused_params(*reduce_scatter_unused_params*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L742)
...
set_requires_all_reduce(*requires_all_reduce*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L499)

Sets if the module should all-reduce gradients. This can be used to
implement gradient accumulation with only reduce-scatter but not
all-reduce for HSDP.

set_requires_gradient_sync(*requires_gradient_sync*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L475)
...
- **requires_gradient_sync** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to reduce gradients for the
module's parameters.
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to set for all FSDP submodules or just the
passed-in module.

set_reshard_after_backward(*reshard_after_backward*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L552)
...
- **reshard_after_backward** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to reshard parameters after
backward.
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to set for all FSDP submodules or just the
passed-in module.

set_reshard_after_forward(*reshard_after_forward*, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L515)
...
- **reshard_after_forward** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to reshard parameters after
forward.
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to set for all FSDP submodules or just the
passed-in module.

set_separate_reduce_scatter_group(*enable=True*, ***, *recurse=True*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L820)
...
- **enable** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - `True` (default) gives reduce-scatter its own
process group; `False` resets it to the shared shard/all-gather
group.
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to set for all FSDP submodules or just the
passed-in module.

set_symm_mem_for_comm(*backend='NCCL'*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L890)
...
set_unshard_in_backward(*unshard_in_backward*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L858)
...
unshard(*async_op=False*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L345)
...
**async_op** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then returns a `UnshardHandle`
...
wait()[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L969)
...
torch.distributed.fsdp.register_fsdp_forward_method(*module*, *method_name*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L989)
...
- **method_name** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - Name of the forward method.
...
- **cast_forward_inputs** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - This specifies whether FSDP should cast the
...
**pin_memory** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to pin sharded parameter and gradient
...
torch.distributed.fsdp.share_comm_ctx(*modules*)[[source]](https://github.com/pytorch/pytorch/blob/5eb87fdd0ab88b4b6cc91ec5bfcf4de22d6a6c49/torch/distributed/fsdp/_fully_shard/_fully_shard.py#L1027)
...
- **shard** (*Optional**[**Union**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,*[*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**...**]**]**]*) - Mesh dimension name(s)
...
- **replicate** (*Optional**[**Union**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,*[*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**...**]**]**]*) - Mesh dimension
