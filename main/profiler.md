...
torch.profiler.profiler.schedule(***, *wait*, *warmup*, *active*, *repeat=0*, *skip_first=0*, *skip_first_wait=0*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L972)
...
torch.profiler.profiler.supported_activities()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L96)
...
torch.profiler.profiler.tensorboard_trace_handler(*dir_name*, *worker_name=None*, *use_gzip=False*, *use_python_export=False*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L1042)
...
add_metadata(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L834)

Adds a user defined metadata with a string key and a string value
into the trace file

add_metadata_json(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L843)

Adds a user defined metadata with a string key and a valid json value
into the trace file

events()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L820)
...
export_chrome_trace(*path*, *use_python_export=False*, *cuda_graph_annotations=None*, *graph_lanes='none'*, *default_stream=7*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L637)
...
export_memory_timeline(*path*, *device=None*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L891)
...
export_stacks(*path*, *metric='self_cpu_time_total'*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L746)
...
get_trace_id()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L1539)

Returns the current trace ID.

key_averages(*group_by_input_shape=False*, *group_by_stack_n=0*, *group_by_overload_name=False*, *include_python_functions=False*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L793)
...
preset_metadata_json(*key*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L851)
...
set_custom_trace_id_callback(*callback*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L1532)

Set the trace ID generator. Called at the start of each cycle, so updating
it between cycles yields distinct IDs per cycle.

step()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L1443)

Signals the profiler that the next profiling step has started.

take_pending_cuspy_export()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L735)
...
toggle_collection_dynamic(*enable*, *activities*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L757)
...
wait_for_exports()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L726)
...
*class*torch.profiler.ProfilerAction(*value*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L949)
...
*class*torch.profiler.CuspyConfig(*enable_cuda_sync_events=False*, *enable_environment_counters=False*, *enable_graph_dependencies=False*, *enable_event_node_ids=False*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L138)
...
- **enable_cuda_sync_events** ([*bool*](https://docs.python.org/3/library/functions.html#bool)*,**optional*) - Collect CUDA synchronization
activities.
- **enable_environment_counters** ([*bool*](https://docs.python.org/3/library/functions.html#bool)*,**optional*) - Collect GPU environment
counters.
- **enable_graph_dependencies** ([*bool*](https://docs.python.org/3/library/functions.html#bool)*,**optional*) - Record CUDA graph
dependency edges.
- **enable_event_node_ids** ([*bool*](https://docs.python.org/3/library/functions.html#bool)*,**optional*) - Associate CUDA events with CUDA
graph event-record nodes.

*class*torch.profiler.ProfilerActivityConfig(*activity_types=None*, *profiler_configs=<factory>*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L200)

Configure collection for an activity group.

Parameters:

- **activity_types** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]**,**optional*) - Fine-grained activity types to
collect. `None` collects the group's default activity types,
while an empty list collects none.
- **profiler_configs** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)) - Additional profiler configurations associated
with this activity group, such as `PerformanceMetricsConfig`
and `CuspyConfig`.

*class*torch.profiler.PerformanceMetricsConfig(*metric_names*, *sampling_interval_ms=None*, *lookback_window_ms=None*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/profiler.py#L165)
...
- **metric_names** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) - Backend-specific hardware metric names to collect.
- **sampling_interval_ms** ([*float*](https://docs.python.org/3/library/functions.html#float)*,**optional*) - CUDA PM-sampling interval in
milliseconds. Defaults to 1 millisecond.
- **lookback_window_ms** ([*float*](https://docs.python.org/3/library/functions.html#float)*,**optional*) - CUDA PM-sampling look-back window
...
torch.profiler.itt.is_available()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/itt.py#L31)

Check if ITT feature is available or not

torch.profiler.itt.mark(*msg*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/itt.py#L57)
...
torch.profiler.itt.range_push(*msg*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/itt.py#L38)
...
torch.profiler.itt.range_pop()[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/itt.py#L49)

Pops a range off of a stack of nested range spans. Returns the
zero-based depth of the range that is ended.

torch.profiler.itt.range(*msg*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/84e524623ea4754a748936bf1ba6ecaaa92c3ae6/torch/profiler/itt.py#L67)
