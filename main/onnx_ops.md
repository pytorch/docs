...
torch.onnx.ops.symbolic(*domain_op*, */*, *inputs*, *attrs=None*, ***, *dtype*, *shape*, *version=None*, *metadata_props=None*)[[source]](https://github.com/pytorch/pytorch/blob/7e49a76253edc1ab706e08750fcdacd6cfc5e114/torch/onnx/ops/__init__.py#L73)
...
torch.onnx.ops.symbolic_multi_out(*domain_op*, */*, *inputs*, *attrs=None*, ***, *dtypes*, *shapes*, *version=None*, *metadata_props=None*)[[source]](https://github.com/pytorch/pytorch/blob/7e49a76253edc1ab706e08750fcdacd6cfc5e114/torch/onnx/ops/__init__.py#L174)
...
torch.onnx.ops.rotary_embedding(*X*, *cos_cache*, *sin_cache*, *position_ids=None*, ***, *interleaved=False*, *num_heads=0*, *rotary_embedding_dim=0*)[[source]](https://github.com/pytorch/pytorch/blob/7e49a76253edc1ab706e08750fcdacd6cfc5e114/torch/onnx/ops/__init__.py#L282)
...
torch.onnx.ops.attention(*Q*, *K*, *V*, *attn_mask=None*, *past_key=None*, *past_value=None*, ***, *is_causal=False*, *kv_num_heads=0*, *q_num_heads=0*, *qk_matmul_output_mode=0*, *scale=None*, *softcap=0.0*, *softmax_precision=None*)[[source]](https://github.com/pytorch/pytorch/blob/7e49a76253edc1ab706e08750fcdacd6cfc5e114/torch/onnx/ops/__init__.py#L348)
...
torch.onnx.ops.aten_decompositions()[[source]](https://github.com/pytorch/pytorch/blob/7e49a76253edc1ab706e08750fcdacd6cfc5e114/torch/onnx/ops/__init__.py#L57)
