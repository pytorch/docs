...
*class*torch.distributed.algorithms.Join(*joinables*, *enable=True*, *throw_on_early_termination=False*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L104)
...
order.
- **enable** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - a flag enabling uneven input detection; setting to
...
(default: `True`).
- **throw_on_early_termination** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - a flag controlling whether to throw an
...
*static*notify_join_context(*joinable*)[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L298)
...
*class*torch.distributed.algorithms.Joinable[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L44)
...
*abstract*join_hook(***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L60)
...
*class*torch.distributed.algorithms.JoinHook[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L14)
...
main_hook()[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L26)
...
post_hook(*is_last_joiner*)[[source]](https://github.com/pytorch/pytorch/blob/80b7a2174586f92cc0af6a820a4c98e73b6fca58/torch/distributed/algorithms/join.py#L32)
...
**is_last_joiner** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - `True` if the rank is one of the last to
