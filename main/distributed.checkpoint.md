...
torch.distributed.checkpoint.optimizer.load_sharded_optimizer_state_dict(*model_state_dict*, *optimizer_key*, *storage_reader*, *planner=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/optimizer.py#L218)
...
torch.distributed.checkpoint.planner_helpers.create_read_items_for_chunk_list(*fqn*, *checkpoint_md*, *local_chunks*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner_helpers.py#L281)
...
torch.distributed.checkpoint.default_planner.create_default_global_load_plan(*all_plans*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L525)
...
torch.distributed.checkpoint.default_planner.create_default_global_save_plan(*all_plans*, *rewrite_index_hints=True*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L564)
...
torch.distributed.checkpoint.default_planner.create_default_local_save_plan(*state_dict*, *is_coordinator*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L537)
...
*class*torch.distributed.checkpoint.state_dict_saver.AsyncCheckpointerType(*value*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_saver.py#L52)

Enum for async checkpointer type.

*class*torch.distributed.checkpoint.state_dict_saver.AsyncSaveResponse(*staging_completion*, *upload_completion*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_saver.py#L206)
...
torch.distributed.checkpoint.state_dict_saver.save(*state_dict*, ***, *checkpoint_id=None*, *storage_writer=None*, *planner=None*, *process_group=None*, *no_dist=False*, *use_collectives=True*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_saver.py#L87)
...
torch.distributed.checkpoint.state_dict_saver.async_save(*state_dict*, ***, *checkpoint_id=None*, *storage_writer=None*, *planner=None*, *process_group=None*, *async_checkpointer_type=AsyncCheckpointerType.THREAD*, *async_stager=None*, *no_dist=False*, *use_collectives=True*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_saver.py#L220)
...
torch.distributed.checkpoint.state_dict_saver.save_state_dict(*state_dict*, *storage_writer*, *process_group=None*, *coordinator_rank=0*, *no_dist=False*, *planner=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_saver.py#L59)
...
torch.distributed.checkpoint.state_dict_loader.load(*state_dict*, ***, *checkpoint_id=None*, *storage_reader=None*, *planner=None*, *process_group=None*, *no_dist=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_loader.py#L58)
...
torch.distributed.checkpoint.state_dict_loader.load_state_dict(*state_dict*, *storage_reader*, *process_group=None*, *coordinator_rank=0*, *no_dist=False*, *planner=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict_loader.py#L31)
...
*class*torch.distributed.checkpoint.staging.AsyncStager(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L39)
...
close()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L99)
...
stage(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L77)
...
synchronize_staging()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L88)
...
*class*torch.distributed.checkpoint.staging.DefaultStager(*config=StagingOptions(use_pinned_memory=True, use_shared_memory=True, use_async_staging=True, use_non_blocking_copy=True)*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L133)
...
close()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L246)
...
stage(*state_dict*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L196)
...
synchronize_staging()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L264)
...
*class*torch.distributed.checkpoint.staging.StagingOptions(*use_pinned_memory=True*, *use_shared_memory=True*, *use_async_staging=True*, *use_non_blocking_copy=True*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L105)
...
*class*torch.distributed.checkpoint.staging.BlockingAsyncStager(*cache_staged_state_dict=False*, *type_check=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L273)
...
stage(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L305)
...
synchronize_staging()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/staging.py#L319)
...
*class*torch.distributed.checkpoint.stateful.Stateful(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/stateful.py#L8)

Stateful protocol for objects that can be checkpointed and restored.

load_state_dict(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/stateful.py#L31)
...
state_dict()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/stateful.py#L14)
...
*class*torch.distributed.checkpoint.StorageReader[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L168)
...
*abstract*prepare_global_plan(*plans*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L242)
...
*abstract*prepare_local_plan(*plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L227)
...
*abstract*read_data(*plan*, *planner*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L259)
...
*abstract*read_metadata(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L204)
...
*abstract*reset(*checkpoint_id=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L186)
...
*abstract*set_up_storage_reader(*metadata*, *is_coordinator*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L214)
...
*abstract classmethod*validate_checkpoint_id(*checkpoint_id*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L281)
...
*class*torch.distributed.checkpoint.StorageWriter[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L27)
...
*abstract*finish(*metadata*, *results*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L131)
...
*abstract*prepare_global_plan(*plans*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L90)
...
*abstract*prepare_local_plan(*plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L75)
...
*abstract*reset(*checkpoint_id=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L45)
...
*abstract*set_up_storage_writer(*is_coordinator*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L63)
...
storage_meta()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L157)
...
*abstract classmethod*validate_checkpoint_id(*checkpoint_id*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L148)
...
*abstract*write_data(*plan*, *planner*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/storage.py#L107)
...
*class*torch.distributed.checkpoint.metadata.StorageMeta(*checkpoint_id: str | os.PathLike | None = None*, *save_id: str | None = None*, *load_id: str | None = None*, *modules: list[str] = <factory>*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/metadata.py#L145)

*class*torch.distributed.checkpoint.metadata.TensorProperties(*dtype=<factory>*, *layout=torch.strided*, *requires_grad=False*, *memory_format=torch.contiguous_format*, *pin_memory=False*, *strides=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/metadata.py#L42)

Properties used to create `Tensor`

*class*torch.distributed.checkpoint.metadata.TensorStorageMetadata(*properties: torch.distributed.checkpoint.metadata.TensorProperties*, *size: [torch.Size](size.html#torch.Size)*, *chunks: [list](https://docs.python.org/3/library/stdtypes.html#list)[torch.distributed.checkpoint.metadata.ChunkStorageMetadata]*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/metadata.py#L129)

The following types define the planner interface used during checkpoint:

*class*torch.distributed.checkpoint.LoadPlanner[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L304)
...
*abstract*commit_tensor(*read_item*, *tensor*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L440)
...
*abstract*create_global_plan(*global_plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L399)
...
*abstract*create_local_plan()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L391)
...
*abstract*finish_plan(*central_plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L407)
...
*abstract*load_bytes(*read_item*, *value*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L411)
...
resolve_bytes(*read_item*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L422)
...
*abstract*resolve_tensor(*read_item*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L430)
...
*abstract*set_up_planner(*state_dict*, *metadata=None*, *is_coordinator=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L378)

Initialize this instance to load data into `state_dict`.

. N.B. This is called on every rank.

*class*torch.distributed.checkpoint.LoadPlan(*items: [list](https://docs.python.org/3/library/stdtypes.html#list)[torch.distributed.checkpoint.planner.ReadItem]*, *storage_data: Any = None*, *planner_data: Any = None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L114)

*class*torch.distributed.checkpoint.ReadItem(*type: torch.distributed.checkpoint.planner.LoadItemType*, *dest_index: torch.distributed.checkpoint.metadata.MetadataIndex*, *dest_offsets: [torch.Size](size.html#torch.Size)*, *storage_index: torch.distributed.checkpoint.metadata.MetadataIndex*, *storage_offsets: [torch.Size](size.html#torch.Size)*, *lengths: [torch.Size](size.html#torch.Size)*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L85)

*class*torch.distributed.checkpoint.SavePlanner[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L121)
...
*abstract*create_global_plan(*all_plans*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L265)
...
*abstract*create_local_plan()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L254)
...
*abstract*finish_plan(*new_plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L275)
...
*abstract*resolve_data(*write_item*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L283)
...
*abstract*set_up_planner(*state_dict*, *storage_meta=None*, *is_coordinator=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L239)
...
*class*torch.distributed.checkpoint.SavePlan(*items: [list](https://docs.python.org/3/library/stdtypes.html#list)[torch.distributed.checkpoint.planner.WriteItem]*, *storage_data: Any = None*, *planner_data: Any = None*, *usable: [bool](https://docs.python.org/3/library/functions.html#bool) = True*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L104)

*class*torch.distributed.checkpoint.planner.WriteItem(*index*, *type*, *bytes_io_data=None*, *tensor_data=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L57)

Dataclass which holds information about what needs to be written to storage.

tensor_storage_size()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L70)
...
*class*torch.distributed.checkpoint.planner.BytesIOWriteData(*nbytes: [int](https://docs.python.org/3/library/functions.html#int)*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L45)

*class*torch.distributed.checkpoint.planner.TensorWriteData(*chunk: torch.distributed.checkpoint.metadata.ChunkStorageMetadata*, *properties: torch.distributed.checkpoint.metadata.TensorProperties*, *size: [torch.Size](size.html#torch.Size)*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/planner.py#L50)

We provide a filesystem based storage layer:

*class*torch.distributed.checkpoint.filesystem.FileSystemBase[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L485)

*class*torch.distributed.checkpoint.filesystem.FileSystem[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L517)

*class*torch.distributed.checkpoint.filesystem.SerializationFormat(*value*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L92)

An enumeration.

*class*torch.distributed.checkpoint.FileSystemReader(*path*, *_extension_registry=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L845)
...
*class*torch.distributed.checkpoint.FileSystemWriter(*path*, *single_file_per_rank=True*, *sync_files=True*, *thread_count=1*, *per_thread_copy_ahead=10000000*, *cache_staged_state_dict=False*, *overwrite=True*, *_extensions=None*, *serialization_format=SerializationFormat.TORCH_SAVE*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L973)
...
stage(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/filesystem.py#L1033)
...
*class*torch.distributed.checkpoint.DefaultSavePlanner(*flatten_state_dict=True*, *flatten_sharded_tensors=True*, *dedup_replicated_tensors=None*, *dedup_save_to_lowest_rank=False*, *enable_plan_caching=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L71)

lookup_object(*index*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L279)
...
transform_object(*write_item*, *object*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L283)

Extension from the planner interface to make it easy to extend the default planner.

*class*torch.distributed.checkpoint.DefaultLoadPlanner(*flatten_state_dict=True*, *flatten_sharded_tensors=True*, *allow_partial_load=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L292)
...
lookup_tensor(*index*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L402)
...
transform_tensor(*read_item*, *tensor*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/default_planner.py#L406)
...
torch.distributed.checkpoint.state_dict.get_state_dict(*model*, *optimizers*, ***, *submodules=None*, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1271)
...
torch.distributed.checkpoint.state_dict.get_model_state_dict(*model*, ***, *submodules=None*, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1189)
...
torch.distributed.checkpoint.state_dict.get_optimizer_state_dict(*model*, *optimizers*, ***, *submodules=None*, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1226)
...
torch.distributed.checkpoint.state_dict.set_state_dict(*model*, *optimizers*, ***, *model_state_dict*, *optim_state_dict*, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1481)
...
torch.distributed.checkpoint.state_dict.set_model_state_dict(*model*, *model_state_dict*, ***, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1399)
...
torch.distributed.checkpoint.state_dict.set_optimizer_state_dict(*model*, *optimizers*, *optim_state_dict*, ***, *options=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L1438)
...
*class*torch.distributed.checkpoint.state_dict.StateDictOptions(*full_state_dict=False*, *cpu_offload=False*, *ignore_frozen_params=False*, *keep_submodule_prefixes=True*, *strict=True*, *broadcast_from_rank0=False*, *flatten_optimizer_state_dict=False*, *dsd_fqn_modifiers='_fqn_modifiers'*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/state_dict.py#L93)
...
torch.distributed.checkpoint.format_utils.dcp_to_torch_save(*dcp_checkpoint_dir*, *torch_save_path*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L208)
...
torch.distributed.checkpoint.format_utils.torch_save_to_dcp(*torch_save_path*, *dcp_checkpoint_dir*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L233)
...
*class*torch.distributed.checkpoint.format_utils.BroadcastingTorchSaveReader(*checkpoint_id=None*, *coordinator_rank=0*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L39)
...
prepare_global_plan(*global_plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L148)
...
prepare_local_plan(*plan*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L144)
...
read_data(*plan*, *planner*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L74)
...
read_metadata()[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L68)
...
reset(*checkpoint_id=None*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L152)

Implementation of the StorageReader method

set_up_storage_reader(*metadata*, *is_coordinator*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L129)

Implementation of the StorageReader method

*classmethod*validate_checkpoint_id(*checkpoint_id*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L156)
...
*class*torch.distributed.checkpoint.format_utils.DynamicMetaLoadPlanner(*flatten_state_dict=True*, *flatten_sharded_tensors=True*, *allow_partial_load=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L162)
...
set_up_planner(*state_dict*, *metadata=None*, *is_coordinator=False*)[[source]](https://github.com/pytorch/pytorch/blob/11cc3f2c2feafe59bf1d7f19c46edaa02b3eac25/torch/distributed/checkpoint/format_utils.py#L183)
