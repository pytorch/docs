...
*class*torch.utils.tensorboard.writer.SummaryWriter(*log_dir=None*, *comment=''*, *purge_step=None*, *max_queue=10*, *flush_secs=120*, *filename_suffix=''*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L173)
...
__init__(*log_dir=None*, *comment=''*, *purge_step=None*, *max_queue=10*, *flush_secs=120*, *filename_suffix=''*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L183)
...
add_scalar(*tag*, *scalar_value*, *global_step=None*, *walltime=None*, *new_style=False*, *double_precision=False*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L347)
...
add_scalars(*main_tag*, *tag_scalar_dict*, *global_step=None*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L388)
...
add_histogram(*tag*, *values*, *global_step=None*, *bins='tensorflow'*, *walltime=None*, *max_bins=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L465)
...
add_image(*tag*, *img_tensor*, *global_step=None*, *walltime=None*, *dataformats='CHW'*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L583)
...
add_images(*tag*, *img_tensor*, *global_step=None*, *walltime=None*, *dataformats='NCHW'*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L634)
...
add_figure(*tag*, *figure*, *global_step=None*, *close=True*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L729)
...
add_video(*tag*, *vid_tensor*, *global_step=None*, *fps=4*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L767)
...
add_audio(*tag*, *snd_tensor*, *global_step=None*, *sample_rate=44100*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L787)
...
add_text(*tag*, *text_string*, *global_step=None*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L807)
...
add_graph(*model*, *input_to_model=None*, *verbose=False*, *use_strict_trace=True*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L830)
...
add_embedding(*mat*, *metadata=None*, *label_img=None*, *global_step=None*, *tag='default'*, *metadata_header=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L859)
...
add_pr_curve(*tag*, *labels*, *predictions*, *global_step=None*, *num_thresholds=127*, *weights=None*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L964)
...
add_custom_scalars(*layout*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L1101)
...
add_mesh(*tag*, *vertices*, *colors=None*, *faces=None*, *config_dict=None*, *global_step=None*, *walltime=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L1125)
...
add_hparams(*hparam_dict*, *metric_dict*, *hparam_domain_discrete=None*, *run_name=None*, *global_step=None*)[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L292)
...
flush()[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L1192)
...
close()[[source]](https://github.com/pytorch/pytorch/blob/4ff2d1161191378e895e560774c1622dba40076d/torch/utils/tensorboard/writer.py#L1203)