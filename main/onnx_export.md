...
apply_weights(*state_dict*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L391)
...
call_reference(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L263)
...
compute_values(*value_names*, *args=()*, *kwargs=None*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L279)
...
initialize_inference_session(*initializer=<function _ort_session_initializer>*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L413)
...
optimize()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L316)
...
release()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L443)

Release the inference session.

You may call this method to release the resources used by the inference session.

rename_axes(*rename_mapping*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L456)
...
save(*destination*, ***, *include_initializers=True*, *keep_initializers_as_inputs=False*, *external_data=None*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_onnx_program.py#L324)
...
dynamic_shapes()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_exportable_module.py#L85)
...
*abstract*example_arguments()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_exportable_module.py#L55)
...
input_names()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_exportable_module.py#L119)
...
output_names()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_exportable_module.py#L146)
...
to_onnx(***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_exportable_module.py#L173)
...
torch.onnx.is_in_onnx_export()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/__init__.py#L356)
...
check_discrepancies(*onnx_program*, *atol=0.0001*, *rtol=0.1*, *progress_bar=False*, *initializer=<function _ort_session_initializer>*, *skip_none=True*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_input_observer.py#L1102)
...
infer_arguments(*index_or_args_or_kwargs=None*, *flat=False*, *as_args_kwargs=False*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_input_observer.py#L1024)
...
infer_dynamic_shapes(*set_batch_dimension_for=None*)[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_input_observer.py#L1000)
...
num_obs()[[source]](https://github.com/pytorch/pytorch/blob/de1ad93d5279bade131efce3de7f798aef4faa3d/torch/onnx/_internal/exporter/_input_observer.py#L925)
