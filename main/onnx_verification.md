...
torch.onnx.verification.verify_onnx_program(*onnx_program*, *args=None*, *kwargs=None*, *compare_intermediates=False*)[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/onnx/_internal/exporter/_verification.py#L148)
...
asdict()[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/onnx/_internal/exporter/_verification.py#L100)
...
*classmethod*from_tensors(*name*, *expected*, *actual*)[[source]](https://github.com/pytorch/pytorch/blob/df83f06a8c49a667b9408934fa9eaae1aaf32d04/torch/onnx/_internal/exporter/_verification.py#L59)
