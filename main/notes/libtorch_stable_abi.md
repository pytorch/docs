...
| std::vector/torch::headeronly::HeaderOnlyArrayRef | raw bitwise copy into leading bytes of uint64_t of pointer to a new StableIValue pointing to a list of StableIValues recursively representing the underlying elements. | c10::List<T> | Type[] |
| ? | ? | ivalue::Tuple<T> | (Type, ...) |
| ? | ? | c10::SymInt | SymInt |
