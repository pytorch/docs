...
[`torch.bmm()`](../generated/torch.bmm.html#torch.bmm). It is possible to implement batched computation as a loop over batch
...
consider normalizing or clamping extremal inputs and using [`torch.isfinite()`](../generated/torch.isfinite.html#torch.isfinite) to detect
them.
...
Consider using [`torch.isfinite()`](../generated/torch.isfinite.html#torch.isfinite) before calling these functions to detect this
situation.

### Extremal values in linalg

Functions within `torch.linalg` have more extremal values than
other PyTorch functions.

[linalg solvers](../linalg.html#linalg-solvers) and [linalg inverses](../linalg.html#linalg-inverses) assume
...
[`torch.linalg.svdvals()`](../generated/torch.linalg.svdvals.html#torch.linalg.svdvals) or their condition number via [`torch.linalg.cond()`](../generated/torch.linalg.cond.html#torch.linalg.cond) may
