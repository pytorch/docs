...
[`torch.bmm()`](../generated/torch.bmm.html#torch.bmm). It is possible to implement batched computation as a loop over batch elements,
...
inputs and using [`torch.isfinite()`](../generated/torch.isfinite.html#torch.isfinite) to detect them.
...
Analyzing the spectrum of the inputs via [`torch.linalg.svdvals()`](../generated/torch.linalg.svdvals.html#torch.linalg.svdvals) or their condition number via [`torch.linalg.cond()`](../generated/torch.linalg.cond.html#torch.linalg.cond)
