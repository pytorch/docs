...
*class*torch.nn.attention.flex_attention.AuxOutput(*lse=None*, *max_scores=None*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L250)

Auxiliary outputs from flex_attention operation.

Fields will be None if not requested, or contain the tensor if requested.

*class*torch.nn.attention.flex_attention.AuxRequest(*lse=False*, *max_scores=False*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L240)
...
torch.nn.attention.flex_attention.create_block_mask(*mask_mod*, *B*, *H*, *Q_LEN*, *KV_LEN*, *device=None*, *BLOCK_SIZE=128*, *_compile=False*, *separate_full_blocks=True*, *compute_dq_write_order=False*, *dq_kv_order=True*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1924)
...
torch.nn.attention.flex_attention.create_mask(*mod_fn*, *B*, *H*, *Q_LEN*, *KV_LEN*, *device=None*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1785)
...
torch.nn.attention.flex_attention.and_masks(**mask_mods*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1730)
...
torch.nn.attention.flex_attention.or_masks(**mask_mods*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1716)
...
torch.nn.attention.flex_attention.noop_mask(*batch*, *head*, *token_q*, *token_kv*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L364)
...
*class*torch.nn.attention.flex_attention.FlexKernelOptions[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L101)
...
*classmethod*from_kv_blocks(*kv_num_blocks*, *kv_indices*, *full_kv_num_blocks=None*, *full_kv_indices=None*, *BLOCK_SIZE=128*, *mask_mod=None*, *seq_lengths=None*, *compute_q_blocks=True*, ***, *dq_write_order=None*, *dq_write_order_full=None*, *dq_kv_order=None*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1018)
...
numel()[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1394)
...
sparsity()[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1403)
...
to(*device*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1497)
...
to_dense()[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1416)
...
to_string(*grid_size=(20, 20)*, *limit=4*)[[source]](https://github.com/pytorch/pytorch/blob/dea5f568512cef2ab009ee7858b1cfd9be8ba924/torch/nn/attention/flex_attention.py#L1432)
