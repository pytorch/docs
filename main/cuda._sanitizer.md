...
torch.cuda._sanitizer.enable_cuda_sanitizer()[[source]](https://github.com/pytorch/pytorch/blob/6a231d0d3e1ccd63dd51479bcadc969d0a8de2b9/torch/cuda/_sanitizer.py#L659)
...
torch.cuda._sanitizer.zip_arguments(*schema*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/6a231d0d3e1ccd63dd51479bcadc969d0a8de2b9/torch/cuda/_sanitizer.py#L474)
...
torch.cuda._sanitizer.zip_by_key(*a*, *b*)[[source]](https://github.com/pytorch/pytorch/blob/6a231d0d3e1ccd63dd51479bcadc969d0a8de2b9/torch/cuda/_sanitizer.py#L468)

Return type:

[*Iterator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterator)[[tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[*TK*, *TVa*, *TVb*]]