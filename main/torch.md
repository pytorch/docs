...
torch.serialization.check_module_version_greater_or_equal(*module*, *req_version_tuple*, *error_if_malformed=True*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/serialization.py#L490)
...
torch.serialization.default_restore_location(*storage*, *location*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/serialization.py#L714)
...
- **location** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - the location tag associated with the storage object
...
[**RuntimeError**](https://docs.python.org/3/builtins/exceptions.html#RuntimeError) - If no deserializer matching location is found in the registry or if
...
You can find our foreach APIs at [`torch.foreach`](foreach.html#module-torch.foreach). While the private
...
*class*torch.SymInt(*node*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L816)

Like an int (including magic methods), but redirects all operations on the
wrapped node. This is used in particular to symbolically record operations
in the symbolic shape workflow.

as_integer_ratio()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L945)

Represent this int as an exact integer ratio

Return type:

[tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[SymInt, [int](https://docs.python.org/3/builtins/functions.html#int)]

*class*torch.SymFloat(*node*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L971)

Like a float (including magic methods), but redirects all operations on the
wrapped node. This is used in particular to symbolically record operations
in the symbolic shape workflow.

as_integer_ratio()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L1047)
...
conjugate()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L1060)
...
hex()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L1064)
...
is_integer()[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L1043)
...
*class*torch.SymBool(*node*)[[source]](https://github.com/pytorch/pytorch/blob/65c295bfa29161891e39b83fac63c4f5417ffdc2/torch/__init__.py#L1080)
