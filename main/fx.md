...
torch.fx.symbolic_trace(*root*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L1360)
...
- **concrete_args** (*Optional**[**Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**any**]**]*) - Inputs to be partially specialized
...
torch.fx.wrap(*fn_or_name: _F*) → _F[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L1291)
...
**fn_or_name** (*Union**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**Callable**]*) - The function or name of the global function to insert into the
...
*class*torch.fx.GraphModule(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L512)
...
__init__(*root*, *graph*, *class_name='GraphModule'*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L546)

Construct a GraphModule.

Parameters:

- **root** (*Union**[*[*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*,**Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**Any**]*) - `root` can either be an nn.Module instance or a Dict mapping strings to any attribute type.
...
- **class_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - `name` denotes the name of this GraphModule for debugging purposes. If it's unset, all
...
add_submodule(*target*, *m*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L769)
...
- **target** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The fully-qualified string name of the new submodule
...
delete_all_unused_submodules()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L851)
...
delete_submodule(*target*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L809)
...
print_readable(*print_output=True*, *include_stride=False*, *include_device=False*, *colored=False*, ***, *fast_sympy_print=False*, *expanded_def=False*, *additional_meta=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L1119)

Return the Python code generated for current GraphModule and its children GraphModules.

Parameters:

**additional_meta** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]**|**None*) - Optional list of meta keys to include in the output.
...
recompile()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L919)
...
to_folder(*folder*, *module_name='FxModule'*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph_module.py#L684)
...
*class*torch.fx.Graph(*owning_module=None*, *tracer_cls=None*, *tracer_extras=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1394)
...
__init__(*owning_module=None*, *tracer_cls=None*, *tracer_extras=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1443)
...
call_function(*the_function*, *args=None*, *kwargs=None*, *type_expr=None*, *name=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1956)
...
- **kwargs** (*Optional**[**Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**Argument**]**]*) - The keyword arguments to be passed
to the called function
- **type_expr** (*Optional**[**Any**]*) - an optional type annotation representing the
Python type the output of this node will have.
- **name** (*Optional**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) - The name of the node. If not specified, set to None
...
call_method(*method_name*, *args=None*, *kwargs=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1917)
...
- **method_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The name of the method to apply to the self argument.
...
call_module(*module_name*, *args=None*, *kwargs=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1864)
...
- **module_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The qualified name of the `Module` in the `Module`
...
create_node(*op*, *target*, *args=None*, *kwargs=None*, *name=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1582)
...
- **op** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - the opcode for this Node. One of 'call_function', 'call_method', 'get_attr',
'call_module', 'placeholder', or 'output'. The semantics of these opcodes are
described in the `Graph` docstring.
- **args** (*Optional**[**Tuple**[**Argument**,**...**]**]*) - is a tuple of arguments to this node.
- **kwargs** (*Optional**[**Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**Argument**]**]*) - the kwargs of this Node
- **name** (*Optional**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]*) - an optional string name for the `Node`.
...
create_size_node(*tensor_node*, *dim*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2015)
...
create_storage_offset_node(*tensor_node*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2033)
...
create_stride_node(*tensor_node*, *dim*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2024)
...
eliminate_dead_code(*is_impure_node=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2687)
...
- **is_impure_node** (*Optional**[**Callable**[**[**Node**]**,*[*bool*](https://docs.python.org/3/library/functions.html#bool)*]**]*) - A function that returns
...
erase_node(*to_erase*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1672)
...
find_nodes(***, *op*, *target=None*, *sort=True*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1495)

Allows for fast query of nodes

Parameters:

- **op** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - the name of the operation
...
- **sort** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - whether to return nodes in the order they appear on
on the graph.
...
get_attr(*qualified_name*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1796)
...
- **qualified_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - the fully-qualified name of the attribute to be retrieved.
...
graph_copy(*g*, *val_map*, *return_output_node=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1522)
...
inserting_before(*n=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1713)
...
lint()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2607)
...
materialize_symint(*value*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2378)
...
materialize_symints(*values*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2107)
...
node_copy(*node*, *arg_transform=<function Graph.<lambda>>*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2383)
...
on_generate_code(*make_transformer*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2780)
...
output(*result*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2420)
...
output_node()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1488)
...
placeholder(*name*, *type_expr=None*, *default_value*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1763)
...
- **name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - A name for the input value. This corresponds to the name
...
print_tabular()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2585)
...
process_inputs(**args*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1661)
...
process_outputs(*out*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L1668)
...
python_code(*root_module*, ***, *verbose=False*, *include_stride=False*, *include_device=False*, *colored=False*, *expanded_def=False*, *record_func=False*, *additional_meta=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2458)

Turn this `Graph` into valid Python code.

Parameters:

**root_module** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The name of the root module on which to look-up
...
set_codegen(*codegen*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/graph.py#L2776)

Warning

This API is experimental and is *NOT* backward-compatible.

*class*torch.fx.Node(*graph*, *name*, *op*, *target*, *args*, *kwargs*, *return_type=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L257)
...
*property*all_input_nodes*: [list](https://docs.python.org/3/library/stdtypes.html#list)[Node]*
...
append(*x*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L440)
...
format_node(*placeholder_names=None*, *maybe_return_typename=None*, ***, *include_tensor_metadata=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L615)
...
- **placeholder_names** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]**|**None*) - A list that will store formatted strings
representing the placeholders in the generated
`forward` function. Internal use only.
- **maybe_return_typename** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*]**|**None*) - A single-element list that will store
a formatted string representing the output of the
generated `forward` function. Internal use only.
- **include_tensor_metadata** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - Whether to include tensor metadata
...
insert_arg(*idx*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L527)

Insert a positional argument to the argument list with given index.

Parameters:

- **idx** ([*int*](https://docs.python.org/3/library/functions.html#int)) - The index of the element in `self.args` to be inserted before.
...
is_impure(*impure_random=True*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L759)
...
**impure_random** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - Whether to treat rand op as impure.
...
normalized_arguments(*root*, *arg_types=None*, *kwarg_types=None*, *normalize_to_only_use_kwargs=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L810)
...
prepend(*x*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L424)
...
replace_all_uses_with(*replace_with*, *delete_user_cb=None*, ***, *propagate_meta=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L712)
...
- **propagate_meta** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - Whether or not to copy all properties
...
[list](https://docs.python.org/3/library/stdtypes.html#list)[Node]

Note

Backwards-compatibility for this API is guaranteed.

replace_input_with(*old_input*, *new_input*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L868)
...
*property*stack_trace*: [str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*
...
update_arg(*idx*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L512)
...
- **idx** ([*int*](https://docs.python.org/3/library/functions.html#int)) - The index into `self.args` of the element to update
...
update_kwarg(*key*, *arg*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/node.py#L554)
...
- **key** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The key in `self.kwargs` of the element to update
...
*class*torch.fx.Tracer(*autowrap_modules=(math,)*, *autowrap_functions=()*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L262)
...
call_module(*m*, *forward*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L528)
...
create_arg(*a*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L372)
...
create_args_for_root(*root_fn*, *is_module*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L657)
...
create_node(*kind*, *target*, *args*, *kwargs*, *name=None*, *type_expr=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L214)
...
create_proxy(*kind*, *target*, *args*, *kwargs*, *name=None*, *type_expr=None*, *proxy_factory_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L339)
...
get_fresh_qualname(*prefix*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L346)
...
getattr(*attr*, *attr_val*, *parameter_proxy_cache*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L588)
...
- **attr** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The name of the attribute being queried
- **attr_val** (*Any*) - The value of the attribute
- **parameter_proxy_cache** (*Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**Any**]*) - A cache of attr names to proxies
...
is_leaf_module(*m*, *module_qualified_name*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L475)
...
- **module_qualified_name** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The path to root of this module. For example,
...
iter(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L496)
...
keys(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L514)
...
path_of_module(*mod*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L500)
...
**mod** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) - The `Module` to retrieve the qualified name for.
...
proxy(*node*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L335)
...
to_bool(*obj*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L485)
...
trace(*root*, *concrete_args=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/_symbolic_trace.py#L768)
...
guaranteed.
- **concrete_args** (*Optional**[**Dict**[*[*str*](https://docs.python.org/3/library/stdtypes.html#str)*,**any**]**]*) - Concrete arguments that should
...
*class*torch.fx.Proxy(*node*, *tracer=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/proxy.py#L599)
...
*class*torch.fx.Interpreter(*module*, *garbage_collect_values=True*, *graph=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L51)
...
- **garbage_collect_values** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) - Whether to delete values after their last
...
boxed_run(*args_list*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L239)
...
call_function(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L356)
...
call_method(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L379)
...
call_module(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L404)
...
fetch_args_kwargs_from_env(*n*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L472)
...
fetch_attr(*target*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L451)
...
get_attr(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L334)
...
map_nodes_to_values(*args*, *n*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L494)
...
output(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L430)
...
placeholder(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L297)
...
run(**args*, *initial_env=None*, *enable_io_processing=True*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L147)
...
run_node(*n*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L273)
...
*class*torch.fx.Transformer(*module*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L517)
...
call_function(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L640)
...
call_module(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L630)
...
get_attr(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L610)
...
placeholder(*target*, *args*, *kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L587)
...
transform()[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/interpreter.py#L647)
...
torch.fx.replace_pattern(*gm*, *pattern*, *replacement*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/subgraph_rewriter.py#L95)
...
torch.fx.traceback.annotate(*annotation_dict*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/traceback.py#L311)
...
torch.fx.passes.tools_common.stable_topological_sort(*gm*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/tools_common.py#L333)
...
torch.fx.passes.graph_manipulation.get_size_of_all_nodes(*fx_module*, *args=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/graph_manipulation.py#L56)
...
torch.fx.passes.graph_manipulation.get_size_of_node(*fx_module*, *node*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/graph_manipulation.py#L87)
...
torch.fx.passes.param_fetch.default_matching(*name*, *target_version*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/param_fetch.py#L18)
...
torch.fx.passes.param_fetch.extract_attrs_for_lowering(*mod*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/param_fetch.py#L58)
...
torch.fx.passes.param_fetch.lift_lowering_attrs_to_nodes(*fx_module*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/param_fetch.py#L85)
...
torch.fx.passes.split_utils.split_by_tags(*gm*, *tags*, *return_fqn_mapping=False*, *return_tuple=False*, *GraphModuleCls=<class 'torch.fx.graph_module.GraphModule'>*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/split_utils.py#L76)
...
torch.fx.passes.utils.common.lift_subgraph_as_module(*gm*, *subgraph*, *comp_name=''*, *class_name='GraphModule'*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/utils/common.py#L24)
...
torch.fx.passes.utils.fuser_utils.fuse_as_graphmodule(*gm*, *nodes*, *module_name*, *partition_lookup_table=None*, ***, *always_return_tuple=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/utils/fuser_utils.py#L97)
...
torch.fx.passes.utils.source_matcher_utils.get_source_partitions(*graph*, *wanted_sources*, *filter_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/utils/source_matcher_utils.py#L55)
...
torch.fx.passes.annotate_getitem_nodes.annotate_getitem_nodes(*graph*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/annotate_getitem_nodes.py#L7)
...
torch.fx.passes.split_utils.move_non_tensor_nodes_on_boundary(*subgraphs*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/split_utils.py#L346)
...
torch.fx.passes.splitter_base.generate_inputs_for_submodules(*model*, *inputs*, *target_submodules*, *deepcopy=False*)[[source]](https://github.com/pytorch/pytorch/blob/b251a9ea25c953bfac6da40dfc57f259e2b120ee/torch/fx/passes/splitter_base.py#L440)
