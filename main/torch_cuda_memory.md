...
torch.cuda.memory._record_memory_history(*enabled='all'*, *context='all'*, *stacks='all'*, *max_entries=9223372036854775807*, *device=None*, *clear_history=False*, *compile_context=False*, *global_record_annotations=False*, *skip_actions=None*, *record_pinned_host_memory=False*, *record_cuda=True*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/cuda/memory.py#L898)
...
param record_pinned_host_memory:

If True, also record memory history for
the CPU pinned memory (host) allocator. Host allocator traces will
appear in the `host_segments` and `host_traces` keys of the
snapshot returned by `_snapshot()`. Defaults to False.

type record_pinned_host_memory:

bool, optional

param record_cuda:

If True, record memory history for the
...
torch.cuda.memory._snapshot(*device=None*, *augment_with_fx_traces=False*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/cuda/memory.py#L1045)
...
torch.cuda.memory._dump_snapshot(*filename='dump_snapshot.pickle'*, *augment_with_fx_traces=False*)[[source]](https://github.com/pytorch/pytorch/blob/9d784735eb70fb8b0335b0ad7cad9db3ea4babbd/torch/cuda/memory.py#L1156)
...
- **filename** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**optional*) - Name of the file to create. Defaults to "dump_snapshot.pickle".
- **augment_with_fx_traces** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - If True, augment the snapshot with FX debug information
