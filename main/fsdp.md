...
[this issue](https://github.com/pytorch/pytorch/issues/77724).
...
- **module** ([*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - This is the module to be wrapped with FSDP.
...
(Default: `None`)
- **auto_wrap_policy** (*Optional**[**Union**[**Callable**[**[*[*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*,*[*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]**,*[*bool*](https://docs.python.org/3/builtins/functions.html#bool)*]**,**ModuleWrapPolicy**,**CustomPolicy**]**]*) -
...
- **ignored_modules** (*Optional**[**Iterable**[*[*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**]*) - Modules whose
...
FSDP. (Default: `None`)
- **param_init_fn** (*Optional**[**Callable**[**[*[*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**,**None**]**]*) -
...
initialization via torchdistX's ([pytorch/torchdistX](https://github.com/pytorch/torchdistX))
...
```
- **device_id** (*Optional**[**Union**[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*,*[*torch.device*](tensor_attributes.html#torch.device)*]**]*) - An `int` or
...
(Default: `None`)
- **sync_module_states** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then each FSDP module will
...
`False`)
- **forward_prefetch** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then FSDP *explicitly* prefetches
...
- **limit_all_gathers** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then FSDP explicitly
...
- **use_orig_params** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Setting this to `True` has FSDP use
...
- **ignored_states** (*Optional**[**Iterable**[**torch.nn.Parameter**]**]**,**Optional**[**Iterable**[*[*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**]*) - Ignored parameters or modules that will not be managed by this FSDP
...
- **device_mesh** (*Optional**[*[*DeviceMesh*](distributed.html#torch.distributed.device_mesh.DeviceMesh)*]*) - DeviceMesh can be used as an alternative to
...
apply(*fn*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L569)

Apply `fn` recursively to every submodule (as returned by `.children()`) as well as self.

Typical use includes initializing the parameters of a model (see also [torch.nn.init](nn.init.html#nn-init-doc)).
...
check_is_root()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L542)
...
clip_grad_norm_(*max_norm*, *norm_type=2.0*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1073)
...
- **max_norm** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*or*[*int*](https://docs.python.org/3/builtins/functions.html#int)) - max norm of the gradients
- **norm_type** ([*float*](https://docs.python.org/3/builtins/functions.html#float)*or*[*int*](https://docs.python.org/3/builtins/functions.html#int)) - type of the used p-norm. Can be `'inf'`
for infinity norm.
...
[`torch.nn.utils.clip_grad_norm_()`](generated/torch.nn.utils.clip_grad_norm_.html#torch.nn.utils.clip_grad_norm_).

If at least some FSDP instance uses a sharded strategy (i.e.
one other than `NO_SHARD`), then you should use this method
instead of [`torch.nn.utils.clip_grad_norm_()`](generated/torch.nn.utils.clip_grad_norm_.html#torch.nn.utils.clip_grad_norm_) since this method
...
*static*flatten_sharded_optim_state_dict(*sharded_optim_state_dict*, *model*, *optim*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1555)
...
- **sharded_optim_state_dict** (*Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]*) - Optimizer state dict
corresponding to the unflattened parameters and holding the
sharded optimizer state.
- **model** ([*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - Refer to `shard_full_optim_state_dict()`.
- **optim** ([*torch.optim.Optimizer*](optim.html#torch.optim.Optimizer)) - Optimizer for `model` 's
parameters.
...
forward(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L835)
...
*static*fsdp_modules(*module*, *root_only=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L546)
...
- **module** ([*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - Root module, which may or may not be an
`FSDP` module.
- **root_only** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Whether to return only FSDP root modules.
(Default: `False`)
...
*static*full_optim_state_dict(*model*, *optim*, *optim_input=None*, *rank0_only=True*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1376)

Return the full optimizer state-dict.

Consolidates the full optimizer state on rank 0 and returns it
as a [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict) following the convention of
[`torch.optim.Optimizer.state_dict()`](generated/torch.optim.Optimizer.state_dict.html#torch.optim.Optimizer.state_dict), i.e. with keys `"state"`
...
return an empty [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict).

Unlike `torch.optim.Optimizer.state_dict()`, this method
uses full parameter names as keys instead of parameter IDs.

Like in [`torch.optim.Optimizer.state_dict()`](generated/torch.optim.Optimizer.state_dict.html#torch.optim.Optimizer.state_dict), the tensors
...
- **model** ([*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - Root module (which may or may not be a
`FullyShardedDataParallel` instance) whose parameters
were passed into the optimizer `optim`.
- **optim** ([*torch.optim.Optimizer*](optim.html#torch.optim.Optimizer)) - Optimizer for `model` 's
parameters.
- **optim_input** (*Optional**[**Union**[**List**[**Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]**]**,**Iterable**[**torch.nn.Parameter**]**]**]*) - Input passed into the optimizer `optim` representing either a
[`list`](https://docs.python.org/3/builtins/stdtypes.html#list) of parameter groups or an iterable of parameters;
if `None`, then this method assumes the input was
`model.parameters()`. This argument is deprecated, and there
is no need to pass it in anymore. (Default: `None`)
- **rank0_only** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, saves the populated [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict)
...
A [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict) containing the optimizer state for
`model` 's original unflattened parameters and including keys
"state" and "param_groups" following the convention of
[`torch.optim.Optimizer.state_dict()`](generated/torch.optim.Optimizer.state_dict.html#torch.optim.Optimizer.state_dict). If `rank0_only=True`,
then nonzero ranks return an empty [`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict).

Return type:

Dict[[str](https://docs.python.org/3/builtins/stdtypes.html#str), Any]

*static*get_state_dict_type(*module*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L753)
...
*property*module*: [Module](generated/torch.nn.Module.html#torch.nn.Module)*

Return the wrapped module.

named_buffers(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L975)
...
named_parameters(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L994)
...
no_sync()[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1033)
...
*static*optim_state_dict(*model*, *optim*, *optim_state_dict=None*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1796)
...
- **optim** ([*torch.optim.Optimizer*](optim.html#torch.optim.Optimizer)) - Optimizer for `model` 's
parameters.
- **optim_state_dict** (*Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]*) - the target optimizer state_dict to
...
*static*optim_state_dict_to_load(*model*, *optim*, *optim_state_dict*, *is_named_optimizer=False*, *load_directly=False*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1892)
...
- **optim** ([*torch.optim.Optimizer*](optim.html#torch.optim.Optimizer)) - Optimizer for `model` 's
parameters.
- **optim_state_dict** (*Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]*) - The optimizer states to be loaded.
- **is_named_optimizer** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - Is this optimizer a NamedOptimizer or
KeyedOptimizer. Only set to True if `optim` is TorchRec's
KeyedOptimizer or torch.distributed's NamedOptimizer.
- **load_directly** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If this is set to True, this API will also
...
register_comm_hook(*state*, *hook*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1982)
...
[GossipGrad](https://arxiv.org/abs/1803.05880) and gradient compression
...
peers to communicate with next in [GossipGrad](https://arxiv.org/abs/1803.05880), etc.
...
*static*rekey_optim_state_dict(*optim_state_dict*, *optim_state_key_type*, *model*, *optim_input=None*, *optim=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1673)
...
*static*scatter_full_optim_state_dict(*full_optim_state_dict*, *model*, *optim_input=None*, *optim=None*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1594)
...
- **full_optim_state_dict** (*Optional**[**Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]**]*) - Optimizer state
...
- **optim_input** (*Optional**[**Union**[**List**[**Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]**]**,**Iterable**[**torch.nn.Parameter**]**]**]*) - Input passed into the optimizer representing either a
[`list`](https://docs.python.org/3/builtins/stdtypes.html#list) of parameter groups or an iterable of parameters;
if `None`, then this method assumes the input was
`model.parameters()`. This argument is deprecated, and there
is no need to pass it in anymore. (Default: `None`)
- **optim** (*Optional**[*[*torch.optim.Optimizer*](optim.html#torch.optim.Optimizer)*]*) - Optimizer that will load
...
*static*set_state_dict_type(*module*, *state_dict_type*, *state_dict_config=None*, *optim_state_dict_config=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L626)
...
- **module** ([*torch.nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - Root module.
...
*static*shard_full_optim_state_dict(*full_optim_state_dict*, *model*, *optim_input=None*, *optim=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1481)
...
- **full_optim_state_dict** (*Dict**[*[*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**Any**]*) - Optimizer state dict
corresponding to the unflattened parameters and holding the
...
*static*sharded_optim_state_dict(*model*, *optim*, *group=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L1447)
...
*static*state_dict_type(*module*, *state_dict_type*, *state_dict_config=None*, *optim_state_dict_config=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L790)
...
*static*summon_full_params(*module*, *recurse=True*, *writeback=True*, *rank0_only=False*, *offload_to_cpu=False*, *with_grads=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/fully_sharded_data_parallel.py#L862)
...
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**Optional*) - recursively summon all params for nested
FSDP instances (default: True).
- **writeback** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**Optional*) - if `False`, modifications to params are
discarded after the context manager exits;
disabling this can be slightly more efficient (default: True)
- **rank0_only** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**Optional*) - if `True`, full parameters are
...
inconsistency across ranks when the context is exited.
- **offload_to_cpu** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**Optional*) - If `True`, full parameters are
...
- **with_grads** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**Optional*) - If `True`, gradients are also
...
*class*torch.distributed.fsdp.BackwardPrefetch(*value*, *names=None*, ***, *module=None*, *qualname=None*, *type=None*, *start=1*, *boundary=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L72)
...
*class*torch.distributed.fsdp.ShardingStrategy(*value*, *names=None*, ***, *module=None*, *qualname=None*, *type=None*, *start=1*, *boundary=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L32)
...
*class*torch.distributed.fsdp.MixedPrecision(*param_dtype=None*, *reduce_dtype=None*, *buffer_dtype=None*, *keep_low_precision_grads=False*, *cast_forward_inputs=False*, *cast_root_forward_inputs=True*, *_module_classes_to_ignore=(<class 'torch.nn.modules.batchnorm._BatchNorm'>*, *)*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L111)

This configures FSDP-native mixed precision training.

Variables:

- **param_dtype** (*Optional**[*[*torch.dtype*](tensor_attributes.html#torch.dtype)*]*) - This specifies the dtype for model
...
`None`)
- **buffer_dtype** (*Optional**[*[*torch.dtype*](tensor_attributes.html#torch.dtype)*]*) - This specifies the dtype for
...
`None`)
- **keep_low_precision_grads** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `False`, then FSDP upcasts
...
(Default: `False`)
- **cast_forward_inputs** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then this FSDP module casts
...
(Default: `False`)
- **cast_root_forward_inputs** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then the root FSDP module
...
- **_module_classes_to_ignore** ([*collections.abc.Sequence*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)*[*[*type*](https://docs.python.org/3/builtins/functions.html#type)*[*[*torch.nn.modules.module.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**]*) - (Sequence[Type[nn.Module]]): This specifies
...
Layer norm and batch norm accumulate in `float32` even when
...
*class*torch.distributed.fsdp.CPUOffload(*offload_params=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L229)

This configures CPU offloading.

Variables:

**offload_params** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - This specifies whether to offload parameters to
CPU when not involved in computation. If `True`, then this
offloads gradients to CPU as well, meaning that the optimizer step
runs on CPU.

*class*torch.distributed.fsdp.StateDictConfig(*offload_to_cpu=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L275)
...
**offload_to_cpu** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then FSDP offloads the state dict
values to CPU, and if `False`, then FSDP keeps them on GPU.
(Default: `False`)

*class*torch.distributed.fsdp.FullStateDictConfig(*offload_to_cpu=False*, *rank0_only=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L292)
...
**rank0_only** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then only rank 0 saves the full state
dict, and nonzero ranks save an empty dict. If `False`, then all
ranks save the full state dict. (Default: `False`)

*class*torch.distributed.fsdp.ShardedStateDictConfig(*offload_to_cpu=False*, *_use_dtensor=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L339)
...
**_use_dtensor** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then FSDP saves the state dict values
...
*class*torch.distributed.fsdp.LocalStateDictConfig(*offload_to_cpu: [bool](https://docs.python.org/3/builtins/functions.html#bool) = False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L334)

*class*torch.distributed.fsdp.OptimStateDictConfig(*offload_to_cpu=True*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L358)
...
**offload_to_cpu** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `True`, then FSDP offloads the state dict's
...
*class*torch.distributed.fsdp.FullOptimStateDictConfig(*offload_to_cpu=True*, *rank0_only=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L376)
...
*class*torch.distributed.fsdp.ShardedOptimStateDictConfig(*offload_to_cpu=True*, *_use_dtensor=False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L393)
...
*class*torch.distributed.fsdp.LocalOptimStateDictConfig(*offload_to_cpu: [bool](https://docs.python.org/3/builtins/functions.html#bool) = False*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L388)

*class*torch.distributed.fsdp.StateDictSettings(*state_dict_type: torch.distributed.fsdp.api.StateDictType*, *state_dict_config: torch.distributed.fsdp.api.StateDictConfig*, *optim_state_dict_config: torch.distributed.fsdp.api.OptimStateDictConfig*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/api.py#L412)

torch.distributed.fsdp.wrap.always_wrap_policy(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L117)
...
torch.distributed.fsdp.wrap.enable_wrap(***, *wrapper_cls*, ***wrapper_kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L400)
...
- **wrapper_cls** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any)) - Class that wrap annotation will wrap modules with, such as
FullyShardedDataParallel.
- ****wrapper_kwargs** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any)) - Configuration settings that will be passed to all `wrap`
...
torch.distributed.fsdp.wrap.lambda_auto_wrap_policy(*module*, *recurse*, *nonwrapped_numel*, *lambda_fn*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L270)
...
The first three parameters are required by `_recursive_wrap()`.

Parameters:

- **module** ([*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - Current module being considered.
- **recurse** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - If `False`, then this function must decide whether
`module` should be wrapped as an FSDP instance or not. If
`True`, then the function is still recursing down the module
tree as a part of the DFS.
- **nonwrapped_numel** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Parameter numel not yet wrapped.
- **lambda_fn** (*Callable**[**[*[*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**,*[*bool*](https://docs.python.org/3/builtins/functions.html#bool)*]*) - If this returns `True`, then
...
torch.distributed.fsdp.wrap.size_based_auto_wrap_policy(*module*, *recurse*, *nonwrapped_numel*, *min_num_params=100000000*, *force_leaf_modules=None*, *exclude_wrap_modules=None*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L341)
...
tree as a part of the DFS.
- **nonwrapped_numel** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Parameter numel not yet wrapped.
- **min_num_params** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Customizable policy input that controls the size
threshold over which a module is ready to be wrapped. This is in
units of numel.
- **force_leaf_modules** (*Optional**[*[*set*](https://docs.python.org/3/builtins/stdtypes.html#set)*[*[*type*](https://docs.python.org/3/builtins/functions.html#type)*[*[*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**]**]*) - Set of module types to keep
as leaves, i.e. their children will never be wrapped.
- **exclude_wrap_modules** (*Optional**[*[*set*](https://docs.python.org/3/builtins/stdtypes.html#set)*[*[*type*](https://docs.python.org/3/builtins/functions.html#type)*[*[*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)*]**]**]*) - Set of module types to be
...
torch.distributed.fsdp.wrap.transformer_auto_wrap_policy(*module*, *recurse*, *nonwrapped_numel*, *transformer_layer_cls*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L298)
...
torch.distributed.fsdp.wrap.wrap(*module*, ***wrap_overrides*)[[source]](https://github.com/pytorch/pytorch/blob/9b9978943e4030e97eeee36a9968db27a3b21163/torch/distributed/fsdp/wrap.py#L436)
...
- **module** ([*nn.Module*](generated/torch.nn.Module.html#torch.nn.Module)) - module to wrap (if in `enable_wrap()` context)
- ****wrap_overrides** ([*Any*](https://docs.python.org/3/library/typing.html#typing.Any)) - configuration overrides that will take priority over
the values provided by the `enable_wrap()` context
