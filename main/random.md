...
torch.random.fork_rng(*devices=None*, *enabled=True*, *_caller='fork_rng'*, *_devices_kw='devices'*, *device_type=None*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L156)
...
- **enabled** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)) - if `False`, the RNG is not forked. This is a convenience
argument for easily disabling the context manager without having
to delete it and unindent your Python code under it.
- **device_type** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)) - device type str, default is `None`, in which case the type
...
torch.random.get_rng_state()[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L39)
...
torch.random.initial_seed()[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L144)
...
torch.random.manual_seed(*seed*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L49)
...
torch.random.seed()[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L89)
...
torch.random.set_rng_state(*new_state*)[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L27)
...
torch.random.thread_safe_generator()[[source]](https://github.com/pytorch/pytorch/blob/8d6343a7cd80821d54ba546bc6f799aad9ccb79c/torch/random.py#L242)
