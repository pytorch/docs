...
*class*torch.utils.data.DataLoader(*dataset*, *batch_size=1*, *shuffle=None*, *sampler=None*, *batch_sampler=None*, *num_workers=0*, *collate_fn=None*, *pin_memory=False*, *drop_last=False*, *timeout=0*, *worker_init_fn=None*, *multiprocessing_context=None*, *generator=None*, ***, *prefetch_factor=None*, *persistent_workers=False*, *pin_memory_device=''*, *in_order=True*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataloader.py#L149)
...
*class*torch.utils.data.Dataset[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L39)
...
*class*torch.utils.data.IterableDataset[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L73)
...
*class*torch.utils.data.TensorDataset(**tensors*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L189)
...
*class*torch.utils.data.StackDataset(**args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L212)
...
*class*torch.utils.data.ConcatDataset(*datasets*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L299)
...
*class*torch.utils.data.ChainDataset(*datasets*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L356)
...
*class*torch.utils.data.Subset(*dataset*, *indices*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L386)
...
torch.utils.data._utils.collate.collate(*batch*, ***, *collate_fn_map=None*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/_utils/collate.py#L118)
...
torch.utils.data.default_collate(*batch*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/_utils/collate.py#L340)
...
torch.utils.data.default_convert(*data*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/_utils/collate.py#L23)
...
torch.utils.data.get_worker_info()[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/_utils/worker.py#L99)
...
torch.utils.data.dataset.random_split(*dataset*, *lengths*, *generator=<torch._C.Generator object>*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/dataset.py#L449)
...
*class*torch.utils.data.Sampler[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L28)
...
*class*torch.utils.data.SequentialSampler(*data_source*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L97)
...
*class*torch.utils.data.RandomSampler(*data_source*, *replacement=False*, *num_samples=None*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L116)
...
*class*torch.utils.data.SubsetRandomSampler(*indices*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L191)
...
*class*torch.utils.data.WeightedRandomSampler(*weights*, *num_samples*, *replacement=True*, *generator=None*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L213)
...
*class*torch.utils.data.BatchSampler(*sampler*, *batch_size*, *drop_last*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/sampler.py#L286)
...
*class*torch.utils.data.distributed.DistributedSampler(*dataset*, *num_replicas=None*, *rank=None*, *shuffle=True*, *seed=0*, *drop_last=False*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/distributed.py#L17)
...
torch.utils.data.graph.traverse(*datapipe*, *only_datapipe=None*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/graph.py#L109)
...
torch.utils.data.graph.traverse_dps(*datapipe*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/graph.py#L91)
...
torch.utils.data.datapipes.utils.decoder.basichandlers(*extension*, *data*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/datapipes/utils/decoder.py#L32)
...
torch.utils.data.datapipes.utils.decoder.handle_extension(*extensions*, *f*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/datapipes/utils/decoder.py#L115)
...
torch.utils.data.datapipes.utils.common.validate_input_col(*fn*, *input_col*)[[source]](https://github.com/pytorch/pytorch/blob/5abd8608770f0b56abd2b52412c9b39feeb6153e/torch/utils/data/datapipes/utils/common.py#L28)
