...
torch.amp.autocast_mode.is_autocast_available(*device_type*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/amp/autocast_mode.py#L28)
...
*class*torch.autocast(*device_type*, *dtype=None*, *enabled=True*, *cache_enabled=None*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/amp/autocast_mode.py#L52)
...
torch.amp.custom_fwd(*fwd=None*, ***, *device_type*, *cast_inputs=None*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/amp/autocast_mode.py#L441)
...
torch.amp.custom_bwd(*bwd=None*, ***, *device_type*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/amp/autocast_mode.py#L500)
...
*class*torch.cuda.amp.autocast(*enabled=True*, *dtype=torch.float16*, *cache_enabled=True*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/amp/autocast_mode.py#L13)

See `torch.autocast`.

`torch.cuda.amp.autocast(args...)` is deprecated. Please use `torch.amp.autocast("cuda", args...)` instead.

torch.cuda.amp.custom_fwd(*fwd=None*, ***, *cast_inputs=None*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/amp/autocast_mode.py#L85)

`torch.cuda.amp.custom_fwd(args...)` is deprecated. Please use
`torch.amp.custom_fwd(args..., device_type='cuda')` instead.

torch.cuda.amp.custom_bwd(*bwd*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/amp/autocast_mode.py#L100)

`torch.cuda.amp.custom_bwd(args...)` is deprecated. Please use
`torch.amp.custom_bwd(args..., device_type='cuda')` instead.

*class*torch.cpu.amp.autocast(*enabled=True*, *dtype=torch.bfloat16*, *cache_enabled=True*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cpu/amp/autocast_mode.py#L12)
...
*class*torch.cuda.amp.GradScaler(*init_scale=65536.0*, *growth_factor=2.0*, *backoff_factor=0.5*, *growth_interval=2000*, *enabled=True*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cuda/amp/grad_scaler.py#L12)

See `torch.amp.GradScaler`.
`torch.cuda.amp.GradScaler(args...)` is deprecated. Please use `torch.amp.GradScaler("cuda", args...)` instead.

*class*torch.cpu.amp.GradScaler(*init_scale=65536.0*, *growth_factor=2.0*, *backoff_factor=0.5*, *growth_interval=2000*, *enabled=True*)[[source]](https://github.com/pytorch/pytorch/blob/6c5b0fcd877d7b7a4a969138e85428dd95fa7636/torch/cpu/amp/grad_scaler.py#L9)
