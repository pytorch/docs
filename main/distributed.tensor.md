...
__create_chunk_list__()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L906)
...
*static*from_local(*local_tensor*, *device_mesh=None*, *placements=None*, ***, *run_check=False*, *shape=None*, *stride=None*, *grad_placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L518)
...
- **run_check** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - at a cost of extra communications, perform
...
- **stride** ([*tuple*](https://docs.python.org/3/builtins/stdtypes.html#tuple)*,**optional*) - A List of int which specifies the stride of DTensor.
...
[**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) - If `placements` contains mixed `Partial` reduce types
...
full_tensor(***, *grad_placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L830)
...
redistribute(*device_mesh=None*, *placements=None*, ***, *async_op=False*, *forward_dtype=None*, *backward_dtype=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L710)
...
- **async_op** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - whether to perform the DTensor redistribute operation
...
to_local(***, *grad_placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L645)
...
*property*placements*: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[Placement, ...]*
...
*class*torch.distributed.tensor.placement_types.Shard[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L162)
...
**dim** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The tensor dimension that describes the DTensor is sharded over its
...
*static*local_shard_size_and_offset(*curr_local_size*, *num_chunks*, *rank*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L335)
...
[tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[*_RankTypeT*, *_RankTypeT*]

*class*torch.distributed.tensor.placement_types._StridedShard(*dim*, ***, *split_factor=1*, *sf=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L823)
...
local_shard_size_and_offset(*curr_local_size*, *num_chunks*, *rank*, *offset_mode=_StridedShardOffsetMode.FIRST*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L1339)
...
- **curr_local_size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - The current size of the tensor dimension to be sharded.
- **num_chunks** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - Number of chunks to split the dimension into (typically the mesh dimension size).
...
*property*split_factor*: [int](https://docs.python.org/3/builtins/functions.html#int) | [SymInt](torch.html#torch.SymInt)*

*class*torch.distributed.tensor.placement_types.Replicate[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L1697)
...
*class*torch.distributed.tensor.placement_types.Partial[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L1762)

ALL_REDUCE_OPS*: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...]**= ('sum', 'avg', 'min', 'max', 'product')*
...
**reduce_op** ([*str*](https://docs.python.org/3/builtins/stdtypes.html#str)*,**optional*) -
...
The `Partial` placement can be generated as a result of DTensor
operators, by `DTensor.from_local`, or by redistributing a `Shard`
placement to `Partial("sum")`.

LINEAR_REDUCE_OPS*: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), ...]**= ('sum', 'avg')*

*class*torch.distributed.tensor.placement_types._MaskPartial(*reduce_op=None*, *mask_buffer=None*, *offset_shape=None*, *offset_dim=0*, **args*, ***kwargs*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/placement_types.py#L1892)
...
offset_dim*: [int](https://docs.python.org/3/builtins/functions.html#int)**= 0*

offset_shape*: [Size](size.html#torch.Size) | [None](https://docs.python.org/3/builtins/constants.html#None)**= None*
...
is_partial(*self: torch._C._distributed.Placement*, *reduce_op: [str](https://docs.python.org/3/builtins/stdtypes.html#str) | [None](https://docs.python.org/3/builtins/constants.html#None) = None*) → [bool](https://docs.python.org/3/builtins/functions.html#bool)

is_replicate(*self: torch._C._distributed.Placement*) → [bool](https://docs.python.org/3/builtins/functions.html#bool)
...
torch.distributed.tensor.distribute_tensor(*tensor*, *device_mesh=None*, *placements=None*, ***, *src_data_rank=0*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L939)
...
**src_data_rank** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - the rank of the source data for the logical/global tensor, it is
...
torch.distributed.tensor.distribute_module(*module*, *device_mesh=None*, *partition_fn=None*, *input_fn=None*, *output_fn=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1151)
...
torch.distributed.tensor.zeros(**size*, *requires_grad=False*, *dtype=None*, *layout=torch.strided*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1887)

Returns a `DTensor` filled with the scalar value 0.

Parameters:

**size** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*...*) - a sequence of integers defining the shape of the output `DTensor`.
...
torch.distributed.tensor.ones(**size*, *dtype=None*, *layout=torch.strided*, *requires_grad=False*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1524)
...
torch.distributed.tensor.empty(**size*, *dtype=None*, *layout=torch.strided*, *requires_grad=False*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1567)
...
torch.distributed.tensor.full(*size*, *fill_value*, ***, *dtype=None*, *layout=torch.strided*, *requires_grad=False*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1610)
...
torch.distributed.tensor.linspace(*start*, *end*, *steps*, ***, *dtype=None*, *layout=torch.strided*, *requires_grad=False*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1657)
...
`DTensor`, it must be 0-dimensional
- **steps** ([*int*](https://docs.python.org/3/builtins/functions.html#int)) - size of the constructed `DTensor`
...
torch.distributed.tensor.logspace(*start*, *end*, *steps*, *base=10.0*, ***, *dtype=None*, *layout=torch.strided*, *requires_grad=False*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1726)
...
torch.distributed.tensor.rand(**size*, *requires_grad=False*, *dtype=None*, *layout=torch.strided*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1799)
...
torch.distributed.tensor.randn(**size*, *requires_grad=False*, *dtype=None*, *layout=torch.strided*, *device_mesh=None*, *placements=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/_api.py#L1843)
...
generate_comm_debug_tracing_table(*noise_level=3*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L406)
...
generate_json_dump(*file_name='comm_mode_log.json'*, *noise_level=3*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L258)
...
get_comm_counts()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L574)
...
Dict[Any, [int](https://docs.python.org/3/builtins/functions.html#int)]

get_parameter_info()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L582)
...
get_sharding_info()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L585)

Return type:

[dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [dict](https://docs.python.org/3/builtins/stdtypes.html#dict)[[str](https://docs.python.org/3/builtins/stdtypes.html#str), [*Any*](https://docs.python.org/3/library/typing.html#typing.Any)]]

get_total_counts()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L571)

Return type:

[int](https://docs.python.org/3/builtins/functions.html#int)

log_comm_debug_tracing_table_to_file(*file_name='comm_mode_log.txt'*, *noise_level=3*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_comm_mode.py#L606)
...
torch.distributed.tensor.debug.visualize_sharding(*dtensor*, *header=''*, *use_rich=False*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/debug/_visualize_sharding.py#L155)
...
torch.distributed.tensor.experimental.context_parallel(*mesh*, ***, *buffers=None*, *buffer_seq_dims=None*, *no_restore_buffers=None*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/experimental/_context_parallel/_attention.py#L1539)
...
nn.Parameter.
- **buffer_seq_dims** (*Optional**[**List**[*[*int*](https://docs.python.org/3/builtins/functions.html#int)*]**]*) - the sequence dimensions of `buffers`.
...
torch.distributed.tensor.experimental.local_map(*func=None*, *out_placements=None*, *in_placements=None*, *in_grad_placements=None*, *device_mesh=None*, ***, *redistribute_inputs=False*, *spmd_types=False*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/experimental/_func_map.py#L218)
...
- **redistribute_inputs** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - the bool value indicating whether to reshard the input `DTensor` s when
their placements are different from the required input placements. If this
value is `False` and some `DTensor` input has a different placement,
an exception will be raised. Default: False.
- **spmd_types** ([*bool*](https://docs.python.org/3/builtins/functions.html#bool)*,**optional*) - if `True`, enable runtime SPMD type checking for `func`. Local
...
[meta-pytorch/spmd_types](https://github.com/meta-pytorch/spmd_types/blob/main/docs/local_spmd_types.md)
...
- [**AssertionError**](https://docs.python.org/3/builtins/exceptions.html#AssertionError) - For any non-DTensor output, we require its corresponding
 output placement in `out_placements` be None. An AssertionError will be raised
 if this is not the case.
- [**ValueError**](https://docs.python.org/3/builtins/exceptions.html#ValueError) - If `redistribute_inputs=False` but the input `DTensor` needs
...
torch.distributed.tensor.experimental.register_sharding(*op*)[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/experimental/_register_sharding.py#L23)
...
torch.distributed.tensor.experimental.implicit_replication()[[source]](https://github.com/pytorch/pytorch/blob/b58511bf7d1e77b23d16cb44e2eacf0f2e05be9c/torch/distributed/tensor/experimental/__init__.py#L14)
